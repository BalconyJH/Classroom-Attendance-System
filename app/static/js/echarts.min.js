!(function (t, e) {
  ...
  function n() {
    ...
    for (var i = Array(t), r = 0, e = 0; n > e; e++)
      for (var o = arguments[e], a = 0, s = o.length; s > a; a++, r++)
        i[r] = o[a];
    return i;
  }
  function i(t, e) {
  ...
  function v(t, e, n) {
    if (t && e)
      if (t.forEach && t.forEach === ly) t.forEach(e, n);
  ...
  function y(t, e, n) {
    if (!t) return [];
    if (!e) return H(t);
    if (t.map && t.map === cy) return t.map(e, n);
  ...
  function _(t, e, n) {
    if (!t) return [];
    if (!e) return H(t);
    if (t.filter && t.filter === uy) return t.filter(e, n);
    for (var i = [], r = 0, o = t.length; o > r; r++)
  ...
  function b(t, e) {
    ...
    return function () {
      return t.apply(e, n.concat(hy.call(arguments)));
    };
  }
  function S(t) {
    for (var e = [], n = 1; n < arguments.length; n++) e[n - 1] = arguments[n];
    return function () {
      return t.apply(this, e.concat(hy.call(arguments)));
    };
  }
  function T(t) {
    return Array.isArray ? Array.isArray(t) : "[object Array]" === ay.call(t);
  }
  function M(t) {
  ...
  function D(t) {
    return "[object String]" === ay.call(t);
  }
  function k(t) {
  ...
  function B(t) {
    return "[object RegExp]" === ay.call(t);
  }
  function E(t) {
    return t !== t;
  }
  ...
  function me(t, e, n, i, r, o) {
    ...
    if (1 === e) {
      var l = Math.round(Math.log(((1 << s) - 1) & ~r) / Iy);
      return t[n][l];
    }
    ...
    for (var c = 0, p = 0, f = 0; s > p; p++) {
      var d = 1 << p;
      d & r ||
        ((c += (f % 2 ? -1 : 1) * t[n][p] * me(t, e - 1, h, u, r | d, o)), f++);
    }
    return (o[a] = c), c;
  }
  function _e(t, e) {
  ...
  function xe(t, e, n, i, r) {
    return we(Py, e, i, r, !0) && we(t, n, Py[0], Py[1]);
  }
  function we(t, e, n, i, r) {
    if (e.getBoundingClientRect && iy.domSupported && !Te(e)) {
      var o = e[Ay] || (e[Ay] = {}),
        a = be(e, o),
        s = Se(a, o, r);
  ...
  function Me(t, e, n, i) {
    return (
      (n = n || {}),
      i || !iy.canvasSupported
        ? Ce(t, e, n)
        : iy.browser.firefox && null != e.layerX && e.layerX !== e.offsetX
  ...
  function Ce(t, e, n) {
    if (iy.domSupported && t.getBoundingClientRect) {
      var i = e.clientX,
        r = e.clientY;
      if (Te(t)) {
      ...
      if (we(Ry, t, i, r)) return (n.zrX = Ry[0]), void (n.zrY = Ry[1]);
    }
    n.zrX = n.zrY = 0;
  }
  function De(t) {
  ...
  function Ae(t, e, n, i) {
    Ly ? t.addEventListener(e, n, i) : t.attachEvent("on" + e, n);
  }
  function Pe(t, e, n, i) {
    Ly ? t.removeEventListener(e, n, i) : t.detachEvent("on" + e, n);
  }
  function Le(t) {
    var e = t[1][0] - t[0][0],
      n = t[1][1] - t[0][1];
  ...
  function rn(t, e) {
    am && nn(am, e), (am = om.put(t, am || e.slice()));
  }
  function on(t, e) {
    if (t) {
      e = e || [];
      ...
      if (i in rm) return nn(e, rm[i]), rn(t, e), e;
      var r = i.length;
      if ("#" !== i.charAt(0)) {
        var o = i.indexOf("("),
          a = i.indexOf(")");
        if (-1 !== o && a + 1 === r) {
          ...
          switch (s) {
            ...
            case "rgb":
              return 3 !== l.length
                ? void en(e, 0, 0, 0, 1)
                : (en(e, $e(l[0]), $e(l[1]), $e(l[2]), u), rn(t, e), e);
            case "hsla":
              return 4 !== l.length
                ? void en(e, 0, 0, 0, 1)
                : ((l[3] = Je(l[3])), an(l, e), rn(t, e), e);
            case "hsl":
              return 3 !== l.length
                ? void en(e, 0, 0, 0, 1)
                : (an(l, e), rn(t, e), e);
  ...
  function _n(t, e, n, i) {
    for (var r = e.length, o = 0; r > o; o++) t[o] = yn(e[o], n[o], i);
  }
  function xn(t, e, n, i) {
    for (var r = e.length, o = r && e[0].length, a = 0; r > a; a++) {
      t[a] || (t[a] = []);
      for (var s = 0; o > s; s++) t[a][s] = yn(e[a][s], n[a][s], i);
    }
  }
  function wn(t, e, n, i) {
  ...
  function Sn(t, e, n) {
    ...
    if (i.push && r.push) {
      ...
      if (o !== a) {
        var s = o > a;
        if (s) i.length = a;
        else for (var l = o; a > l; l++) i.push(1 === n ? r[l] : hm.call(r[l]));
      }
  ...
  function kn(t) {
    if (g(t)) {
      var e = t.length;
      if (g(t[0])) {
        for (var n = [], i = 0; e > i; i++) n.push(hm.call(t[i]));
        return n;
      }
      return hm.call(t);
    }
  ...
  function Pn(t, e) {
    return (
      Gy || (Gy = vy().getContext("2d")),
      Uy !== e && (Uy = Gy.font = e || Mm),
      Gy.measureText(t)
    );
  }
  function Ln(t, e) {
    ...
    n || (n = Tm[e] = new im(500));
    var i = n.get(t);
    return null == i && ((i = Cm.measureText(t, e).width), n.put(t, i)), i;
  }
  function On(t, e, n, i) {
    var r = Ln(t, e),
      o = Nn(e),
  ...
  function Rn(t, e, n, i) {
    ...
    for (var a = new Sm(0, 0, 0, 0), s = 0; s < r.length; s++) {
      var l = On(r[s], e, n, i);
  ...
  function Gn(t, e, n) {
    if (g(e[n]))
      if ((g(t[n]) || (t[n] = []), P(e[n]))) {
        var i = e[n].length;
        t[n].length !== i &&
          ((t[n] = new e[n].constructor(i)), Vn(t[n], e[n], i));
      } else {
        var r = e[n],
          o = t[n],
          a = r.length;
  ...
  function Un(t, e, n, i, r, o, a, s) {
    ...
    if (x > 0 || (r.force && !a.length)) {
      for (var b = t.animators, S = [], T = 0; T < b.length; T++)
        b[T].targetName === e && S.push(b[T]);
      if (!d && S.length)
      ...
      var P = new fm(n, !1, d ? S : null);
      (P.targetName = e),
        r.scope && (P.scope = r.scope),
        v && D && P.whenWithKeys(0, D, l),
        A && P.whenWithKeys(0, A, l),
        P.whenWithKeys(null == c ? 500 : c, s ? k : i, l).delay(f || 0),
        t.addAnimator(P, e),
        a.push(P);
    }
  }
  function Yn(t) {
    for (var e = 0; t >= Hm; ) (e |= 1 & t), (t >>= 1);
    return t + e;
  }
  function Xn(t, e, n, i) {
    var r = e + 1;
  ...
  function Jn(t, e, n, i) {
    ...
    if (!(2 > r)) {
      var o = 0;
      if (Hm > r) return (o = Xn(t, n, i, e)), void qn(t, n, i, n + o, e);
      var a = $n(t, e),
        s = Yn(r);
      do {
        if (((o = Xn(t, n, i, e)), s > o)) {
  ...
  function ai(t, e) {
    var n = e.domHandlers;
    iy.pointerEventsSupported
      ? v(qm.pointer, function (i) {
          li(e, i, function (e) {
            n[i].call(t, e);
          });
        })
      : (iy.touchEventsSupported &&
          v(qm.touch, function (i) {
            li(e, i, function (r) {
              n[i].call(t, r), ni(e);
            });
          }),
        v(qm.mouse, function (i) {
          li(e, i, function (r) {
  ...
  function si(t, e) {
    function n(n) {
      function i(i) {
        (i = De(i)),
          oi(t, i.target) || ((i = ri(t, i)), e.domHandlers[n].call(t, i));
      }
      li(e, n, i, { capture: !0 });
    }
    iy.pointerEventsSupported
      ? v(Zm.pointer, n)
      : iy.touchEventsSupported || v(Zm.mouse, n);
  }
  function li(t, e, n, i) {
  ...
  function ui(t) {
    var e = t.mounted;
    for (var n in e)
      e.hasOwnProperty(n) && Pe(t.domTarget, n, e[n], t.listenerOpts[n]);
    t.mounted = {};
  }
  function hi(t) {
    delete o_[t];
  ...
  function ci(t) {
    if (!t) return !1;
    if ("string" == typeof t) return gn(t, 1) < Im;
    if (t.colorStops) {
  ...
  function di() {
    for (var t in o_) o_.hasOwnProperty(t) && o_[t].dispose();
    o_ = {};
  }
  function gi(t) {
    return o_[t];
  ...
  function Wi(t) {
    return !I(t) || T(t) || t instanceof Date ? t : t.value;
  }
  function Gi(t) {
    ...
    v(e, function (e) {
      if (e) {
        for (
          ...
          (i.newOption ||
            er(i.existing) ||
            (i.existing && null != e.id && !$i("id", e, i.existing)));
    ...
    v(t, function (t) {
      ...
      v(t, function (t, n) {
        var i = t.existing,
          ...
          o = t.keyInfo;
        if (I(r)) {
          if (((o.name = null != r.name ? Ji(r.name) : i ? i.name : p_ + n), i))
            o.id = Ji(i.id);
  ...
  function Qi(t, e) {
    if (null == t) return e;
    var n = typeof t;
    return "string" === n ? t : "number" === n || D(t) ? t + "" : e;
  }
  function tr(t) {
    var e = t.name;
    return !(!e || !e.indexOf(p_));
  }
  function er(t) {
    return t && null != t.id && 0 === Ji(t.id).indexOf(f_);
  }
  function nr(t, e, n) {
    v(t, function (t) {
      var i = t.newOption;
      I(i) &&
        ...
        (t.keyInfo.subType = ir(e, i, t.existing, n)));
    });
  }
  function ir(t, e, n, i) {
  ...
  function cr(t) {
    return "auto" === t ? (iy.domSupported ? "html" : "richText") : t || "html";
  }
  ...
  function br(t) {
    function e(t) {
      var e = n[t.main];
      return (e && e[m_]) || ((e = n[t.main] = {}), (e[m_] = !0)), e;
    }
    var n = {};
  ...
  function Mr(t, e, n, i, r) {
    if (t) {
      if ("string" == typeof t) {
        ...
        return (
          o
            ? ((e = o.image), !Dr(e) && o.pending.push(a))
            : ((e = new Image()),
              (e.onload = e.onerror = Cr),
              T_.put(t, (e.__cachedImgObj = { image: e, pending: [a] })),
  ...
  function Ir(t, e, n, i) {
    i = i || {};
    var r = h({}, i);
    (r.font = e), (n = z(n, "...")), (r.maxIterations = z(i.maxIterations, 2));
    var o = (r.minChar = z(i.minChar, 0));
    r.cnCharWidth = Ln("国", e);
    var a = (r.ascCharWidth = Ln("a", e));
    r.placeholder = z(i.placeholder, "");
  ...
  function Ar(t, e) {
    ...
    for (var a = 0; ; a++) {
      ...
      var s =
        0 === a
          ? Pr(t, r, e.ascCharWidth, e.cnCharWidth)
          : o > 0
  ...
  function Lr(t, e) {
    ...
    n =
      (null != h && "break" === i) || "breakAll" === i
        ? t
          ? Nr(t, e.font, h, "breakAll" === i, 0).lines
          : []
        : t
        ? t.split("\n")
        : [];
    ...
    if (
      ...
      for (
        ...
        n[y] = Ar(n[y], v);
    if (null == h) {
      for (var m = 0, y = 0; y < n.length; y++) m = Math.max(Ln(n[y], o), m);
      h = m;
    }
    return {
      lines: n,
  ...
  function Or(t, e) {
    ...
    t: for (var y = 0; y < i.lines.length; y++) {
      for (var m = i.lines[y], _ = 0, x = 0, w = 0; w < m.tokens.length; w++) {
        ...
        b.contentHeight = Nn(C);
        var D = z(S.height, b.contentHeight);
        if (
          ((b.innerHeight = D),
          T && (D += T[0] + T[2]),
          (b.height = D),
          (b.lineHeight = F(S.lineHeight, e.lineHeight, D)),
        ...
        if ("string" == typeof k && "%" === k.charAt(k.length - 1))
          (b.percentWidth = k), c.push(b), (b.contentWidth = Ln(b.text, C));
        else {
          if (I) {
            ...
            P &&
              ((P = Tr(P)),
              Dr(P) && (b.width = Math.max(b.width, (P.width * D) / P.height)));
          }
          var L = g && null != o ? o - x : null;
          null != L && L < b.width
            ? !I || M > L
              ? ((b.text = ""), (b.width = b.contentWidth = 0))
              : ((b.text = kr(b.text, L - M, C, e.ellipsis, {
                  minChar: e.truncateMinChar,
                })),
                (b.width = b.contentWidth = Ln(b.text, C)))
            : (b.contentWidth = Ln(b.text, C));
        }
        (b.width += M), (x += b.width), S && (_ = Math.max(_, b.lineHeight));
      }
      n(m, x, _);
    }
    (i.outerWidth = i.width = z(o, f)),
      (i.outerHeight = i.height = z(a, p)),
      (i.contentHeight = p),
      (i.contentWidth = f),
  ...
  function Rr(t, e, n, i, r) {
    ...
    for (var v = 0; v < o.length; v++) {
      ...
      if (
        ...
        (m.text = y),
        (m.isLineHolder = !y && !s),
        (m.width = "number" == typeof l.width ? l.width : a ? a[v] : Ln(y, h)),
        v || c)
      )
        u.push(new D_([m]));
      else {
        var _ = (u[u.length - 1] || (u[0] = new D_())).tokens,
          x = _.length;
  ...
  function zr(t, e, n) {
    return (
      B_.copy(t.getBoundingRect()),
      t.transform && B_.applyTransform(t.transform),
      (E_.width = e),
      (E_.height = n),
      !B_.intersect(E_)
    );
    ...
    if (Fr(h) && Fr(c))
      ...
      if (Fr(g)) {
        ...
        var m = z_(g),
          _ = h * s + 1.5 * a * (-c + m),
          x = h * s + 1.5 * a * (-c - m);
        (_ = 0 > _ ? -N_(-_, W_) : N_(_, W_)),
          (x = 0 > x ? -N_(-x, W_) : N_(x, W_));
        var d = (-s - (_ + x)) / (3 * a);
        d >= 0 && 1 >= d && (o[f++] = d);
      } else {
        var w = (2 * h * s - 3 * a * c) / (2 * z_(h * h * h)),
          b = Math.acos(w) / 3,
          S = z_(h),
          T = Math.cos(b),
          d = (-s - 2 * S * T) / (3 * a),
          y = (-s + S * (T + V_ * Math.sin(b))) / (3 * a),
          M = (-s + S * (T - V_ * Math.sin(b))) / (3 * a);
        d >= 0 && 1 >= d && (o[f++] = d),
          y >= 0 && 1 >= y && (o[f++] = y),
          M >= 0 && 1 >= M && (o[f++] = M);
      }
  ...
  function Xr(t, e, n, i, r, o, a, s, l, u, h) {
    ...
    return h && ((h[0] = Vr(t, n, r, a, c)), (h[1] = Vr(e, i, o, s, c))), z_(y);
  }
  ...
  function Qr(t, e, n, i, r, o, a, s, l) {
    ...
    for (var d = 0; 32 > d && !(H_ > h); d++) {
      ...
      if (g >= 0 && c > f) (u = g), (c = f);
        ...
        (Y_[0] = qr(t, n, r, v)), (Y_[1] = qr(e, i, o, v));
        var y = Ty(Y_, G_);
        1 >= v && c > y ? ((u = v), (c = y)) : (h *= 0.5);
      }
    }
    return l && ((l[0] = qr(t, n, r, u)), (l[1] = qr(e, i, o, u))), z_(c);
  }
  ...
  function no(t, e, n, i, r, o) {
    (r[0] = X_(t, n)), (r[1] = X_(e, i)), (o[0] = j_(t, n)), (o[1] = j_(e, i));
  }
  function io(t, e, n, i, r, o, a, s, l, u) {
    ...
    for (var f = 0; p > f; f++) {
      var d = c(t, n, r, a, tx[f]);
      (l[0] = X_(d, l[0])), (u[0] = j_(d, u[0]));
    }
    p = h(e, i, o, s, ex);
    for (var f = 0; p > f; f++) {
      var g = c(e, i, o, s, ex[f]);
      (l[1] = X_(g, l[1])), (u[1] = j_(g, u[1]));
    }
    (l[0] = X_(t, l[0])),
      (u[0] = j_(t, u[0])),
      (l[0] = X_(a, l[0])),
  ...
  function po(t, e, n, i, r, o, a, s, l) {
    ...
    if (Math.abs(i - r) % bx < 1e-4) return !0;
    if (o) {
      var c = i;
      (i = co(r)), (r = co(c));
    } else (i = co(i)), (r = co(r));
    ...
    return (
      0 > p && (p += bx), (p >= i && r >= p) || (p + bx >= i && r >= p + bx)
    );
  }
  ...
  function yo(t, e, n, i, r, o, a, s, l, u) {
    if (
      (u > e && u > i && u > o && u > s) ||
      (e > u && i > u && o > u && s > u)
    )
      return 0;
    var h = Gr(e, i, o, s, u, Cx);
    if (0 === h) return 0;
  ...
  function mo(t, e, n, i, r, o, a, s) {
    ...
    if (u >= 0 && 1 >= u) {
      for (var h = 0, c = qr(e, i, o, u), p = 0; l > p; p++) {
        var f = 0 === Cx[p] || 1 === Cx[p] ? 0.5 : 1,
          d = qr(t, n, r, Cx[p]);
        a > d || (h += Cx[p] < u ? (e > c ? f : -f) : c > o ? f : -f);
      }
      return h;
    }
    var f = 0 === Cx[0] || 1 === Cx[0] ? 0.5 : 1,
      d = qr(t, n, r, Cx[0]);
    ...
    for (
      ...
      switch (
        ...
        case Sx.C:
          if (n) {
            if (
              uo(h, c, s[d++], s[d++], s[d++], s[d++], s[d], s[d + 1], e, i, r)
            )
              return !0;
          } else
            u +=
              yo(h, c, s[d++], s[d++], s[d++], s[d++], s[d], s[d + 1], i, r) ||
              0;
          (h = s[d++]), (c = s[d++]);
          break;
        case Sx.Q:
        ...
        case Sx.A:
          ...
          (o = Math.cos(w) * _ + y),
            (a = Math.sin(w) * x + m),
            v ? ((p = o), (f = a)) : (u += fo(h, c, o, a, i, r));
          var T = ((i - y) * x) / _ + y;
          if (n) {
            if (po(y, m, x, w, w + b, S, e, T, r)) return !0;
          } else u += _o(y, m, x, w, w + b, S, T, r);
  ...
  function Mo(t, e, n) {
    if (e) {
      ...
      var s = n && n.lineWidth;
      return s
        ? (Nx(2 * i) === Nx(2 * r) && (t.x1 = t.x2 = Do(i, s, !0)),
          Nx(2 * o) === Nx(2 * a) && (t.y1 = t.y2 = Do(o, s, !0)),
          t)
        : t;
    }
  }
  function Co(t, e, n) {
    if (e) {
      ...
      return s
        ? ((t.x = Do(i, s, !0)),
          (t.y = Do(r, s, !0)),
          (t.width = Math.max(Do(i + o, s, !1) - t.x, 0 === o ? 0 : 1)),
          (t.height = Math.max(Do(r + a, s, !1) - t.y, 0 === a ? 0 : 1)),
          t)
        : t;
    }
  }
  function Do(t, e, n) {
    if (!e) return t;
    var i = Nx(2 * t);
    return (i + Nx(e)) % 2 === 0 ? i / 2 : (i + (n ? 1 : -1)) / 2;
  }
  function ko(t) {
    return Io(t), v(t.rich, Io), t;
  }
  function Io(t) {
    if (t) {
      t.font = Ux.makeFont(t);
      var e = t.align;
      "middle" === e && (e = "center"),
        (t.align = null == e || Yx[e] ? e : "left");
      var n = t.verticalAlign;
      "center" === n && (n = "middle"),
        (t.verticalAlign = null == n || Xx[n] ? n : "top");
      var i = t.padding;
  ...
  function Eo(t) {
    ...
    var e = uw.get(t);
    return e || ((e = ln(t, -0.1)), uw.put(t, e)), e;
  }
  function No(t, e, n) {
  ...
  function Fo(t) {
    t.hoverState === Qx && No(t, "normal", $x);
  }
  function Ho(t) {
    No(t, "blur", Jx);
  }
  function Vo(t) {
    t.hoverState === Jx && No(t, "normal", $x);
  }
  function Wo(t) {
    t.selected = !0;
  }
  ...
  function jo(t, e, n, i) {
    ...
    if (t instanceof Px) {
      ...
      if (Bo(s) || Bo(l)) {
        ...
        var u = i.style || {};
        !Bo(u.fill) && Bo(s)
          ? ((o = !0), (i = h({}, i)), (u = h({}, u)), (u.fill = Eo(s)))
          : !Bo(u.stroke) &&
            Bo(l) &&
            (o || ((i = h({}, i)), (u = h({}, u))), (u.stroke = Eo(l))),
          (i.style = u);
      }
    }
    if (i && null == i.z2) {
  ...
  function Zo(t, e, n) {
    var i = p(t.currentStates, e) >= 0,
      r = t.style.opacity,
      o = i ? null : Xo(t, ["opacity"], e, { opacity: 1 });
    n = n || {};
    var a = n.style || {};
    return (
      null == a.opacity &&
  ...
  function Jo(t, e) {
    !aa(t, e) && !t.__highByOuter && Yo(t, zo);
  }
  function Qo(t, e) {
    !aa(t, e) && !t.__highByOuter && Yo(t, Fo);
  }
  function ta(t, e) {
    (t.__highByOuter |= 1 << (e || 0)), Yo(t, zo);
  }
  function ea(t, e) {
  ...
  function pa(t, e, n) {
    var i = jx(t),
      ...
      a = r.focusSelf;
    o
      ? (a && ua(i.componentMainType, i.componentIndex, n),
        v(o, function (t) {
          return Jo(t, e);
        }))
      : (la(i.seriesIndex, i.focus, i.blurScope, n),
        "self" === i.focus && ua(i.componentMainType, i.componentIndex, n),
        Jo(t, e));
  }
  function fa(t, e, n) {
    sa(n);
  ...
  function da(t, e) {
    if (Sa(e)) {
      ...
      T(r) || (r = [r]),
        t[
          e.type === lw ? "toggleSelect" : e.type === aw ? "select" : "unselect"
        ](r, n);
    }
  }
  function ga(t) {
  ...
  function ba(t) {
    var e = Zx[t];
    return null == e && 32 >= qx && (e = Zx[t] = qx++), e;
  }
  function Sa(t) {
    var e = t.type;
    return e === aw || e === sw || e === lw;
  }
  function Ta(t) {
    var e = t.type;
    return e === rw || e === ow;
    ...
    for (r = 0, o = 0; u > r; ) {
      switch (((n = l[r++]), (o = r), (i = 0), n)) {
        ...
        case d:
          var v = e[4],
            y = e[5],
            m = dw(e[0] * e[0] + e[1] * e[1]),
            _ = dw(e[2] * e[2] + e[3] * e[3]),
            x = gw(-e[1] / _, e[0] / m);
          (l[r] *= m),
            (l[r++] += v),
            (l[r] *= _),
  ...
  function Ia(t, e) {
    return (t[0] * e[1] < t[1] * e[0] ? -1 : 1) * Math.acos(ka(t, e));
  }
  function Aa(t, e, n, i, r, o, a, s, l, u, h) {
    var c = l * (_w / 180),
      p = (mw(c) * (t - n)) / 2 + (yw(c) * (e - i)) / 2,
      f = (-1 * yw(c) * (t - n)) / 2 + (mw(c) * (e - i)) / 2,
      d = (p * p) / (a * a) + (f * f) / (s * s);
    d > 1 && ((a *= vw(d)), (s *= vw(d)));
    var g =
        (r === o ? -1 : 1) *
      ...
      v = (g * a * f) / s,
      y = (g * -s * p) / a,
      m = (t + n) / 2 + mw(c) * v - yw(c) * y,
      _ = (e + i) / 2 + yw(c) * v + mw(c) * y,
      x = Ia([1, 0], [(p - v) / a, (f - y) / s]),
      w = [(p - v) / a, (f - y) / s],
      b = [(-1 * p - v) / a, (-1 * f - y) / s],
      S = Ia(w, b);
    if ((ka(w, b) <= -1 && (S = _w), ka(w, b) >= 1 && (S = 0), 0 > S)) {
      var T = Math.round((S / _w) * 1e6) / 1e6;
      S = 2 * _w + (T % 2) * _w;
    }
        ...
        switch (c) {
          ...
          case "S":
            (y = i),
              ...
              (C = e.len()),
              (D = e.data),
              n === s.C && ((y += i - D[C - 4]), (m += r - D[C - 3])),
              (p = s.C),
              (T = f[v++]),
              (M = f[v++]),
              (i = f[v++]),
              (r = f[v++]),
              e.addData(p, y, m, T, M, i, r);
            break;
          case "s":
            (y = i),
              (m = r),
  ...
  function Oa(t, e) {
    ...
    return (
      ...
      (i.applyTransform = function (t) {
        Ca(n, t), this.dirtyShape();
      }),
      i
    );
  }
  function Ra(t, e) {
    return new bw(Oa(t, e));
  }
  function Ba(t, n) {
    var i = Oa(t, n),
      r = (function (t) {
  ...
  function Ea(t, e) {
    for (var n = [], i = t.length, r = 0; i > r; r++) {
      ...
      o.path || o.createPathProxy(),
        o.shapeChanged() && o.buildPath(o.path, o.shape, !0),
        n.push(o.path);
    }
    var a = new Px(e);
    return (
  ...
  function Fa(t, e) {
    ...
    if (r || o) {
      ...
      if (n > Nw)
        if (s > kw - Nw)
          t.moveTo(p + n * Aw(u), f + n * Iw(u)),
            t.arc(p, f, n, u, h, !l),
            i > Nw &&
              (t.moveTo(p + i * Aw(h), f + i * Iw(h)), t.arc(p, f, i, h, u, l));
        else {
          var v = Ow(n - i) / 2,
            y = Ew(v, d),
            m = Ew(v, g),
            ...
            if (I) {
              var A = w - I[0],
                ...
                R =
                  ...
                  Iw(
                    Pw(
                      (A * L + P * O) / (Rw(A * A + P * P) * Rw(L * L + O * O)),
                    ) / 2,
                  ),
                B = Rw(I[0] * I[0] + I[1] * I[1]);
              (_ = Ew(m, (i - B) / (R - 1))), (x = Ew(y, (n - B) / (R + 1)));
            }
          }
          if (s > Nw)
            if (x > Nw) {
              var E = za(D, k, w, b, n, x, l),
                N = za(M, C, S, T, n, x, l);
              t.moveTo(p + E.cx + E.x01, f + E.cy + E.y01),
                y > x
                  ? t.arc(
                      p + E.cx,
                      f + E.cy,
                  ...
                  : (t.arc(
                    ...
                    t.arc(
                      ...
                      f,
                      n,
                      Lw(E.cy + E.y11, E.cx + E.x11),
                      Lw(N.cy + N.y11, N.cx + N.x11),
                      !l,
                    ),
                    t.arc(
                      p + N.cx,
          ...
          if (i > Nw && s > Nw)
            if (_ > Nw) {
              var E = za(S, T, M, C, i, -_, l),
                N = za(w, b, D, k, i, -_, l);
              t.lineTo(p + E.cx + E.x01, f + E.cy + E.y01),
                m > _
                  ? t.arc(
                      p + E.cx,
                      f + E.cy,
            ...
            } else t.lineTo(p + S, f + T), t.arc(p, f, i, h, u, l);
  ...
  function Va(t, e) {
    ...
    for (var o = 0; a > o; o++) {
      var s = (o / (a - 1)) * (e ? n : n - 1),
        ...
        f = void 0;
      e
        ? ((h = t[(l - 1 + n) % n]), (p = t[(l + 1) % n]), (f = t[(l + 2) % n]))
        : ((h = t[0 === l ? l : l - 1]),
          (p = t[l > n - 2 ? n - 1 : l + 1]),
          (f = t[l > n - 3 ? n - 1 : l + 2]));
      var d = u * u,
        g = u * d;
      i.push([
        Ha(h[0], c[0], p[0], f[0], u, d, g),
        Ha(h[1], c[1], p[1], f[1], u, d, g),
      ]);
    }
    return i;
  }
  function Wa(t, e, n, i) {
    ...
    if (i) {
      (a = [1 / 0, 1 / 0]), (s = [-1 / 0, -1 / 0]);
      for (var p = 0, f = t.length; f > p; p++) ve(a, a, t[p]), ye(s, s, t[p]);
      ve(a, a, i[0]), ye(s, s, i[1]);
    }
    for (var p = 0, f = t.length; f > p; p++) {
      ...
      var m = ee([], d, h),
        _ = ee([], d, c);
      i && (ye(m, m, a), ve(m, m, s), ye(_, _, a), ve(_, _, s)),
        l.push(m),
        l.push(_);
    }
  ...
  function Ga(t, e, n) {
    ...
    if (r && r.length >= 2) {
      if (i && "spline" !== i) {
        ...
        "spline" === i && (r = Va(r, n)), t.moveTo(r[0][0], r[0][1]);
  ...
  function Ua(t, e, n) {
    ...
    return null === i || null === r
      ...
      : [
          (n ? Zr : qr)(t.x1, t.cpx1, t.x2, e),
          (n ? Zr : qr)(t.y1, t.cpy1, t.y2, e),
        ];
  }
  function Ya(t) {
    return Px.extend(t);
  ...
  function qa(t) {
    return fb.hasOwnProperty(t) ? fb[t] : void 0;
  }
  function Za(t, e, n, i) {
    var r = Ra(t, e);
    return (
      n && ("center" === i && (n = $a(n, r.getBoundingRect())), Ja(r, n)), r
    );
  }
  function Ka(t, e, n) {
    var i = new Ex({
  ...
  function es(t, e, n, i, r, o, a) {
    ...
    if ((c || e.stopAnimation("remove"), f)) {
      ...
      u
        ...
        ? ((s = s || {}),
          (d = z(s.duration, 200)),
          (g = z(s.easing, "cubicOut")),
          (v = 0))
        : ((d = i.getShallow(
            h ? "animationDurationUpdate" : "animationDuration",
          )),
          (g = i.getShallow(h ? "animationEasingUpdate" : "animationEasing")),
          (v = i.getShallow(h ? "animationDelayUpdate" : "animationDelay"))),
        "function" == typeof v &&
          (v = v(
            r,
  ...
  function rs(t, e, n, i, r, o) {
    ss(t) || es("remove", t, e, n, i, r, o);
  }
  function os(t, e, n, i) {
    t.removeTextContent(),
      t.removeTextGuideLine(),
      rs(t, { style: { opacity: 0 } }, e, n, i);
  }
  function as(t, e, n) {
    function i() {
  ...
  function us(t, e, n) {
    return (
      e && !g(e) && (e = Jy.getLocalTransform(e)),
      n && (e = Ye([], e)),
      ge([], t, e)
    );
  }
  ...
  function fs(t, e, n) {
    ...
    function r(t) {
      ...
      return ps(t) && (e.shape = h({}, t.shape)), e;
    }
    if (t && e) {
      var o = i(t);
      e.traverse(function (t) {
        if (cs(t) && t.anid) {
          ...
          if (e) {
            var i = r(t);
            t.attr(r(e)), ns(t, i, n, jx(t).dataIndex);
          }
        }
      });
    }
  ...
  function ds(t, e) {
    return y(t, function (t) {
      var n = t[0];
      (n = cb(n, e.x)), (n = pb(n, e.x + e.width));
      var i = t[1];
      return (i = cb(i, e.y)), (i = pb(i, e.y + e.height)), [n, i];
    });
  }
  function gs(t, e) {
    var n = cb(t.x, e.x),
      i = pb(t.x + t.width, e.x + e.width),
      r = cb(t.y, e.y),
      o = pb(t.y + t.height, e.y + e.height);
    return i >= n && o >= r
  ...
  function vs(t, e, n) {
    ...
    return (
      ...
      t
        ? 0 === t.indexOf("image://")
          ? ((r.image = t.slice(8)), c(r, n), new Ex(i))
          : Za(t.replace("path://", ""), i, n, "center")
        : void 0
    );
  }
  ...
  function Ss(t, e, n) {
    ...
    r &&
      ...
      null == i &&
        (i = M(t.defaultText) ? t.defaultText(o, t, n) : t.defaultText);
  ...
  function Ts(t, e, n, i) {
    n = n || mb;
    for (var r = t instanceof Ux, o = !1, a = 0; a < ew.length; a++) {
      var s = e[ew[a]];
    ...
    if (o) {
      r ||
        (l || ((l = new Ux()), t.setTextContent(l)),
        t.stateProxy && (l.stateProxy = t.stateProxy));
      var u = Ss(n, e),
        h = e.normal,
        c = !!h.getShallow("show"),
        p = Cs(h, i && i.normal, n, !1, !r);
      (p.text = u.normal), r || t.setTextConfig(Ds(h, n, !1));
  ...
  function ks(t, e, n, i, r) {
    ...
    null != p && (t.margin = p), As(t, e, s, n, i, r, !0, !1);
  }
  function Is(t) {
  ...
  function Ns(t, e) {
    (t = t.toUpperCase()), (Hb[t] = new Lb(e)), (Fb[t] = e);
  }
  function zs(t) {
    if (C(t)) {
      var e = Fb[t.toUpperCase()] || {};
      return t === Eb || t === Nb ? s(e) : l(s(e), s(Fb[zb]), !1);
    }
    return l(s(t), s(Fb[zb]), !1);
  }
  function Fs(t) {
    return Hb[t];
  }
  ...
  function Ys(t, e, n, i) {
    var r = ki(t),
      ...
      f = r[tl(n)](),
      d = r[el(n)](),
      g = i instanceof Lb ? i : Fs(i || Vb) || Hs(),
      v = g.getModel("time"),
      y = v.get("month"),
      m = v.get("monthAbbr"),
      _ = v.get("dayOfWeek"),
  ...
  function Xs(t, e, n, i, r) {
    ...
    if ("string" == typeof n) o = n;
      ...
      var a = h({}, jb);
      if (t.level > 0)
        for (var s = 0; s < Kb.length; ++s)
          a[Kb[s]] = "{primary|" + a[Kb[s]] + "}";
      var l = n ? (n.inherit === !1 ? n : c(n, a)) : a,
        u = js(t.value, r);
      if (l[u]) o = l[u];
      else if (l.inherit) {
        for (var p = $b.indexOf(u), s = p - 1; s >= 0; --s)
          if (l[u]) {
            o = l[u];
            break;
          }
    ...
    return Ys(new Date(t.value), o, r, i);
  }
  function js(t, e) {
    var n = ki(t),
      i = n[Ks(e)]() + 1,
  ...
  function fl(t, e, n) {
    ...
    if (a || s) {
      var l = a ? ki(t) : t;
      if (!isNaN(+l)) return Ys(l, o, n);
      if (s) return "-";
    }
    if ("ordinal" === e) return D(t) ? i(t) : k(t) && r(t) ? t + "" : "-";
    var u = Ri(t);
    return r(u) ? hl(u) : D(t) ? i(t) : "-";
  }
  function dl(t, e, n) {
    T(e) || (e = [e]);
    var i = e.length;
    ...
    for (var r = e[0].$vars || [], o = 0; o < r.length; o++) {
      var a = eS[o];
      t = t.replace(nS(a), nS(a, 0));
    }
    for (var s = 0; i > s; s++)
      for (var l = 0; l < r.length; l++) {
        var u = e[s][r[l]];
        t = t.replace(nS(eS[l], s), n ? pl(u) : u);
      }
    return t;
  }
  function gl(t, e, n) {
  ...
  function bl(t, e, n) {
    ...
    (o = o || 0),
      ...
      isNaN(u) && (u = i - p - o - (s || 0)),
      isNaN(h) && (h = r - c - a - (l || 0));
    var d = new Sm(o + n[3], a + n[0], u, h);
    return (d.margin = n), d;
  }
  function Sl(t, e) {
    return null != t[oS[e][0]] || (null != t[oS[e][1]] && null != t[oS[e][2]]);
  }
  function Tl(t) {
  ...
  function kl(t) {
    var e = [];
    return (
      v(lS.getClassesByMainType(t), function (t) {
    ...
    var l = (function () {
      ...
      for (var i = {}, r = {}, l = [], u = 0, h = Math.min(5, n); h > u; u++) {
        ...
        if (
          ...
          (null == i.n || i.n === i.v || (!p && l[i.n] === SS.Not)) &&
            (i.n = u),
          t(i) && l[i.n] !== SS.Not)
        )
          return i;
        p ||
          (c === SS.Might && null == r.v && u !== o && (r.v = u),
  ...
  function Bl(t, e, n, i, r, o) {
    ...
    var s,
      l = 5;
    if (P(t)) return SS.Not;
    var u, h;
    if (i) {
      var c = i[o];
      I(c) ? ((u = c.name), (h = c.type)) : C(c) && (u = c);
    }
    if (null != h) return "ordinal" === h ? SS.Must : SS.Not;
    if (e === vS) {
      var p = t;
      if (n === bS) {
  ...
  function Ul(t) {
    ...
    return (
      t &&
        v(Hi(t.replaceMerge), function (t) {
          e.set(t, !0);
        }),
  ...
  function tu(t) {
    if (GS(t)) {
      Zl(t),
        ...
        t.emphasis &&
          (Jl(t.emphasis, "label"),
          Jl(t.emphasis, "upperLabel"),
          Jl(t.emphasis, "edgeLabel"));
      var e = t.markPoint;
      e && (Zl(e), Ql(e));
      var n = t.markLine;
      n && (Zl(n), Ql(n));
      ...
      if ("graph" === t.type) {
        ...
        if (o && !P(o)) for (var a = 0; a < o.length; a++) Ql(o[a]);
        v(t.categories, function (t) {
          $l(t);
        });
      }
      if (r && !P(r)) for (var a = 0; a < r.length; a++) Ql(r[a]);
      ...
      if (((n = t.markLine), n && n.data))
        for (var l = n.data, a = 0; a < l.length; a++)
          T(l[a]) ? (Ql(l[a][0]), Ql(l[a][1])) : Ql(l[a]);
      "gauge" === t.type
        ? (Jl(t, "axisLabel"), Jl(t, "title"), Jl(t, "detail"))
        : "treemap" === t.type
  ...
  function iu(t, e) {
    ...
    e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"),
      WS(n, function (e) {
        WS(eu(t[e]), function (t) {
          t && (Jl(t, "axisLabel"), Jl(t.axisPointer, "label"));
        });
      }),
      WS(eu(t.parallel), function (t) {
        var e = t && t.parallelAxisDefault;
        Jl(e, "axisLabel"), Jl(e && e.axisPointer, "label");
      }),
      WS(eu(t.calendar), function (t) {
        Kl(t, "itemStyle"),
          Jl(t, "dayLabel"),
          Jl(t, "monthLabel"),
          Jl(t, "yearLabel");
      }),
      WS(eu(t.radar), function (t) {
        Jl(t, "name"),
          t.name &&
            null == t.axisName &&
      ...
      WS(eu(t.geo), function (t) {
        GS(t) &&
          (Ql(t),
          WS(eu(t.regions), function (t) {
            Ql(t);
          }));
      }),
      WS(eu(t.timeline), function (t) {
      ...
      WS(eu(t.toolbox), function (t) {
        Kl(t, "iconStyle"),
          WS(t.feature, function (t) {
            Kl(t, "iconStyle");
          });
      }),
      Jl(nu(t.axisPointer), "label"),
      Jl(nu(t.tooltip).axisPointer, "label");
  }
  function ru(t, e) {
    for (
      ...
      v(t.series, function (t) {
        if (I(t)) {
          ...
          if ("line" === e) null != t.clipOverflow && (t.clip = t.clipOverflow);
            ...
            var n = t.data;
            if (n && !P(n)) for (var i = 0; i < n.length; i++) lu(n[i]);
            null != t.hoverOffset &&
              ((t.emphasis = t.emphasis || {}),
      ...
      var i = [],
        ...
        l = a.map(o, function (o, l, u) {
          ...
          for (var f = 0 / 0, d = n - 1; d >= 0; d--) {
            var g = t[d];
            if (
              (s || (p = g.data.rawIndexOf(g.stackedByDimension, c)), p >= 0)
            ) {
  ...
  function vu(t, e, n, i) {
    ...
    var r = e.seriesLayoutBy,
      o = wu(t, n, r, e.sourceHeader, e.dimensions),
      a = new qS({
        data: t,
        sourceFormat: n,
        seriesLayoutBy: r,
  ...
  function yu(t) {
    return new qS({ data: t, sourceFormat: P(t) ? _S : gS });
  }
  function mu(t) {
    return new qS({
      data: t.data,
  ...
  function wu(t, e, n, i, r) {
    ...
    if (e === vS) {
      ...
      "auto" === i || null == i
        ...
        (o = r ? r.length : n === bS ? s.length : s[0] ? s[0].length : null);
    } else if (e === yS) r || (r = bu(t));
    else if (e === mS)
      r ||
        ((r = []),
        v(t, function (t, e) {
  ...
  function Iu(t, e, n) {
    if (t) {
      ...
      if (null != i) {
        ...
        return s && ((r = s.name), (o = s.index)), Du(a)(i, o, r);
      }
    }
  }
  function Au(t) {
    var e, n;
    return (
      I(t) ? t.type && (n = t) : (e = t), { markupText: e, markupFragment: n }
    );
  }
  function Pu(t) {
    return new rT(t);
  ...
  function Ou(t, e) {
    ...
    e.__isBuiltIn &&
      ...
      (n.getRawData = yy(Ru, null, t))),
      (n.cloneRawData = yy(Bu, null, t));
    var p = Cu(r, wS);
    n.count = yy(p, null, i, o, s);
    var f = Du(r);
    ...
    return (
      (n.getDimensionInfo = yy(Eu, null, s, l)),
      (n.cloneAllDimensionInfo = yy(Nu, null, s)),
      n
    );
  }
  function Ru(t) {
  ...
  function Hu(t, e) {
    ...
    return y(a, function (t, n) {
      ...
      if (a && 0 === n && !t.dimensions) {
        ...
        o = { seriesLayoutBy: wS, sourceHeader: 0, dimensions: t.dimensions };
      return vu(t.data, o, null, null);
    });
  }
  function Vu(t) {
    return t === vS || t === yS;
  ...
  function Ju(t, e, n) {
    ...
    return '<span style="' + n + ";" + i + '">' + pl(t) + "</span>";
  }
  function Qu(t, e, n, i) {
    var r = n ? "10px" : "20px",
  ...
  function yh(t, e, n) {
    var i = rr(t, e),
      r = e && null != e.highlightKey ? ba(e.highlightKey) : null;
    null != i
      ? v(Hi(i), function (e) {
  ...
  function bh(t, e) {
    ...
    return n
      ? n
      : (console.warn("Unkown style type '" + e + "'."), kT.itemStyle);
  }
  function Sh(t, e) {
    var n = t.visualDrawType || IT[e];
  ...
  function Th(t, e) {
    ...
    var n = new n_(),
      i = new Hx({ style: { fill: e.maskColor }, zlevel: e.zlevel, z: 1e4 });
    n.add(i);
    var r = new Ux({
        style: {
          text: e.text,
    ...
    return (
      e.showSpinner &&
        ...
        a
          .animateShape(!0)
          .when(1e3, { endAngle: (3 * RT) / 2 })
          .start("circularInOut"),
        a
          .animateShape(!0)
          .when(1e3, { startAngle: (3 * RT) / 2 })
          .delay(300)
          .start("circularInOut"),
        n.add(a)),
      (n.resize = function () {
  ...
  function zh(t, e, n, i, r, o, a, s, l) {
    (a -= t), (s -= e);
    var u = Math.sqrt(a * a + s * s);
    (a /= u), (s /= u);
    var h = a * n + t,
      c = s * n + e;
    if (Math.abs(i - r) % ZT < 1e-4) return (l[0] = h), (l[1] = c), u - n;
    if (o) {
      var p = i;
      (i = co(r)), (r = co(p));
    } else (i = co(i)), (r = co(r));
    ...
    if (
      (0 > f && (f += ZT), (f >= i && r >= f) || (f + ZT >= i && r >= f + ZT))
    )
  ...
  function Vh(t, e, n) {
    var i = Hh(e.x, e.y, e.width, e.height, t.x, t.y, JT);
    return n.set(JT[0], JT[1]), i;
  }
  function Wh(t, e, n) {
    for (
      var i,
      ...
      switch (d) {
        ...
        case KT.C:
          ...
          break;
        case KT.Q:
          (g = Qr(o, a, h[f++], h[f++], h[f], h[f + 1], c, p, JT)),
            (o = h[f++]),
            (a = h[f++]);
          break;
        case KT.A:
        ...
        case KT.R:
          ...
          break;
        case KT.Z:
          (g = Fh(o, a, s, l, c, p, JT, !0)), (o = s), (a = l);
      }
      u > g && ((u = g), n.set(JT[0], JT[1]));
    }
    return u;
  }
  function Gh(t, e) {
    if (t) {
      ...
      if (i && n) {
        ...
        for (var f = 0; f < a.length; f++) {
          var d = a[f];
          Nh(d, 0, s, QT, nM), dm.scaleAndAdd(tM, QT, nM, p), tM.transform(c);
        ...
        Uh(o, e.get("minTurnAngle")), n.setShape({ points: o });
      }
    }
  }
  function Uh(t, e) {
    if (180 >= e && e > 0) {
      ...
      var n = nM.len(),
        i = iM.len();
      if (!(0.001 > n || 0.001 > i)) {
        nM.scale(1 / n), iM.scale(1 / i);
        var r = nM.dot(iM),
          o = Math.cos(e);
        if (r > o) {
          var a = Fh(tM.x, tM.y, eM.x, eM.y, QT.x, QT.y, rM, !1);
          oM.fromArray(rM), oM.scaleAndAdd(iM, a / Math.tan(Math.PI - e));
          var s =
            eM.x !== tM.x
              ? (oM.x - tM.x) / (eM.x - tM.x)
              : (oM.y - tM.y) / (eM.y - tM.y);
          if (isNaN(s)) return;
          0 > s ? dm.copy(oM, tM) : s > 1 && dm.copy(oM, eM), oM.toArray(t[1]);
        }
      }
    }
  }
  function Yh(t, e, n) {
    if (180 >= n && n > 0) {
      ...
      var i = nM.len(),
        r = iM.len();
      if (!(0.001 > i || 0.001 > r)) {
        nM.scale(1 / i), iM.scale(1 / r);
        var o = nM.dot(e),
          a = Math.cos(n);
        if (a > o) {
          var s = Fh(tM.x, tM.y, eM.x, eM.y, QT.x, QT.y, rM, !1);
          oM.fromArray(rM);
          var l = Math.PI / 2,
            u = Math.acos(iM.dot(e)),
            h = l + u - n;
          if (h >= l) dm.copy(oM, eM);
          else {
            oM.scaleAndAdd(iM, s / Math.tan(Math.PI / 2 - h));
            var c =
              eM.x !== tM.x
                ? (oM.x - tM.x) / (eM.x - tM.x)
                : (oM.y - tM.y) / (eM.y - tM.y);
            if (isNaN(c)) return;
            0 > c ? dm.copy(oM, tM) : c > 1 && dm.copy(oM, eM);
          }
          oM.toArray(t[1]);
        }
      }
  ...
  function qh(t, e, n) {
    ...
    for (
      ...
      if (h) {
        var f = h.get("show"),
          d = p ? s : z(r.states[u] && r.states[u].ignore, s);
        if (d || !z(f, a)) {
    ...
    if (i) {
      ...
      (y.showAbove = v || !1), (i.buildPath = jh);
    }
  }
  function Zh(t, e) {
    e = e || "labelLine";
  ...
  function tc(t) {
    ...
    for (var i = new Sm(0, 0, 0, 0), r = 0; r < t.length; r++) {
      var o = t[r],
        a = o.axisAligned,
        s = o.localRect,
        l = o.transform,
      ...
      for (var c = o.obb, p = !1, f = 0; f < n.length; f++) {
        ...
        if (i.intersect(d.rect)) {
          ...
          if (
            (d.obb || (d.obb = new lb(d.localRect, d.transform)),
            c || (c = new lb(s, l)),
            c.intersect(d.obb))
          ) {
            p = !0;
  ...
  function uc(t, e, n, i, r, o, a) {
    ...
    return (
      (l =
        0 === t.indexOf("image://")
          ? Ka(t.slice(8), new Sm(e, n, i, r), a ? "center" : "cover")
          : 0 === t.indexOf("path://")
          ? Za(t.slice(7), {}, new Sm(e, n, i, r), a ? "center" : "cover")
          : new bM({
  ...
  function xc(t, e, n, i) {
    ...
    if (!i) {
      var h = n.fill,
        ...
        x = void 0,
        w = void 0;
      (p || f) && (w = e.getBoundingRect()),
        p &&
          ((v = e.__dirty ? pc(t, h, w) : e.__canvasFillGradient),
          (e.__canvasFillGradient = v)),
        f &&
          ((m = e.__dirty ? pc(t, c, w) : e.__canvasStrokeGradient),
        ...
        p ? (t.fillStyle = v) : d && (_ ? (t.fillStyle = _) : (o = !1)),
        f ? (t.strokeStyle = m) : g && (x ? (t.strokeStyle = x) : (r = !1));
    }
    var b = n.lineDash && n.lineWidth > 0 && dc(n.lineDash, n.lineWidth),
      S = n.lineDashOffset,
      T = !!t.setLineDash,
      M = e.getGlobalScale();
    ...
    var D = !0;
    (l || e.__dirty & Px.SHAPE_CHANGED_BIT || (b && !T && r)) &&
      (u.setDPR(t.dpr),
      s ? u.setContext(null) : (u.setContext(t), (D = !1)),
      u.reset(),
      b && !T && (u.setLineDash(b), u.setLineDashOffset(S)),
      e.buildPath(u, e.shape, i),
      u.toStatic(),
      e.pathUpdated()),
      D && u.rebuildPath(t, s ? a : 1),
      b && T && (t.setLineDash(b), (t.lineDashOffset = S)),
      i ||
        (n.strokeFirst
          ? (r && mc(t, n), o && yc(t, n))
          : (o && yc(t, n), r && mc(t, n))),
  ...
  function bc(t, e, n) {
    ...
    if ((null != i && (i += ""), i)) {
      ...
      n.strokeFirst
        ? (gc(n) && t.strokeText(i, n.x, n.y), vc(n) && t.fillText(i, n.x, n.y))
        : (vc(n) && t.fillText(i, n.x, n.y),
          gc(n) && t.strokeText(i, n.x, n.y)),
        r && t.setLineDash([]);
    }
  }
  function Sc(t, e, n, i, r) {
    ...
    if (i || e.opacity !== n.opacity) {
      ...
      t.globalAlpha = isNaN(a) ? P_.opacity : a;
    }
    (i || e.blend !== n.blend) &&
      (o || (Ac(t, r), (o = !0)),
      (t.globalCompositeOperation = e.blend || P_.blend));
    for (var s = 0; s < TM.length; s++) {
      var l = TM[s];
      (i || e[l] !== n[l]) &&
        (o || (Ac(t, r), (o = !0)), (t[l] = t.dpr * (e[l] || 0)));
    }
    return (
      (i || e.shadowColor !== n.shadowColor) &&
        (o || (Ac(t, r), (o = !0)),
        (t.shadowColor = e.shadowColor || P_.shadowColor)),
      o
    );
  }
  function Tc(t, e, n, i, r) {
    var o = Pc(e, r.inHover),
      a = i ? null : (n && Pc(n, r.inHover)) || {};
    if (o === a) return !1;
    var s = Sc(t, o, a, i, r);
    if (
      ((i || o.fill !== a.fill) &&
        (s || (Ac(t, r), (s = !0)), (t.fillStyle = o.fill)),
      (i || o.stroke !== a.stroke) &&
        (s || (Ac(t, r), (s = !0)), (t.strokeStyle = o.stroke)),
      ...
      t.lineWidth !== u && (s || (Ac(t, r), (s = !0)), (t.lineWidth = u));
    }
    for (var h = 0; h < MM.length; h++) {
      var c = MM[h],
        p = c[0];
      (i || o[p] !== a[p]) &&
        (s || (Ac(t, r), (s = !0)), (t[p] = o[p] || c[1]));
    }
    return s;
  }
  function Mc(t, e, n, i, r) {
    return Sc(t, Pc(e, r.inHover), n && Pc(n, r.inHover), i, r);
  }
  function Cc(t, e) {
    var n = e.transform,
      i = t.dpr || 1;
  ...
  function Oc(t, e, n, i) {
    ...
    if (!e.shouldBePainted(n.viewWidth, n.viewHeight, !1, !1))
      return (e.__dirty &= ~zm.REDARAW_BIT), void (e.__isRendered = !1);
    var o = e.__clipPaths,
      a = n.prevElClipPaths,
      s = !1,
      l = !1;
    if (
      ((!a || fc(o, a)) &&
        (a &&
          ...
          (n.allClipped = !1),
          (n.prevEl = null)),
        o && o.length && (Ac(t, n), t.save(), Dc(o, t, n), (s = !0)),
        (n.prevElClipPaths = o)),
      n.allClipped)
    )
    ...
    var u = n.prevEl;
    u || (l = s = !0);
    var h = e instanceof Px && e.autoBatch && Ic(e.style);
    s || kc(r, u.transform) ? (Ac(t, n), Cc(t, e)) : h || Ac(t, n);
    var c = Pc(e, n.inHover);
    e instanceof Px
      ? (n.lastDrawType !== CM && ((l = !0), (n.lastDrawType = CM)),
        Tc(t, e, u, l, n),
      ...
      ? (n.lastDrawType !== kM && ((l = !0), (n.lastDrawType = kM)),
        ...
        bc(t, e, c))
      : e instanceof Ex
      ? (n.lastDrawType !== DM && ((l = !0), (n.lastDrawType = DM)),
        Mc(t, e, u, l, n),
        wc(t, e, c))
      : e instanceof hb &&
        (n.lastDrawType !== IM && ((l = !0), (n.lastDrawType = IM)),
        Rc(t, e, n)),
      h && i && Ac(t, n),
      e.innerAfterBrush(),
  ...
  function Bc(t, e) {
    function n(t) {
      function e() {
        for (var t = 1, e = 0, n = m.length; n > e; ++e) t = zi(t, m[e]);
        for (var i = 1, e = 0, n = y.length; n > e; ++e) i = zi(i, y[e].length);
        t *= i;
      ...
      function n() {
        function t(t, e, n, a, l) {
          ...
          o ? w.appendChild(r.painter.paintOne(h)) : Lc(d, h);
        }
        d &&
          (d.clearRect(0, 0, x.width, x.height),
          s.backgroundColor &&
            ((d.fillStyle = s.backgroundColor),
            d.fillRect(0, 0, x.width, x.height)));
        for (var e = 0, n = 0; n < v.length; ++n) e += v[n];
        if (!(0 >= e))
          for (var a = -_, l = 0, u = 0, h = 0; a < b.height; ) {
            if (l % 2 === 0) {
              for (
                var c = (u / 2) % y.length, p = 0, f = 0, m = 0;
                p < 2 * b.width;
                ...
                if (0 >= S) break;
                if (f % 2 === 0) {
                  var T = 0.5 * (1 - s.symbolSize),
                    M = p + g[h][f] * T,
                    C = a + v[l] * T,
                    D = g[h][f] * s.symbolSize,
                    k = v[l] * s.symbolSize,
                    I = (m / 2) % y[c].length;
                  t(M, C, D, k, y[c][I]);
                }
      ...
      for (var a = [i], l = !0, u = 0; u < LM.length; ++u) {
        var h = s[LM[u]],
          c = typeof h;
        if (
          null != h &&
  ...
  function Ec(t) {
    ...
    for (var i = [], n = 0; n < t.length; ++n)
      i.push("string" == typeof t[n] ? [t[n]] : t[n]);
    return i;
  }
  function Nc(t) {
  ...
  function jc(t, e, n, i, r) {
    var o = e,
      ...
      s = {};
    1 === t.nodeType && (Jc(t, e), Qc(t, a, s), i || tp(t, a, s)),
      (o.style = o.style || {}),
      null != a.fill && (o.style.fill = Zc(o, "fill", a.fill, n)),
      null != a.stroke && (o.style.stroke = Zc(o, "stroke", a.stroke, n)),
      v(
        [
          "lineWidth",
          "opacity",
      ...
      r && (o.__selfStyle = s),
      a.lineDash &&
        (o.style.lineDash = y($c(a.lineDash), function (t) {
          return parseFloat(t);
        })),
  ...
  function Jc(t, e) {
    ...
    if (n) {
      ...
      for (var o = i.length - 1; o > 0; o -= 2) {
        ...
        switch (((r = r || ze()), s)) {
          case "translate":
            (l = $c(a)), We(r, r, [parseFloat(l[0]), parseFloat(l[1] || "0")]);
            break;
          case "scale":
            (l = $c(a)), Ue(r, r, [parseFloat(l[0]), parseFloat(l[1] || l[0])]);
            break;
          case "rotate":
            (l = $c(a)), Ge(r, r, (-parseFloat(l[0]) / 180) * Math.PI);
            break;
          case "skew":
  ...
  function Qc(t, e, n) {
    ...
    if (i) {
      WM.lastIndex = 0;
      for (var r; null != (r = WM.exec(i)); ) {
        var o = r[1],
          a = Z(OM, o) ? OM[o] : null;
        a && (e[a] = r[2]);
        var s = Z(BM, o) ? BM[o] : null;
        s && (n[s] = r[2]);
      }
    }
  }
  ...
  function rp(t, e, n) {
    ...
    var s = t[0];
    return (
      (ip(r[0], s[0]) && ip(r[1], s[1])) ||
        (i += fo(r[0], r[1], s[0], s[1], e, n)),
      0 !== i
    );
  }
  function op(t) {
    ...
    for (var i = e.features, r = 0; r < i.length; r++) {
      ...
      if ("Polygon" === a.type)
        for (var s = a.coordinates, l = 0; l < s.length; l++)
          s[l] = lp(s[l], a.encodeOffsets[l], n);
      else if ("MultiPolygon" === a.type)
        for (var s = a.coordinates, l = 0; l < s.length; l++)
          for (var u = s[l], h = 0; h < u.length; h++)
            u[h] = lp(u[h], a.encodeOffsets[l][h], n);
    }
  ...
  function fp(t, e) {
    "china" === t &&
      "台湾" === e.name &&
      e.geometries.push({ type: "polygon", exterior: nC[0] });
  }
  function dp(t) {
    for (var e, n = 0; n < t.length; n++) {
  ...
  function mp(t, e, n) {
    return (n[0] = n[0] && n[0].toLowerCase()), ky.prototype[e].apply(t, n);
  }
  function _p(t, e, n) {
    var i = Sp(t);
    if (i) return i;
  ...
  function bp(t) {
    "string" == typeof t ? (t = wD[t]) : t instanceof uD || (t = Sp(t)),
      t instanceof uD && !t.isDisposed() && t.dispose();
  }
  function Sp(t) {
    return wD[hr(t, MD)];
  }
  ...
  function kp(t) {
    cC(vD, t) < 0 && t && vD.push(t);
  }
  function Ip(t) {
    cC(yD, t) < 0 && t && yD.push(t);
  }
  function Ap(t, e, n) {
    "function" == typeof e && ((n = e), (e = ""));
    var i = hC(t) ? t.type : [t, (t = { event: e })][0];
    (t.event = (t.event || i).toLowerCase()),
      (e = t.event),
      fD[e] ||
        (sC(BC.test(i) && BC.test(e)),
        pD[i] || (pD[i] = { action: n, actionInfo: t }),
        (fD[e] = i));
  }
  function Pp(t, e) {
    FS.register(t, e);
  ...
  function Bp(t, e, n, i, r) {
    if (((uC(e) || hC(e)) && ((n = e), (e = i)), !(cC(DD, n) >= 0))) {
      DD.push(n);
      var o = BT.wrapStageHandler(n, r);
  ...
  function zp(t, e, n) {
    aC.registerMap(t, e, n);
  }
  function Fp(t) {
    return aC.getMapForUser(t);
  }
  function Hp(t) {
  ...
  function Wp(t) {
      ...
      if (l) {
        ...
        (Gp(n, l)[u] = e),
          s.isExtraCoord ||
            (i.set(l, 1),
            Yp(s.type) && (r[0] = e),
            (Gp(a.encode, l)[u] = s.index)),
          s.defaultTooltip && o.push(e);
      }
      dS.each(function (t, e) {
        var i = Gp(n, e),
          r = s.otherDims[e];
    ...
    var h = n.tooltip;
    return (
      h && h.length ? (o = h.slice()) : o.length || (o = r.slice()),
      (n.defaultedLabel = r),
  ...
  function Xp(t, e, n) {
    ...
    gu(e) || (e = yu(e)), (n = n || {}), (t = (t || []).slice());
    for (
      var r = (n.dimsDef || []).slice(),
        o = X(),
        a = X(),
        l = [],
        u = jp(e, t, r, n.dimCount),
        p = 0;
      u > p;
      p++
    ) {
      var f = r[p],
        d = (r[p] = h({}, I(f) ? f : { name: f })),
        g = d.name,
        y = (l[p] = new YD());
      null != g &&
        null == o.get(g) &&
        ((y.name = y.displayName = g), o.set(g, p)),
        null != d.type && (y.type = d.type),
        null != d.displayName && (y.displayName = d.displayName);
    }
    var m = n.encodeDef;
      ...
      if (u !== !1) {
        ...
        v(u, function (t, a) {
          ...
          if ((i(c(s, o), e, a), null == s.name && n)) {
            var u = n[a];
            !I(u) && (u = { name: u }),
              (s.name = s.displayName = u.name),
              (s.defaultTooltip = u.defaultTooltip);
          }
          r && c(s.otherDims, r);
        });
      }
    ...
    for (var T = w || "value", M = 0; u > M; M++) {
      var y = (l[M] = l[M] || new YD()),
        D = y.coordDim;
      null == D &&
        ((y.coordDim = qp(T, a, S)),
        (y.coordDimIndex = 0),
        (!w || 0 >= b) && (y.isExtraCoord = !0),
        b--),
        null == y.name && (y.name = qp(y.coordDim, o, !1)),
        null != y.type ||
          (Rl(e, M) !== SS.Must &&
            (!y.isExtraCoord ||
              (null == y.otherDims.itemName &&
                null == y.otherDims.seriesName))) ||
          (y.type = "ordinal");
    }
    return l;
  }
  ...
  function ef(t, e, n) {
    ...
    var s,
      ...
      h = Zp(t, {
        ...
        encodeDefaulter: M(u) ? u : u ? S(Al, i, e) : null,
      });
    a &&
      v(h, function (t, e) {
        var i = t.coordDim,
        ...
        r &&
          (null == s && (s = e),
          (t.ordinalMeta = r.getOrdinalMeta()),
          n.createInvertedIndices && (t.createInvertedIndices = !0)),
  ...
  function af(t, e, n, i) {
    ...
    var s = (r.intervalPrecision = sf(a)),
      l = (r.niceTickExtent = [
        uk(Math.ceil(t[0] / a) * a, s),
        uk(Math.floor(t[1] / a) * a, s),
      ]);
    return uf(l, t), r;
  }
  function sf(t) {
  ...
  function Tf(t) {
    return (t /= Yb), t > 16 ? 16 : t > 7.5 ? 7 : t > 3.5 ? 4 : t > 1.5 ? 2 : 1;
  }
  function Mf(t) {
    var e = 30 * Yb;
  ...
  function Af(t, e, n, i) {
      ...
      if (!Sf(Ws(t), i[0], i[1], n)) {
        ...
        for (var u = 0; u < o.length - 1; u++) {
          ...
          if (h !== c) {
            ...
            switch (t) {
              case "year":
                (p = Math.max(1, Math.round(e / Yb / 365))),
                  (f = Zs(n)),
                  (d = nl(n));
                break;
              case "half-year":
              case "quarter":
              case "month":
                (p = Mf(e)), (f = Ks(n)), (d = il(n));
                break;
              case "week":
              case "half-week":
              case "day":
                (p = Tf(e, 31)), (f = $s(n)), (d = rl(n)), (g = !0);
                break;
              case "half-day":
              case "quarter-day":
              case "hour":
                ...
                break;
              case "minute":
                (p = Df(e, !0)), (f = Qs(n)), (d = al(n));
                break;
              case "second":
                (p = Df(e, !1)), (f = tl(n)), (d = sl(n));
                break;
              case "millisecond":
                (p = kf(e)), (f = el(n)), (d = ll(n));
            }
            r(p, h, c, f, d, g, s),
              "year" === t &&
                a.length > 1 &&
    ...
    for (
      var a = 1e4, s = $b, l = 0, u = [], h = [], c = 0, p = 0, f = 0;
      f < s.length && l++ < a;
      ++f
    ) {
      var d = Ws(s[f]);
    ...
    for (
      ...
      for (var M = b[f], C = 0; C < M.length; ++C)
        S.push({ value: M[C].value, level: T - f });
    S.sort(function (t, e) {
      return t.value - e.value;
    });
    for (var D = [], f = 0; f < S.length; ++f)
      (0 === f || S[f].value !== S[f - 1].value) && D.push(S[f]);
    return D;
  }
  function Pf(t, e) {
    return bk(t, wk(e));
  ...
  function Lf(t, e, n) {
    ...
    return i ? i : ((i = new Ik(t, e, n)), (t.rawExtentInfo = i), i);
  }
  function Of(t, e) {
  ...
  function Rf(t, e) {
    var n = t.type,
      i = Lf(t, e, t.getExtent()).calculate();
  ...
  function Ef(t, e) {
    var n = Rf(t, e),
      i = n.extent,
      r = e.get("splitNumber");
    t instanceof Dk && (t.base = e.get("logBase"));
    var o = t.type;
    t.setExtent(i[0], i[1]),
      t.niceExtent({
        splitNumber: r,
    ...
    return "time" === t.scale.type
      ...
      ? (function (e) {
          return function (i, r) {
            return (
              null != n && (r = i.value - n),
              e(Ff(t, i), r, null != i.level ? { level: i.level } : null)
            );
          };
        })(e)
      : function (e) {
  ...
  function Gf(t, e) {
    var n = e;
    e instanceof Lb || (n = new Lb(e));
    var i = Nf(n);
    return i.setExtent(t[0], t[1]), Ef(i, n), i;
  }
  function Uf(t) {
    d(t, Lk);
  }
  ...
  function Xf(t) {
    return T(t)
      ...
      : void (
          p(Bk, t) >= 0 ||
          (Bk.push(t), M(t) && (t = { install: t }), t.install(Ek))
        );
  }
  function jf(t) {
    return "category" === t.type ? Zf(t) : Jf(t);
  }
  function qf(t, e) {
  ...
  function Kf(t, e) {
    ...
    var o, a;
    return (
      M(i) ? (o = ad(t, i)) : ((a = "auto" === i ? nd(t) : i), (o = od(t, a))),
      ed(n, i, { labels: o, labelCategoryInterval: a })
    );
  }
  function $f(t, e) {
    var n = Qf(t, "ticks"),
    ...
    if (r) return r;
    var o, a;
    if (((!e.get("show") || t.scale.isBlank()) && (o = []), M(i)))
      o = ad(t, i, !0);
    else if ("auto" === i) {
      var s = Kf(t, t.getLabelModel());
      (a = s.labelCategoryInterval),
        (o = y(s.labels, function (t) {
          return t.tickValue;
        }));
    } else (a = i), (o = od(t, a, !0));
    return ed(n, i, { ticks: o, tickCategoryInterval: a });
  }
  function Jf(t) {
  ...
  function id(t) {
    ...
    for (
      ...
      var d = 0,
        g = 0,
        v = Rn(n({ value: l }), e.font, "center", "top");
      (d = 1.3 * v.width),
        (g = 1.3 * v.height),
        (p = Math.max(p, d, 7)),
        (f = Math.max(f, g, 7));
  ...
  function md(t) {
    t.registerPainter("canvas", Kk);
  }
  function _d(t) {
    t.registerComponentModel($k), t.registerComponentView(Jk);
  }
  function xd(t, e) {
        ...
        if (0.001 >= S) {
          ...
          e.each(i, function (t, n) {
            if (!isNaN(t)) {
              ...
              (i.angle = k),
                (i.startAngle = d + D * n * k),
                (i.endAngle = d + D * (n + 1) * k);
            }
          });
        } else
          (m = S / M),
            ...
            e.each(i, function (t, n) {
              if (!isNaN(t)) {
                var i = e.getItemLayout(n),
                  r = i.angle === g ? g : t * m;
                (i.startAngle = C), (i.endAngle = C + D * r), (C += D * r);
              }
            });
    });
  }
  ...
  function Sd(t, e, n, i, r, o, a, s, l, u) {
    function h(t) {
  ...
  function Td(t, e, n, i, r, o, a, s) {
    ...
    Sd(u, e, n, i, 1, r, o, a, s, c), Sd(l, e, n, i, -1, r, o, a, s, h);
      ...
      if (!Md(d)) {
        ...
        if (g) {
          ...
          (m = v
            ...
            m < d.rect.width &&
              ((d.label.style.width = m), "edge" === d.labelAlignTo && (y = m));
          var _ = g[1][0] - g[2][0];
          v
            ? (g[2][0] =
                f.x < e
                  ? a + d.edgeDistance + y + d.labelDistance
                  : a + r - d.edgeDistance - y - d.labelDistance)
            : ((g[2][0] =
  ...
  function Cd(t) {
    ...
    var i,
      ...
      a = [],
      s = !1,
      l = (t.get("minShowLabelAngle") || 0) * eI,
    ...
    o.each(function (t) {
      ...
      M = _i(M, c);
      var C = T.get("length2");
      if (((C = _i(C, c)), Math.abs(f.endAngle - f.startAngle) < l))
      ...
      if (n(d)) {
        var D,
          ...
          I,
          A,
          P = (f.startAngle + f.endAngle) / 2,
          L = Math.cos(P),
          O = Math.sin(P);
        (i = f.cx), (r = f.cy);
        var R = "inside" === _ || "inner" === _;
        if ("center" === _) (D = f.cx), (k = f.cy), (A = "center");
        else {
          var B = (R ? ((f.r + f.r0) / 2) * L : f.r * L) + i,
            E = (R ? ((f.r + f.r0) / 2) * O : f.r * O) + r;
          if (((D = B + 3 * L), (k = E + 3 * O), !R)) {
            var N = B + L * (M + h - f.r),
              z = E + O * (M + h - f.r),
              F = N + (0 > L ? -1 : 1) * C,
              H = z;
      ...
      !s && t.get("avoidLabelOverlap") && Td(a, i, r, h, c, d, p, f);
    for (var g = 0; g < a.length; g++) {
      ...
      if (_) {
        ...
        x || !b
          ...
          : (Uh(b, y.minTurnAngle),
            Yh(b, y.surfaceNormal, y.maxSurfaceAngle),
            _.setShape({ points: b }),
            (m.__hostTarget.textGuideLineConfig = {
              anchor: new dm(b[0][0], b[0][1]),
            }));
      }
    }
  }
  function Dd(t, e) {
    ...
    return null == n
      ? null
      : (T(n) || (n = [n, n]),
        { innerCornerRadius: zn(n[0], e.r0), cornerRadius: zn(n[1], e.r) });
  }
  function kd(t, e, n) {
  ...
  function Id(t) {
    t.registerChartView(iI),
      t.registerSeriesModel(oI),
      rc("pie", t.registerAction),
      t.registerLayout(S(wd, "pie")),
      t.registerProcessor(bd("pie"));
  }
  function Ad(t, e) {
    var n,
      i = t.cellSize;
    (n = T(i) ? i : (t.cellSize = [i, i])), 1 === n.length && (n[1] = n[0]);
    var r = y([0, 1], function (t) {
      return Sl(e, t) && (n[t] = "auto"), null != n[t] && "auto" !== n[t];
    });
    Ml(t, e, { type: "box", ignoreSize: r });
  }
  function Pd(t) {
    var e = t.calendarModel,
      n = t.seriesModel,
      i = e ? e.coordinateSystem : n ? n.coordinateSystem : null;
    return i;
  }
  function Ld(t) {
    t.registerComponentModel(aI),
      t.registerComponentView(uI),
      t.registerCoordinateSystem("calendar", cI);
  }
  function Od(t) {
    t.registerComponentModel(pI), t.registerComponentView(fI);
  }
  function Rd(t, e) {
    var n = Jb(e.get("padding")),
  ...
  function Bd(t, e, n, i, r, o, a) {
    ...
    for (
      var d = e.getModel("lineStyle"),
        g = Cb.concat([["inactiveColor"], ["inactiveWidth"]]),
        v = {},
        h = 0;
      h < g.length;
      ++h
      ...
      "inherit" === f
        ? (v[p] = i[p])
        : "auto" === f && "lineWidth" === p
        ? (v.lineWidth = i.lineWidth > 0 ? 2 : 0)
        : (v[p] = f);
    }
    if (
      ("auto" === u.fill && (u.fill = r.fill),
      "auto" === u.stroke && (u.stroke = r.fill),
      "auto" === v.stroke && (v.stroke = r.fill),
      !a)
    ) {
      var y = e.get("inactiveBorderWidth"),
        m = u[t.indexOf("empty") > -1 ? "fill" : "stroke"];
      (u.lineWidth =
        "auto" === y ? (r.lineWidth > 0 && m ? 2 : 0) : u.lineWidth),
        (u.fill = e.get("inactiveColor")),
        (u.stroke = e.get("inactiveBorderColor")),
        (v.stroke = n.get("inactiveColor")),
        (v.lineWidth = n.get("inactiveWidth"));
    }
  ...
  function Gd(t) {
    t.registerAction(
      ...
      t.registerAction("legendSelect", "legendselected", S(Wd, "select")),
      t.registerAction("legendUnSelect", "legendunselected", S(Wd, "unSelect"));
  }
  function Ud(t) {
    t.registerComponentModel(gI),
      t.registerComponentView(_I),
      t.registerProcessor(t.PRIORITY.PROCESSOR.SERIES_FILTER, Vd),
  ...
  function Yd(t, e, n) {
    var i = t.getOrient(),
      r = [1, 1];
    (r[i.index] = 0), Ml(e, n, { type: "box", ignoreSize: !!r });
  }
  function Xd(t) {
  ...
  function jd(t) {
    Xf(Ud), t.registerComponentModel(xI), t.registerComponentView(TI), Xd(t);
  }
  function qd(t, e) {
    var n = {
      axesInfo: {},
    ...
    return Zd(n, t, e), n.seriesInvolved && $d(n, t), n;
  }
  function Zd(t, e, n) {
  ...
  function Kd(t, e, n, i, r, o) {
    ...
    return t.model.getModel("axisPointer", new Lb(u, n, i));
  }
  function $d(t, e) {
    e.eachSeries(function (e) {
      ...
      n &&
        ...
        v(t.coordSysAxesInfo[rg(n.model)], function (t) {
          var i = t.axis;
          n.getAxis(i.dim) === i &&
  ...
  function Jd(t, e) {
    for (var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
      ...
      if (
        Qd(o[i + "AxisId"], n.id) ||
        Qd(o[i + "AxisIndex"], n.componentIndex) ||
        Qd(o[i + "AxisName"], n.name)
      )
        return r;
    }
  }
  ...
  function og(t, e, n, i) {
    ag(DI(n).lastProp, i) ||
      ((DI(n).lastProp = i), e ? ns(n, i, t) : (n.stopAnimation(), n.attr(i)));
  }
  function ag(t, e) {
    if (I(t) && I(e)) {
      var n = !0;
  ...
  function cg(t, e, n) {
    if (!Vf(t.axis)) {
      ...
      i === !1
        ? (pg(o), pg(u))
        : fg(o, a) && (i ? (pg(a), pg(h)) : (pg(o), pg(u))),
        r === !1
          ? (pg(s), pg(c))
          : fg(l, s) && (r ? (pg(l), pg(p)) : (pg(s), pg(c)));
    }
  }
  function pg(t) {
    t && (t.ignore = !0);
    ...
    if (o.get("show") && !r.scale.isBlank()) {
      ...
      if (a.length)
        for (
          ...
          for (
            var p = gg(a[h], e.transform, l, u, "minorticks_" + h), f = 0;
            f < p.length;
            f++
          )
            t.add(p[f]);
  ...
  function mg(t, e, n, i) {
    var r = n.axis,
      o = N(i.axisLabelShow, n.get(["axisLabel", "show"]));
    if (o && !r.scale.isBlank()) {
      var a = n.getModel("axisLabel"),
        s = a.get("margin"),
        l = r.getViewLabels(),
        u = ((N(i.labelRotate, a.get("rotate")) || 0) * PI) / 180,
        h = LI.innerTextLayout(i.rotation, u, i.labelDirection),
        c = n.getCategories && n.getCategories(!0),
        p = [],
        f = LI.isLabelSilent(n),
      ...
      return (
        v(l, function (o, l) {
          ...
          if (c && c[u]) {
            var m = c[u];
            I(m) && m.textStyle && (y = new Lb(m.textStyle, a, n.ecModel));
          }
          ...
          if (((w.anid = "label_" + u), d)) {
            var b = LI.makeAxisEventDataBase(n);
            (b.targetType = "axisLabel"), (b.value = v), (jx(w).eventData = b);
          }
          e.add(w),
            w.updateTransform(),
            p.push(w),
  ...
  function xg(t, e, n, i, r) {
    var o = n.get("value"),
      a = bg(o, e.axis, e.ecModel, n.get("seriesDataIndices"), {
        precision: n.get(["label", "precision"]),
        formatter: n.get(["label", "formatter"]),
      }),
      s = n.getModel("label"),
      l = Jb(s.get("padding") || 0),
      u = s.getFont(),
      h = Rn(a, u),
      c = r.position,
      p = h.width + l[1] + l[3],
  ...
  function Tg(t, e, n, i, r, o) {
    var a = LI.innerTextLayout(n.rotation, 0, n.labelDirection);
    (n.labelMargin = r.get(["label", "margin"])),
      xg(e, i, r, o, {
        position: Sg(i.axis, t, n),
        align: a.textAlign,
  ...
  function Ag(t, e, n) {
    if (!iy.node) {
      var i = e.getZr();
      NI(i).records || (NI(i).records = {}), Pg(i, e);
      var r = NI(i).records[t] || (NI(i).records[t] = {});
      r.handler = n;
    }
  }
  function Pg(t, e) {
  ...
  function zg(t, e, n) {
    var i = t.currTrigger,
      r = [t.x, t.y],
      o = t,
      a = t.dispatchAction || yy(n.dispatchAction, n),
    ...
    if (s) {
      ...
      var l = qg(r),
        ...
        f = {},
        d = { list: [], map: {} },
        g = { showPointer: S(Vg, f), showTooltip: S(Wg, d) };
        ...
        v(h, function (t, e) {
          ...
          n &&
            ...
            v(n.axesInfo, function (e, i) {
              ...
              if (e !== t && r) {
                var o = r.value;
                n.mapper && (o = t.axis.scale.parse(n.mapper(o, jg(e), jg(t)))),
                  (y[t.key] = o);
              }
            });
        }),
  ...
  function Ug(t, e, n, i) {
    if (qg(e) || !t.list.length) return void i({ type: "hideTip" });
  ...
  function Zg(t) {
    CI.registerAxisPointerClass("CartesianAxisPointer", RI),
      t.registerComponentModel(EI),
      t.registerComponentView(FI),
      ...
      t.registerProcessor(t.PRIORITY.PROCESSOR.STATISTIC, function (t, e) {
        t.getComponent("axisPointer").coordSysAxesInfo = qd(t, e);
      }),
      t.registerAction(
        {
  ...
  function ev(t, e, n) {
    ...
    p(["left", "right"], i) > -1
      ? ((r += "top:50%"),
        (o +=
          "translateY(-50%) rotate(" + ("left" === i ? -225 : -45) + "deg)"))
      : ((r += "left:50%"),
        (o += "translateX(-50%) rotate(" + ("top" === i ? 225 : 45) + "deg)"));
    var a = e + " solid 1px;",
      s = [
  ...
  function nv(t, e) {
    ...
    return (
      e ||
        ((i = " " + t + "s " + n),
        (r += iy.transformSupported ? "," + WI + i : ",left" + i + ",top" + i)),
      UI + ":" + r
    );
  }
  function iv(t, e, n) {
  ...
  function ov(t, e, n) {
    ...
    return (
      ...
      i.push(rv(h)),
      null != c && i.push("padding:" + Jb(c).join("px ") + "px"),
      i.join(";") + ";"
    );
  }
  ...
  function lv(t) {
    var e = sv(t.shadowBlur || 0),
      n = sv(t.shadowOffsetX || 0),
      i = sv(t.shadowOffsetY || 0);
    return {
      left: sv(e - n),
      right: sv(e + n),
      top: sv(e - i),
  ...
  function hv(t, e, n) {
    var i,
      r = e.ecModel;
    n ? ((i = new Lb(n, r, r)), (i = new Lb(e.option, i, r))) : (i = e);
    for (var o = t.length - 1; o >= 0; o--) {
      var a = t[o];
      a &&
        (a instanceof Lb && (a = a.get("tooltip", !0)),
        C(a) && (a = { formatter: a }),
        a && (i = new Lb(a, i, r)));
    }
    return i;
  ...
  function cv(t, e) {
    return t.dispatchAction || yy(e.dispatchAction, e);
  }
  ...
  function _v(t, e, n) {
    function i() {
      for (var i = -1 * a; a >= i; i += 2) {
        var s,
          u = l[i - 1],
          h = l[i + 1],
          c = (h ? h.newPos : 0) - i;
        u && (l[i - 1] = void 0);
        var p = u && u.newPos + 1 < r,
          f = h && c >= 0 && o > c;
        if (p || f) {
          if (
            (!p || (f && u.newPos < h.newPos)
              ? ((s = Sv(h)), wv(s.components, !1, !0))
              : ((s = u), s.newPos++, wv(s.components, !0, !1)),
            (c = xv(s, e, t, i, n)),
            s.newPos + 1 >= r && c + 1 >= o)
          )
            return bv(s.components);
          l[i] = s;
        } else l[i] = void 0;
      }
      a++;
    ...
    if (l[0].newPos + 1 >= r && u + 1 >= o) {
      ...
      return [{ indices: h, count: e.length, added: !1, removed: !1 }];
    }
    for (; s >= a; ) {
      var p = i();
      if (p) return p;
  ...
  function xv(t, e, n, i, r) {
    for (
      var o = e.length, a = n.length, s = t.newPos, l = s - i, u = 0;
      o > s + 1 && a > l + 1 && r(e[s + 1], n[l + 1]);

    )
      s++, l++, u++;
    return (
      u && t.components.push({ count: u, added: !1, removed: !1, indices: [] }),
      (t.newPos = s),
      l
    );
  }
  function wv(t, e, n) {
    ...
    i && i.added === e && i.removed === n
      ...
      : t.push({ count: 1, added: e, removed: n, indices: [] });
  }
  function bv(t) {
    for (var e = 0, n = t.length, i = 0, r = 0; n > e; e++) {
      var o = t[e];
      if (o.removed) {
        for (var a = r; a < r + o.count; a++) o.indices.push(a);
        r += o.count;
      } else {
        for (var s = [], a = i; a < i + o.count; a++) s.push(a);
        (o.indices = s), (i += o.count), o.added || (r += o.count);
      }
    }
    return t;
  }
  ...
  function Ov(t, e, n) {
    t.setAttributeNS("http://www.w3.org/XML/1998/namespace", e, n);
  }
  function Rv(t, e, n) {
    var i = null == e.opacity ? 1 : e.opacity;
    if (n instanceof Ex) return void (t.style.opacity = i + "");
    if (kv(e)) {
      var r = e.fill;
      (r = "transparent" === r ? tA : r),
        Pv(t, "fill", r),
        Pv(
          t,
          "fill-opacity",
          (null != e.fillOpacity ? e.fillOpacity * i : i) + "",
        );
    } else Pv(t, "fill", tA);
    if (Iv(e)) {
      var o = e.stroke;
      (o = "transparent" === o ? tA : o), Pv(t, "stroke", o);
      var a = e.lineWidth,
        s = e.strokeNoScale ? n.getLineScale() : 1;
      Pv(t, "stroke-width", (s ? a / s : 0) + ""),
        Pv(t, "paint-order", e.strokeFirst ? "stroke" : "fill"),
        Pv(
          t,
          "stroke-opacity",
          (null != e.strokeOpacity ? e.strokeOpacity * i : i) + "",
        );
      var l = e.lineDash && a > 0 && dc(e.lineDash, a);
      if (l) {
        var u = e.lineDashOffset;
        s &&
          1 !== s &&
          ((l = y(l, function (t) {
            return t / s;
          ...
          u && ((u /= s), (u = eA(u)))),
          Pv(t, "stroke-dasharray", l.join(",")),
          Pv(t, "stroke-dashoffset", (u || 0) + "");
      } else Pv(t, "stroke-dasharray", "");
      e.lineCap && Pv(t, "stroke-linecap", e.lineCap),
        e.lineJoin && Pv(t, "stroke-linejoin", e.lineJoin),
        e.miterLimit && Pv(t, "stroke-miterlimit", e.miterLimit + "");
    } else Pv(t, "stroke", tA);
  }
  function Bv(t, e, n) {
  ...
  function Jv(t) {
    return function () {
      a('In SVG mode painter not support method "' + t + '"');
    };
  }
  var Qv = function (t, e) {
      return (Qv =
  ...
  "object" == typeof wx && "function" == typeof wx.getSystemInfoSync
    ? ((iy.wxa = !0), (iy.canvasSupported = !0), (iy.touchEventsSupported = !0))
    : "undefined" == typeof document && "undefined" != typeof self
    ? ((iy.worker = !0), (iy.canvasSupported = !0))
    : "undefined" == typeof navigator
    ? ((iy.node = !0), (iy.canvasSupported = !0), (iy.svgSupported = !0))
    : i(navigator.userAgent, iy);
  var ry = {
      "[object Function]": !0,
      "[object RegExp]": !0,
      "[object Date]": !0,
    ...
    hy = sy.slice,
    cy = sy.map,
    py = function () {}.constructor,
    fy = py ? py.prototype : null,
    dy = {},
    gy = 2311,
    vy = function () {
      return dy.createCanvas();
    };
  dy.createCanvas = function () {
    return document.createElement("canvas");
  };
  var yy = fy && M(fy.bind) ? fy.call.bind(fy.bind) : b,
    my = "__ec_primitive__",
    _y = (function () {
      function t(e) {
        function n(t, e) {
      ...
      return (
        (t.prototype._dragStart = function (t) {
          ...
          e &&
            ...
            (this._x = t.offsetX),
            (this._y = t.offsetY),
            this.handler.dispatchToElement(new Cy(e, t), "dragstart", t.event));
        }),
        (t.prototype._drag = function (t) {
          ...
          if (e) {
            ...
            (this._x = n),
              (this._y = i),
              e.drift(r, o, t),
              this.handler.dispatchToElement(new Cy(e, t), "drag", t.event);
        ...
        (t.prototype._dragEnd = function (t) {
          var e = this._draggingTarget;
          e && (e.dragging = !1),
            this.handler.dispatchToElement(new Cy(e, t), "dragend", t.event),
            this._dropTarget &&
              this.handler.dispatchToElement(
                new Cy(this._dropTarget, t),
                "drop",
                t.event,
              ),
    ...
    Ay = "___zrEVENTSAVED",
    Py = [],
    Ly = "undefined" != typeof window && !!window.addEventListener,
    Oy = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    Ry = [],
    By = Ly
      ? function (t) {
    ...
    Ey = (function () {
      ...
      return (
        ...
        (t.prototype._recognize = function (t) {
          for (var e in Ny)
            if (Ny.hasOwnProperty(e)) {
              var n = Ny[e](this._track, t);
              if (n) return n;
            }
        }),
        t
    ...
    Wy = (function (t) {
      ...
      return (
        ...
        (n.prototype.mousemove = function (t) {
          ...
          var a = (this._hovered = i ? new Hy(e, n) : this.findHover(e, n)),
            s = a.target,
            l = this.proxy;
        ...
        (n.prototype.findHover = function (t, e, n) {
          for (
            ...
            if (
              ...
              !i[o].ignore &&
              (a = Ee(i[o], t, e)) &&
              (!r.topTarget && (r.topTarget = i[o]), a !== zy)
            ) {
              r.target = i[o];
              break;
            }
      ...
      Wy.prototype[t] = function (e) {
        ...
        if (
          ...
          if (
            ...
            !this._downPoint ||
            Sy(this._downPoint, [e.zrX, e.zrY]) > 4
          )
            return;
  ...
  var Gy,
    ...
    Jy = (function () {
      ...
      return (
        ...
        (t.prototype.updateTransform = function () {
          ...
          return n || e
            ? ((i = i || ze()),
              n ? this.getLocalTransform(i) : Xy(i),
              e && (n ? Ve(i, t.transform, i) : He(i, t.transform)),
              (this.transform = i),
              void this._resolveGlobalScaleRatio(i))
            : void (i && Xy(i));
        }),
        ...
        (t.prototype.setLocalTransform = function (t) {
          if (t) {
            var e = t[0] * t[0] + t[1] * t[1],
              n = t[2] * t[2] + t[3] * t[3];
            je(e - 1) && (e = Math.sqrt(e)),
              je(n - 1) && (n = Math.sqrt(n)),
              t[0] < 0 && (e = -e),
              t[3] < 0 && (n = -n),
              (this.rotation = Math.atan2(-t[1] / n, t[0] / e)),
              0 > e &&
                0 > n &&
                ((this.rotation += Math.PI), (e = -e), (n = -n)),
              (this.x = t[4]),
              (this.y = t[5]),
              (this.scaleX = e),
              (this.scaleY = n);
        ...
        (t.prototype.decomposeTransform = function () {
          if (this.transform) {
            var t = this.parent,
              e = this.transform;
            t && t.transform && (Ve(Zy, t.invTransform, e), (e = Zy));
            var n = this.originX,
              i = this.originY;
            (n || i) &&
              ((Ky[4] = n),
        ...
        (t.prototype.getLineScale = function () {
          ...
          return t && $y(t[0] - 1) > 1e-10 && $y(t[3] - 1) > 1e-10
            ? Math.sqrt($y(t[0] * t[3] - t[2] * t[1]))
            : 1;
        }),
    ...
    pm = (function () {
      ...
      return (
          ...
          if (this.interpolable)
            if (g(e)) {
              ...
              if (i > 0) {
                ...
                this._isAllValueEqual &&
                  (1 === r
                    ? Tn(e, o.value) || (this._isAllValueEqual = !1)
              ...
              if ("string" == typeof e) {
                var a = on(e);
                a
                  ? ((e = a), (this.isValueColor = !0))
                  : (this.interpolable = !1);
              } else if ("number" != typeof e || isNaN(e))
                return void (this.interpolable = !1);
              if (this._isAllValueEqual && i > 0) {
                var o = n[i - 1];
                this.isValueColor && !Tn(o.value, e)
                  ? (this._isAllValueEqual = !1)
                  : o.value !== e && (this._isAllValueEqual = !1);
              }
            }
        ...
        (t.prototype.prepare = function (t) {
          ...
          for (
            var n = this.arrDim, i = e.length, r = e[i - 1], o = 0;
            i > o;
            o++
          )
            (e[o].percent = e[o].time / this.maxTime),
              n > 0 && o !== i - 1 && Sn(e[o].value, r.value, n);
          if (
            t &&
            this.needsAnimate() &&
            t.needsAnimate() &&
            ...
            for (var a = e[0].value, o = 0; i > o; o++)
              0 === n
                ? (e[o].additiveValue = this.isValueColor
                    ? wn([], e[o].value, a, -1)
                    : e[o].value - a)
                : 1 === n
                ? (e[o].additiveValue = wn([], e[o].value, a, -1))
                : 2 === n && (e[o].additiveValue = bn([], e[o].value, a, -1));
          }
        }),
        (t.prototype.step = function (t, e) {
          if (!this._finished) {
            ...
            if (p && c) {
              ...
              if (0 !== f) {
                var d = (e - p.percent) / f,
                  g = i ? this._additiveValue : u ? cm : t[s];
                if (
                  ((l > 0 || u) && !g && (g = this._additiveValue = []),
                  this.useSpline)
                ) {
                  var v = o[n][r],
                    y = o[0 === n ? n : n - 1][r],
                  ...
                  if (l > 0)
                    1 === l
                      ? Cn(g, y, v, m, _, d, d * d, d * d * d)
                      : Dn(g, y, v, m, _, d, d * d, d * d * d);
                  else if (u)
                    Cn(g, y, v, m, _, d, d * d, d * d * d), i || (t[s] = In(g));
                  else {
                    var x = void 0;
                    (x = this.interpolable
                      ? Mn(y, v, m, _, d, d * d, d * d * d)
                      : m),
                      i ? (this._additiveValue = x) : (t[s] = x);
                  }
                } else if (l > 0)
                  1 === l ? _n(g, p[r], c[r], d) : xn(g, p[r], c[r], d);
                else if (u) _n(g, p[r], c[r], d), i || (t[s] = In(g));
                else {
                  var x = void 0;
                  (x = this.interpolable
                    ? yn(p[r], c[r], d)
        ...
        (t.prototype._addToTarget = function (t) {
          ...
          0 === e
            ? this.isValueColor
              ? (on(t[n], cm), wn(cm, cm, i, 1), (t[n] = In(cm)))
              : (t[n] = t[n] + i)
            : 1 === e
            ? wn(t[n], t[n], i, 1)
            : 2 === e && bn(t[n], t[n], i, 1);
      ...
      function t(t, e, n) {
        return (
          ...
          e && n
            ...
            : void (this._additiveAnimators = n)
        );
      }
      return (
          ...
          for (var i = this._tracks, r = 0; r < n.length; r++) {
            ...
            if (!a) {
              ...
              if (l) {
                ...
                (s = u && u.value), l.isValueColor && s && (s = In(s));
        ...
        (t.prototype.during = function (t) {
          return (
            t &&
              (this._onframeList || (this._onframeList = []),
        ...
        (t.prototype.done = function (t) {
          return (
            t &&
              (this._doneList || (this._doneList = []), this._doneList.push(t)),
            this
          );
        }),
        (t.prototype.aborted = function (t) {
          return (
            t &&
              (this._abortedList || (this._abortedList = []),
              this._abortedList.push(t)),
            this
          );
        }),
    ...
    Sm = (function () {
      function t(t, e, n, i) {
        0 > n && isFinite(n) && ((t += n), (n = -n)),
          0 > i && isFinite(i) && ((e += i), (i = -i)),
          (this.x = t),
          (this.y = e),
          (this.width = n),
          (this.height = i);
      ...
      return (
        (t.prototype.union = function (t) {
          ...
          (this.width =
            isFinite(this.x) && isFinite(this.width)
              ? vm(t.x + t.width, this.x + this.width) - e
              : t.width),
            (this.height =
              isFinite(this.y) && isFinite(this.height)
                ? vm(t.y + t.height, this.y + this.height) - n
                : t.height),
            (this.x = e),
            (this.y = n);
        }),
        ...
        (t.prototype.calculateTransform = function (t) {
          var e = this,
            ...
            r = ze();
          return (
            We(r, r, [-e.x, -e.y]), Ue(r, r, [n, i]), We(r, r, [t.x, t.y]), r
          );
        }),
        (t.prototype.intersect = function (e, n) {
          ...
          if (n) {
            var f = 1 / 0,
              ...
              x = Math.min(y, m);
            l > o || r > u
              ? _ > d && ((d = _), v > g ? dm.set(bm, -g, 0) : dm.set(bm, v, 0))
              : f > _ &&
                ((f = _), v > g ? dm.set(wm, g, 0) : dm.set(wm, -v, 0)),
              h > s || a > c
                ? x > d &&
                  ((d = x), m > y ? dm.set(bm, 0, -y) : dm.set(bm, 0, m))
                : f > _ &&
                  ((f = _), m > y ? dm.set(wm, 0, y) : dm.set(wm, 0, -m));
          }
          return n && dm.copy(n, p ? wm : bm), p;
        }),
        ...
        (t.applyTransform = function (e, n, i) {
          ...
          (ym.x = _m.x = n.x),
            (ym.y = xm.y = n.y),
            (mm.x = xm.x = n.x + n.width),
            (mm.y = _m.y = n.y + n.height),
            ym.transform(i),
            xm.transform(i),
            mm.transform(i),
            _m.transform(i),
            (e.x = gm(ym.x, mm.x, _m.x, xm.x)),
            (e.y = gm(ym.y, mm.y, _m.y, xm.y));
          var l = vm(ym.x, mm.x, _m.x, xm.x),
            u = vm(ym.y, mm.y, _m.y, xm.y);
    ...
    zm = (function () {
      ...
      return (
            ...
            if (
              ...
              u.copy(n.layoutRect ? n.layoutRect : this.getBoundingRect()),
                ...
                this.calculateTextPosition
                  ? this.calculateTextPosition(Em, n, u)
                  : Fn(Em, n, u),
                (r.x = Em.x),
                (r.y = Em.y),
                (o = Em.align),
              ...
              if (h && null != n.rotation) {
                ...
                "center" === h
                  ...
                  : ((c = zn(h[0], u.width)), (p = zn(h[1], u.height))),
                  (l = !0),
        ...
        (t.prototype.getOutsideFill = function () {
          return this.__zr && this.__zr.isDarkMode() ? Pm : Am;
        }),
        ...
        (t.prototype._innerSaveToNormal = function (t) {
          ...
          e || (e = this._normalState = {}),
            ...
            this._savePrimaryToNormal(t, e, Rm);
        }),
        ...
        (t.prototype.useState = function (e, n, i) {
          ...
          if (o || !r) {
            ...
            if (!(p(s, e) >= 0) || (!n && 1 !== s.length)) {
              var u;
              if (
                (this.stateProxy && !r && (u = this.stateProxy(e)),
                u || (u = this.states && this.states[e]),
                !u && !r)
              )
                return void a("State " + e + " not exists.");
              ...
              return (
                ...
                this._textContent && this._textContent.useState(e, n),
                this._textGuide && this._textGuide.useState(e, n),
                r
        ...
        (t.prototype.useStates = function (e, n) {
          if (e.length) {
            ...
            for (var s = 0; o > s; s++) {
              var l = e[s],
                u = void 0;
              this.stateProxy && (u = this.stateProxy(l, e)),
                u || (u = this.states[l]),
                u && i.push(u);
            }
            ...
            this.saveCurrentToNormalState(c),
              this._applyStateObj(
                ...
                this._normalState,
                !1,
                !n && !this.__inHover && p && p.duration > 0,
                p,
              ),
              this._textContent && this._textContent.useStates(e),
              this._textGuide && this._textGuide.useStates(e),
              this._updateAnimationTargets(),
        ...
        (t.prototype._applyStateObj = function (t, e, n, i, r, o) {
          ...
          for (var s = {}, l = !1, u = 0; u < Rm.length; u++) {
            var c = Rm[u],
              p = r && Bm[c];
            e && null != e[c]
              ? p
        ...
        (t.prototype._transitionState = function (t, e, n, i) {
          for (var r = Hn(this, e, n, i), o = 0; o < r.length; o++)
        ...
        (t.initDefaultProps = (function () {
          ...
          (i.type = "element"),
            ...
            (i.ignoreClip = !1),
            (i.__inHover = !1),
            (i.__dirty = t.REDARAW_BIT);
          var r = {};
          Object.defineProperty &&
            (!iy.browser.ie || iy.browser.version > 8) &&
    ...
    Gm = (function () {
      ...
      return (
        ...
        (t.prototype.updateDisplayList = function (t) {
          ...
          (n.length = this._displayListLen), iy.canvasSupported && Jn(n, ti);
        }),
          ...
          if (!t.ignore || n) {
            ...
            if (t.childrenRef) {
              for (var a = t.childrenRef(), s = 0; s < a.length; s++) {
                var l = a[s];
                t.__dirty && (l.__dirty |= zm.REDARAW_BIT),
              ...
              e && e.length
                ...
                : u.__clipPaths &&
                  ...
                  (u.__clipPaths = []),
                isNaN(u.z) && (Qn(), (u.z = 0)),
                isNaN(u.z2) && (Qn(), (u.z2 = 0)),
                isNaN(u.zlevel) && (Qn(), (u.zlevel = 0)),
  ...
  var Um = Fm,
    ...
    $m = (function () {
      function t(t, e) {
        (this.stopPropagation = K),
          (this.stopImmediatePropagation = K),
    ...
    Jm = {
      ...
      wheel: function (t) {
        (Km = !0), (t = ke(this.dom, t)), this.trigger("mousewheel", t);
      },
      mousewheel: function (t) {
        Km || ((t = ke(this.dom, t)), this.trigger("mousewheel", t));
      },
      touchstart: function (t) {
        (t = ke(this.dom, t)),
          ...
          Jm.mousemove.call(this, t),
          Jm.mousedown.call(this, t);
      },
      ...
      touchend: function (t) {
        (t = ke(this.dom, t)),
          ...
          Jm.mouseup.call(this, t),
          +new Date() - +this.__lastTouchMoment < Xm && Jm.click.call(this, t);
      },
      pointerdown: function (t) {
        Jm.mousedown.call(this, t);
      },
      pointermove: function (t) {
        ei(t) || Jm.mousemove.call(this, t);
      },
      pointerup: function (t) {
        Jm.mouseup.call(this, t);
      },
      pointerout: function (t) {
        ei(t) || Jm.mouseout.call(this, t);
      },
    };
  ...
  var Qm = {
      pointermove: function (t) {
        ei(t) || Qm.mousemove.call(this, t);
      },
      pointerup: function (t) {
        Qm.mouseup.call(this, t);
      },
      mousemove: function (t) {
        this.trigger("mousemove", t);
      },
    ...
    e_ = (function (t) {
      function n(e, n) {
        ...
        return (
          ...
          (i.dom = e),
          (i.painterRoot = n),
          (i._localHandlerScope = new t_(e, Jm)),
          jm && (i._globalHandlerScope = new t_(document, Qm)),
          ai(i, i._localHandlerScope),
          i
        );
      }
      return (
        e(n, t),
        (n.prototype.dispose = function () {
          ui(this._localHandlerScope), jm && ui(this._globalHandlerScope);
        }),
        ...
        (n.prototype.getBoundingRect = function (t) {
          for (
            ...
            if (!a.ignore && !a.invisible) {
              ...
              l
                ? (Sm.applyTransform(e, s, l), (r = r || e.clone()), r.union(e))
  ...
  n_.prototype.type = "group";
  var i_ = !iy.canvasSupported,
    r_ = {},
    o_ = {},
    a_ = (function () {
      function t(t, e, n) {
        ...
        var r = new Gm(),
          o = n.renderer || "canvas";
        if (i_) throw new Error("IE8 support has been dropped since 5.0");
        if ((r_[o] || (o = w(r_)[0]), !r_[o]))
          throw new Error(
            "Renderer '" + o + "' is not imported. Please import it first.",
          );
        n.useDirtyRect = null == n.useDirtyRect ? !1 : n.useDirtyRect;
        var a = new r_[o](e, r, n, t);
        (this.storage = r), (this.painter = a);
        var s =
          iy.node || iy.worker ? null : new e_(a.getViewportRoot(), a.root);
        (this.handler = new Wy(r, a, s, a.root)),
          (this.animation = new Ym({
            stage: {
              update: function () {
                return i._flush(!0);
              },
      ...
      return (
        ...
        (t.prototype.pathToImage = function (t, e) {
          return this.painter.pathToImage
            ? this.painter.pathToImage(t, e)
            : void 0;
        }),
        ...
        (t.prototype.clear = function () {
          for (var t = this.storage.getRoots(), e = 0; e < t.length; e++)
            t[e] instanceof n_ && t[e].removeSelfFromZr(this);
    ...
    g_ = Ei(),
    v_ = { useDefault: !0, enableAll: !1, enableNone: !1 },
    y_ = ".",
    m_ = "___EC__COMPONENT__CONTAINER___",
    __ = "___EC__EXTENDED_CLASS___",
    x_ = Math.round(10 * Math.random()),
    w_ = [
      ["fill", "color"],
      ["shadowBlur"],
      ["shadowOffsetX"],
    ...
    A_ = "__zr_style_" + Math.round(10 * Math.random()),
    P_ = {
      shadowBlur: 0,
      shadowOffsetX: 0,
      shadowOffsetY: 0,
  ...
  var O_ = ["z", "z2", "invisible"],
    R_ = (function (t) {
      ...
      return (
        ...
        (n.prototype.getPaintRect = function () {
          ...
          if (!this._paintRect || this.__dirty) {
            var e = this.transform,
              ...
              o = i.shadowOffsetX || 0,
              a = i.shadowOffsetY || 0;
            (t = this._paintRect || (this._paintRect = new Sm(0, 0, 0, 0))),
              e ? Sm.applyTransform(t, n, e) : t.copy(n),
              (r || o || a) &&
        ...
        (n.prototype.setPrevPaintRect = function (t) {
          t
            ? ((this._prevPaintRect =
                this._prevPaintRect || new Sm(0, 0, 0, 0)),
        ...
        (n.prototype._innerSaveToNormal = function (e) {
          ...
          e.style &&
            ...
            this._savePrimaryToNormal(e, n, O_);
        }),
        ...
        (n.initDefaultProps = (function () {
          ...
          (t.type = "displayable"),
            ...
            (t.__dirty = zm.REDARAW_BIT | n.STYLE_CHANGED_BIT);
        })()),
        n
      );
    })(zm),
    ...
    tx = [],
    ex = [],
    nx = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    ix = [],
    rx = [],
    ox = [],
    ax = [],
    ...
    gx = Math.PI,
    vx = 2 * gx,
    yx = "undefined" != typeof Float32Array,
    mx = [],
    _x = (function () {
      function t(t) {
        (this.dpr = 1),
      ...
      return (
        ...
        (t.prototype.setScale = function (t, e, n) {
          (n = n || 0),
            n > 0 &&
              ((this._ux = dx(n / km / t) || 0),
              (this._uy = dx(n / km / e) || 0));
        }),
        ...
        (t.prototype.lineTo = function (t, e) {
          var n =
            dx(t - this._xi) > this._ux ||
            dx(e - this._yi) > this._uy ||
            this._len < 5;
          return (
            this.addData(nx.L, t, e),
            this._ctx &&
              n &&
              (this._needsDash
        ...
        (t.prototype.arc = function (t, e, n, i, r, o) {
          (mx[0] = i), (mx[1] = r), so(mx, o), (i = mx[0]), (r = mx[1]);
          var a = r - i;
          return (
            this.addData(nx.A, t, e, n, n, i, a, 0, o ? 0 : 1),
        ...
        (t.prototype._dashedLineTo = function (t, e) {
          ...
          (h = f - t), (c = d - e), (this._dashOffset = -fx(h * h + c * c));
        }),
        (t.prototype._dashedBezierTo = function (t, e, n, i, r, o) {
          var a,
            ...
            _ = d.length,
            x = 0;
          for (0 > f && (f = p + f), f %= p, a = 0; 1 > a; a += 0.1)
            (s = Vr(g, t, n, r, a + 0.1) - Vr(g, t, n, r, a)),
              (l = Vr(v, e, i, o, a + 0.1) - Vr(v, e, i, o, a)),
              (y += fx(s * s + l * l));
          for (; _ > m && ((x += d[m]), !(x > f)); m++);
          for (a = (x - f) / y; 1 >= a; )
            (u = Vr(g, t, n, r, a)),
        ...
        (t.prototype.toStatic = function () {
          if (this._saveData) {
            ...
            t instanceof Array &&
              ((t.length = this._len),
              yx && this._len > 11 && (this.data = new Float32Array(t)));
          }
        }),
        (t.prototype.getBoundingRect = function () {
          (ox[0] = ox[1] = sx[0] = sx[1] = Number.MAX_VALUE),
            (ax[0] = ax[1] = lx[0] = lx[1] = -Number.MAX_VALUE);
          var t,
            e = this.data,
            n = 0,
            i = 0,
          ...
          for (t = 0; t < this._len; ) {
            ...
            switch ((s && ((n = e[t]), (i = e[t + 1]), (r = n), (o = i)), a)) {
              case nx.M:
                ...
                break;
              case nx.L:
                no(n, i, e[t], e[t + 1], sx, lx), (n = e[t++]), (i = e[t++]);
                break;
              case nx.C:
                io(
                  n,
                ...
                break;
              case nx.Q:
                ro(n, i, e[t++], e[t++], e[t], e[t + 1], sx, lx),
                  (n = e[t++]),
                  (i = e[t++]);
                break;
              case nx.A:
                ...
                t += 1;
                var d = !e[t++];
                s && ((r = cx(p) * h + l), (o = px(p) * c + u)),
                  oo(l, u, h, c, p, f, d, sx, lx),
                  (n = cx(f) * h + l),
                  (i = px(f) * c + u);
                break;
              case nx.R:
                ...
                var g = e[t++],
                  v = e[t++];
                no(r, o, r + g, o + v, sx, lx);
                break;
              case nx.Z:
                (n = r), (i = o);
            }
            ve(ox, ox, sx), ye(ax, ax, lx);
          }
          return (
            0 === t && (ox[0] = ox[1] = ax[0] = ax[1] = 0),
            new Sm(ox[0], ox[1], ax[0] - ox[0], ax[1] - ox[1])
          );
        }),
            ...
            switch (p) {
              ...
              case nx.C:
                var _ = t[c++],
                  ...
                  w = t[c++],
                  b = t[c++];
                (d = jr(r, o, _, x, g, v, w, b, 10)), (r = w), (o = b);
                break;
              case nx.Q:
                var _ = t[c++],
                  x = t[c++],
              ...
              case nx.A:
                ...
                f && ((a = cx(D) * M + S), (s = px(D) * C + T)),
                  (d = hx(M, C) * ux(vx, Math.abs(k))),
                  (r = cx(I) * M + S),
                  (o = px(I) * C + T);
                break;
              case nx.R:
            ...
            t: for (var m = 0; d > m; ) {
              ...
              switch (
                ...
                case nx.C:
                  ...
                  t.bezierCurveTo(S, T, M, C, D, k), (r = D), (o = k);
                  break;
                case nx.Q:
                  var S = c[m++],
                    T = c[m++],
                  ...
                  if (g) {
                    ...
                    if (v + w > h) {
                      ...
                      Jr(r, S, M, b, ix),
                        Jr(o, T, C, b, rx),
                        t.quadraticCurveTo(ix[1], rx[1], ix[2], rx[2]);
                      break t;
                    }
                    v += w;
                  }
                ...
                case nx.A:
                  ...
                  if (g) {
                    var w = l[y++];
                    v + w > h && ((F = O + (R * (h - v)) / w), (H = !0)),
                      (v += w);
                  }
                  if (
                    (z && t.ellipse
                      ? t.ellipse(I, A, P, L, B, O, F, E)
                      : t.arc(I, A, N, O, F, E),
                    H)
                  )
                    break t;
                  x && ((n = cx(O) * P + I), (i = px(O) * L + A)),
                    (r = cx(F) * P + I),
                    (o = px(F) * L + A);
                  break;
                case nx.R:
                  ...
                  if (g) {
                    ...
                    if (v + w > h) {
                      ...
                      t.moveTo(a, s),
                        t.lineTo(a + ux(G, V), s),
                        (G -= V),
                        G > 0 && t.lineTo(a + V, s + ux(G, W)),
                        (G -= W),
                        G > 0 && t.lineTo(a + hx(V - G, 0), s + W),
                        (G -= V),
                        G > 0 && t.lineTo(a, s + hx(W - G, 0));
                      break t;
                    }
                    v += w;
                  }
      ...
      return (
        ...
        (n.prototype.update = function () {
          ...
          if (i.decal) {
            ...
            for (var s = 0; s < Ax.length; ++s) r[Ax[s]] = this[Ax[s]];
            r.__dirty |= zm.REDARAW_BIT;
        ...
        (n.prototype.getBoundingRect = function () {
          ...
          if (i) {
            ...
            var o = this.path;
            (r || this.__dirty & n.SHAPE_CHANGED_BIT) &&
              (o.beginPath(),
        ...
        (n.initDefaultProps = (function () {
          ...
          (t.type = "path"),
            ...
            (t.autoBatch = !1),
            (t.__dirty =
              zm.REDARAW_BIT | R_.STYLE_CHANGED_BIT | n.SHAPE_CHANGED_BIT);
        })()),
        n
      );
    })(R_),
  ...
  var Vx = { fill: "#000" },
      ...
      return (
        ...
        (n.prototype.update = function () {
          ...
          if (i) {
            ...
            var r = i.transform;
            r
              ? ((this.transform = this.transform || []), He(this.transform, r))
              : (this.transform = null);
        ...
        (n.prototype._updatePlainTexts = function () {
          ...
          (v += u / 2),
            n &&
              ((g = Lo(c, f, n)),
              "top" === d ? (v += n[0]) : "bottom" === d && (v -= n[2]));
          for (
            var x = 0,
              w = !1,
              b = Po(("fill" in t) ? t.fill : ((w = !0), h.fill)),
              S = Ao(
                ("stroke" in t)
                  ? t.stroke
                  : a || (h.autoStroke && !w)
              ...
              M =
                ...
                ("truncate" === t.overflow ||
                  "break" === t.overflow ||
                  "breakAll" === t.overflow),
              C = r.calculatedLineHeight,
              D = 0;
            D < l.length;
            D++
          ) {
            var k = this._getOrCreateChild(Ox),
              I = k.createStyle();
            k.useStyle(I),
              (I.text = l[D]),
              (I.x = g),
              ...
              M &&
                k.setBoundingRect(
                  new Sm(
                    Bn(I.x, t.width, I.textAlign),
                    En(I.y, C, I.textBaseline),
                    t.width,
                    C,
                  ),
                );
          ...
          for (var y = !!t.backgroundColor, m = 0; m < n.lines.length; m++) {
            for (
              var _ = n.lines[m],
                ...
                D = w - 1,
                k = void 0;
              w > T && ((k = x[T]), !k.align || "left" === k.align);

            )
              this._placeToken(k, t, b, g, M, "left", y),
                (S -= k.width),
                (M += k.width),
                T++;
            for (; D >= 0 && ((k = x[D]), "right" === k.align); )
              this._placeToken(k, t, b, g, C, "right", y),
                (S -= k.width),
                (C -= k.width),
                D--;
            for (M += (i - (M - d) - (v - C) - S) / 2; D >= T; )
              (k = x[T]),
                this._placeToken(k, t, b, g, M + k.width / 2, "center", y),
                (M += k.width),
                T++;
            g += b;
          }
        ...
        (n.prototype._placeToken = function (t, e, n, i, r, o, a) {
          ...
          var c = !!s.backgroundColor,
            p = t.textPadding;
          p &&
            ((r = Lo(r, o, p)), (u -= t.height / 2 - p[0] - t.innerHeight / 2));
          var f = this._getOrCreateChild(Ox),
            d = f.createStyle();
          f.useStyle(d);
          ...
          var w = t.contentWidth,
            b = t.contentHeight;
          f.setBoundingRect(
            new Sm(Bn(d.x, w, d.textAlign), En(d.y, b, d.textBaseline), w, b),
          );
        }),
        (n.prototype._renderBackground = function (t, e, n, i, r, o) {
          ...
          if (c) {
            var g = a.style;
            (g.fill = l || null), (g.fillOpacity = z(t.fillOpacity, 1));
          } else if (l && l.image) {
            (s = this._getOrCreateChild(Ex)),
              (s.onload = function () {
                f.dirtyStyle();
              });
            var v = s.style;
          ...
          if (u && h) {
            ...
            (g.lineWidth = u),
              (g.stroke = h),
              (g.strokeOpacity = z(t.strokeOpacity, 1)),
              (g.lineDash = t.borderDash),
              (g.lineDashOffset = t.borderDashOffset || 0),
              (a.strokeContainThreshold = 0),
              a.hasFill() &&
                a.hasStroke() &&
                ((g.strokeFirst = !0), (g.lineWidth *= 2));
          }
          var y = (a || s).style;
          (y.shadowBlur = t.shadowBlur || 0),
            (y.shadowColor = t.shadowColor || "transparent"),
            (y.shadowOffsetX = t.shadowOffsetX || 0),
            (y.shadowOffsetY = t.shadowOffsetY || 0),
            (y.opacity = F(t.opacity, e.opacity, 1));
        }),
    ...
    Yx = { left: !0, right: 1, center: 1 },
    Xx = { top: 1, bottom: 1, middle: 1 },
    jx = or(),
    qx = 1,
    Zx = {},
    Kx = or(),
  ...
  var tb = (function (t) {
      ...
      return (
        ...
        (n.prototype.getBoundingRect = function () {
          return (
            ...
            Px.prototype.getBoundingRect.call(this)
          );
        }),
        n
      );
    ...
    lb = (function () {
      function t(t, e) {
        ...
        for (var n = 0; 4 > n; n++) this._corners[n] = new dm();
        for (var n = 0; 2 > n; n++) this._axes[n] = new dm();
      ...
      return (
        ...
        (t.prototype.intersect = function (t, e) {
          ...
          return (
            ab.set(1 / 0, 1 / 0),
            sb.set(0, 0),
            !this._intersectCheckOneSide(this, t, ab, sb, i, 1) && ((n = !1), i)
              ? n
              : !this._intersectCheckOneSide(t, this, ab, sb, i, -1) &&
                ((n = !1), i)
              ? n
              : (i || dm.copy(e, n ? ab : sb), n)
          );
        }),
        (t.prototype._intersectCheckOneSide = function (t, e, n, i, r, o) {
          for (var a = !0, s = 0; 2 > s; s++) {
            var l = this._axes[s];
            if (
              (this._getProjMinMaxOnAxis(s, t._corners, rb),
              this._getProjMinMaxOnAxis(s, e._corners, ob),
              rb[1] < ob[0] || rb[0] > ob[1])
            ) {
              if (((a = !1), r)) return a;
              var u = Math.abs(ob[0] - rb[1]),
                h = Math.abs(rb[0] - ob[1]);
              Math.min(u, h) > i.len() &&
                (h > u ? dm.scale(i, l, -u * o) : dm.scale(i, l, h * o));
            } else if (n) {
              var u = Math.abs(ob[0] - rb[1]),
                h = Math.abs(rb[0] - ob[1]);
              Math.min(u, h) < n.len() &&
                (h > u ? dm.scale(n, l, u * o) : dm.scale(n, l, -h * o));
            }
          }
          return a;
        }),
    ...
    hb = (function (t) {
      ...
      return (
        ...
        (n.prototype.getBoundingRect = function () {
          if (!this._rect) {
            for (
              var t = new Sm(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
              ...
              n.needLocalTransform() &&
                i.applyTransform(n.getLocalTransform(ub)),
                t.union(i);
            }
            this._rect = t;
          }
  ...
  var yb = (Object.freeze || Object)({
      ...
      BezierCurve: $w,
      Arc: Qw,
      IncrementalDisplayable: hb,
      CompoundPath: tb,
      LinearGradient: nb,
      RadialGradient: ib,
      BoundingRect: Sm,
      OrientedBoundingRect: lb,
      Point: dm,
      Path: Px,
    }),
    mb = {},
    ...
    xb = ["align", "lineHeight", "width", "height", "tag", "verticalAlign"],
    wb = [
      "padding",
      "borderWidth",
      "borderRadius",
  ...
  vr(Lb), _r(Lb), d(Lb, kb), d(Lb, Pb), d(Lb, S_), d(Lb, Mb);
  var Ob = Math.round(10 * Math.random()),
    Rb = {
      time: {
        month: [
          "January",
  ...
  var Wb = 1e3,
    ...
    Kb = ["year", "month", "day", "hour", "minute", "second", "millisecond"],
    $b = [
      "year",
      "half-year",
      "quarter",
    ...
    iS = v,
    rS = ["left", "right", "top", "bottom", "width", "height"],
    oS = [
      ["width", "left", "right"],
      ["height", "top", "bottom"],
    ],
    aS = wl,
    sS = (S(wl, "vertical"), S(wl, "horizontal"), or()),
    lS = (function (t) {
      function n(e, n, i) {
        var r = t.call(this, e, n, i) || this;
        return (r.uid = Os("ec_cpt_model")), r;
      }
      return (
        e(n, t),
  ...
  mr(lS, Lb), br(lS), Rs(lS), Bs(lS, kl);
  var uS = "";
  "undefined" != typeof navigator && (uS = navigator.platform || "");
  var hS,
    cS,
    pS = "rgba(0, 0, 0, 0.2)",
    fS = {
      ...
      textStyle: {
        fontFamily: uS.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
        fontSize: 12,
        fontStyle: "normal",
        fontWeight: "normal",
      },
    ...
    dS = X(["tooltip", "label", "itemName", "itemId", "seriesName"]),
    gS = "original",
    vS = "arrayRows",
    yS = "objectRows",
    mS = "keyedColumns",
      ...
      (function () {
        ...
        return (
          (t.prototype.getColorFromPalette = function (t, e, n) {
            var i = Hi(this.get("color", !0)),
              r = this.get("colorLayer", !0);
            return zl(this, CS, i, r, t, e, n);
          }),
    ...
    AS = (function (t) {
      ...
      return (
        ...
        (n.prototype.init = function (t, e, n, i, r, o) {
          (i = i || {}),
            (this.option = null),
            (this._theme = new Lb(i)),
            (this._locale = new Lb(r)),
        ...
        (n.prototype._mergeOption = function (t, e) {
          function n(e) {
            var n = El(this, e, Hi(t[e])),
              ...
              s = a
                ...
                : "replaceAll",
              l = Ui(a, n, s);
            nr(l, e, lS), (i[e] = null), r.set(e, null), o.set(e, 0);
            var u = [],
              p = [],
              f = 0;
            v(
              ...
              function (t, n) {
                ...
                if (r) {
                  var o = "series" === e,
                    a = lS.getClass(e, t.keyInfo.subType, !o);
                  if (!a) return;
                ...
                i
                  ? (u.push(i.option), p.push(i), f++)
                  : (u.push(void 0), p.push(void 0));
              },
              this,
            ),
              (i[e] = u),
          ...
          Il(this),
            ...
            c &&
              c.each(function (t, e) {
                lS.hasClass(e) && !u.get(e) && (a.push(e), u.set(e, !0));
              }),
            lS.topologicalTravel(a, lS.getAllClassMainTypes(), n, this),
        ...
        (n.prototype.getOption = function () {
          ...
          return (
            v(t, function (e, n) {
              if (lS.hasClass(n)) {
                for (
                  var i = Hi(e), r = i.length, o = !1, a = r - 1;
                  a >= 0;
                  a--
                )
                  i[a] && !er(i[a]) ? (o = !0) : ((i[a] = null), !o && r--);
                (i.length = r), (t[n] = i);
              }
            }),
            delete t[kS],
        ...
        (n.prototype.eachComponent = function (t, e, n) {
          ...
          if (M(t)) {
            ...
            for (
              var a = C(t) ? i.get(t) : I(t) ? this.findComponents(t) : null,
                s = 0;
              a && s < a.length;
              s++
            ) {
        ...
        (n.prototype.restoreData = function (t) {
          ...
          var e = this._componentsMap,
            n = [];
          e.each(function (t, e) {
            lS.hasClass(e) && n.push(e);
          }),
            lS.topologicalTravel(n, lS.getAllClassMainTypes(), function (n) {
              v(e.get(n), function (e) {
                !e || ("series" === n && Hl(e, t)) || e.restoreData();
              });
            });
        }),
  ...
  var PS,
    ...
    VS = (function () {
      ...
      return (
        (t.prototype.setOption = function (t, e) {
          t &&
            (v(Hi(t.series), function (t) {
              t && t.data && P(t.data) && U(t.data);
            }),
            v(Hi(t.dataset), function (t) {
        ...
        (t.prototype.getMediaOption = function () {
          ...
          for (var a = 0, l = n.length; l > a; a++)
            Xl(n[a].query, t, e) && r.push(a);
          return (
            !r.length && i && (r = [-1]),
            r.length &&
              !ql(r, this._currentMediaIndices) &&
              (o = y(r, function (t) {
    ...
    qS = (function () {
      function t(t) {
        (this.data = t.data || (t.sourceFormat === mS ? {} : [])),
          (this.sourceFormat = t.sourceFormat || xS),
          (this.seriesLayoutBy = t.seriesLayoutBy || wS),
          ...
          (this.encodeDefine = t.encodeDefine),
        ...
        (t.internalField = (function () {
          ...
          BS = function (t, e, o) {
            ...
            if ((h(t, c), a === _S))
              ...
              var p = Mu(a, s);
              t.getItem = yy(p, null, e, l, u);
              var f = Cu(a, s);
              t.count = yy(f, null, e, l, u);
            }
          };
          var n = function (t, e) {
              (t -= this._offset), (e = e || []);
    ...
    $S =
      ((PS = {}),
      (PS[vS + "_" + wS] = function (t, e, n, i) {
        return t[i + e];
      }),
      (PS[vS + "_" + bS] = function (t, e, n, i) {
        i += e;
    ...
    QS =
      ((LS = {}),
      (LS[vS + "_" + wS] = function (t, e) {
        return Math.max(0, t.length - e);
      }),
      (LS[vS + "_" + bS] = function (t, e) {
        var n = t[0];
        return n ? Math.max(0, n.length - e) : 0;
      }),
      (LS[yS] = JS),
      (LS[mS] = function (t, e, n) {
        var i = n[0].name,
          r = t[i];
        return r ? r.length : 0;
      }),
      ...
      return (
        ...
        (t.prototype.getFormattedLabel = function (t, e, n, i, r, o) {
          ...
          if (
            ...
            null != i && T(s.value) && (s.value = s.value[i]),
            !r)
          ) {
          ...
          if ("function" == typeof r)
            return (s.status = e), (s.dimensionIndex = i), r(s);
          if ("string" == typeof r) {
            var u = dl(r, s);
            return u.replace(nT, function (e, n) {
              var i = n.length,
                r =
                  "[" === n.charAt(0) && "]" === n.charAt(i - 1)
                    ? +n.slice(1, i - 1)
                    : n,
                s = Iu(a, t, r);
        ...
        (t.prototype._doProgress = function (t, e, n, i, r) {
          oT.reset(e, n, i, r),
            ...
            this._callingProgress(
              { start: e, end: n, count: n - e, next: oT.next },
              this.context,
            );
        }),
    ...
    sT =
      ((function () {
        function t(t, e) {
          ...
          (this._opFn = aT[t]), (this._rvalFloat = Ri(e));
        }
        return (
          (t.prototype.evaluate = function (t) {
            return "number" == typeof t
              ? this._opFn(t, this._rvalFloat)
              : this._opFn(Ri(t), this._rvalFloat);
          }),
          t
        );
      })(),
        ...
        return (
          (t.prototype.evaluate = function (t, e) {
            var n = typeof t,
              ...
              s = isNaN(o);
            if (
              (a && (r = this._incomparable),
              s && (o = this._incomparable),
              a && s)
            ) {
              var l = "string" === n,
                u = "string" === i;
      ...
      return (
          ...
          if (Gu(n)) {
            ...
            if (r) {
              ...
              u.prepareSource(),
                ...
                (s = l.sourceFormat),
                (e = [u._getVersionSign()]);
            } else (a = o.get("data", !0)), (s = P(a) ? _S : gS), (e = []);
            var h = this._getSourceMetaRawOption(),
              c = l ? l.metaRawOption : null,
              p = z(h.seriesLayoutBy, c ? c.seriesLayoutBy : null),
              f = z(h.sourceHeader, c ? c.sourceHeader : null),
              d = z(h.dimensions, c ? c.dimensions : null);
            t = [
              vu(
                a,
            ...
            if (r) {
              ...
              (t = [vu(y, this._getSourceMetaRawOption(), null, null)]),
                (e = []);
            }
          }
        ...
        (t.prototype._applyTransform = function (t) {
          ...
          return (
            ...
            n
              ? (o = Fu(n, a, { datasetIndex: e.componentIndex }))
              : null != i && (o = [mu(a[0])]),
        ...
        (t.prototype._isDirty = function () {
          ...
          for (
            var e = this._getUpstreamSourceManagers(), n = 0;
            n < e.length;
            n++
          ) {
            var i = e[n];
            if (
              i._isDirty() ||
              this._upstreamSignList[n] !== i._getVersionSign()
            )
              return !0;
          }
        }),
    ...
    dT = {
      section: {
        planLayout: function (t) {
          ...
          v(t.blocks, function (t) {
            ...
            e >= i &&
              (i =
                e +
                (!n || (e && ("section" !== t.type || t.noHeader)) ? 0 : 1));
          }),
        ...
        build: function (t, e, n, i) {
          ...
          if (r) return a;
          var s = fl(e.header, "ordinal", t.useUTC),
            l = Yu(i, t.renderMode).nameStyle;
          return "richText" === t.renderMode
            ? th(t, s, l) + o.richText + a
            : $u(
                '<div style="' + l + ";" + cT + ';">' + pl(s) + "</div>" + a,
                n,
              );
        },
      },
      ...
      return (
        ...
        (t.prototype.makeTooltipMarker = function (t, e, n) {
          var i = "richText" === n ? this._generateStyleName() : null,
            r = vl({ color: e, type: t, renderMode: n, markerId: i });
      ...
      return (
        ...
        (n.prototype.init = function (t, e, n) {
          (this.seriesIndex = this.componentIndex),
            (this.dataTask = Pu({ count: uh, reset: hh })),
            (this.dataTask.context = { model: this }),
            this.mergeDefaultAndTheme(t, n);
          var i = (vT(this).sourceManager = new hT(this));
          i.prepareSource();
          var r = this.getInitialData(t, n);
          ph(r, this),
            (this.dataTask.context.data = r),
            (vT(this).dataBeforeProcessed = r),
            sh(this),
        ...
        (n.prototype.mergeOption = function (t, e) {
          ...
          var n = Tl(this);
          n && Ml(this.option, t, n);
          var i = vT(this).sourceManager;
        ...
        (n.prototype.getSource = function () {
          return vT(this).sourceManager.getSource();
        }),
        (n.prototype.getRawData = function () {
          return vT(this).dataBeforeProcessed;
        }),
        ...
        (n.prototype.formatTooltip = function (t, e) {
          return rh({ series: this, dataIndex: t, multipleSeries: e });
        }),
        ...
        (n.prototype.getColorFromPalette = function (t, e, n) {
          var i = this.ecModel,
            r = DS.prototype.getColorFromPalette.call(this, t, e, n);
        ...
        (n.prototype._innerSelect = function (t, e) {
          ...
          if (r && o)
            if ("multiple" === r)
              for (
                var a =
                    this.option.selectedMap || (this.option.selectedMap = {}),
                  s = 0;
                o > s;
                s++
              ) {
                var l = e[s],
                  u = ah(t, l);
                (a[u] = !0),
                  (this._selectedDataIndicesMap[u] = t.getRawIndex(l));
              }
            else if ("single" === r || r === !0) {
              var h = e[o - 1],
                u = ah(t, h);
              (this.option.selectedMap = ((n = {}), (n[u] = !0), n)),
        ...
        (n.registerClass = function (t) {
          return lS.registerClass(t);
        }),
        (n.protoInitialize = (function () {
          var t = n.prototype;
          (t.type = "series.__base__"),
            (t.seriesIndex = 0),
            (t.useColorPaletteOnData = !1),
  ...
  d(yT, iT), d(yT, DS), mr(yT, lS);
  var mT = (function () {
    function t() {
      (this.group = new n_()), (this.uid = Os("viewComponent"));
    }
    return (
      (t.prototype.init = function () {}),
  ...
  var _T = or(),
    ...
    wT = (function () {
      function t() {
        (this.group = new n_()),
          (this.uid = Os("viewChart")),
          (this.renderTask = Pu({ plan: mh, reset: _h })),
      ...
      return (
        ...
        (t.prototype.highlight = function (t, e, n, i) {
          yh(t.getData(), i, "emphasis");
        }),
        (t.prototype.downplay = function (t, e, n, i) {
          yh(t.getData(), i, "normal");
        }),
  ...
  var bT,
    ...
    TT = "\x00__throttleOriginMethod",
    MT = "\x00__throttleRate",
    CT = "\x00__throttleType",
    DT = or(),
    kT = { itemStyle: Sr(Ib, !0), lineStyle: Sr(Cb, !0) },
    IT = { lineStyle: "stroke", itemStyle: "fill" },
    AT = {
      createOnAllSeries: !0,
      performRawSeries: !0,
      reset: function (t, e) {
        ...
        if (!a[l] || c || p) {
          ...
          a[l] || ((a[l] = f), n.setVisual("colorFromPalette", !0)),
            (a.fill =
              "auto" === a.fill || "function" == typeof a.fill ? f : a.fill),
            (a.stroke =
              "auto" === a.stroke || "function" == typeof a.stroke
                ? f
                : a.stroke);
        }
        return (
            ...
            dataEach: n.hasItemOption
              ? function (t, e) {
                  ...
                  if (n && n[i]) {
                    ...
                    h(s, a),
                      PT.option.decal &&
                        (t.setItemVisual(e, "decal", PT.option.decal),
                        (PT.option.decal.dirty = !0)),
      ...
      overallReset: function (t) {
        ...
        t.eachSeries(function (t) {
          if (t.useColorPaletteOnData) {
            var n = e.get(t.type);
            n || ((n = {}), e.set(t.type, n)), (DT(t).scope = n);
          }
        }),
    ...
    BT = (function () {
      ...
      return (
        ...
        (t.prototype._createSeriesStageTask = function (t, e, n, i) {
          function r(e) {
            var r = e.uid,
              l = s.set(
                r,
                (a && a.get(r)) || Pu({ plan: Ih, reset: Ah, count: Lh }),
              );
            (l.context = {
              model: e,
              ecModel: n,
        ...
        (t.prototype._createOverallStageTask = function (t, e, n, i) {
          function r(t) {
            var e = t.uid,
              n = l.set(
                e,
                (s && s.get(e)) || ((p = !0), Pu({ reset: Ch, onDirty: kh })),
              );
          ...
          var o = this,
            a = (e.overallTask = e.overallTask || Pu({ reset: Mh }));
          a.context = {
            ecModel: n,
            api: i,
        ...
        (t.wrapStageHandler = function (t, e) {
          return (
            M(t) && (t = { overallReset: t, seriesType: Oh(t) }),
            (t.uid = Os("stageHandler")),
            e && (t.visualType = e),
            t
          );
        }),
  ...
  Rh(NT, AS),
    Rh(zT, NS),
    (NT.eachSeriesByType = NT.eachRawSeriesByType =
      function (t) {
        bT = t;
      }),
  ...
  var FT = [
    ...
    YT = {
      ...
      timeline: {
        lineStyle: { color: VT },
        label: { color: VT },
        controlStyle: { color: VT, borderColor: VT },
      },
      calendar: {
        itemStyle: { color: WT },
        dayLabel: { color: VT },
  ...
  var XT = (function () {
      ...
      reset: function (t, e) {
        function n(e, n) {
          var i = t.getRawValue(n),
            a = t.getDataParams(n);
          u && e.setItemVisual(n, "symbol", r(i, a)),
            h && e.setItemVisual(n, "symbolSize", o(i, a)),
            c && e.setItemVisual(n, "symbolRotate", s(i, a)),
            p && e.setItemVisual(n, "symbolOffset", l(i, a));
        }
        var i = t.getData();
        if (
          (t.legendSymbol && i.setVisual("legendSymbol", t.legendSymbol),
          t.hasSymbolVisual)
        ) {
          var r = t.get("symbol"),
            o = t.get("symbolSize"),
    ...
    rM = [],
    oM = new dm(),
    aM = ["align", "verticalAlign", "width", "height", "fontSize"],
    sM = new Jy(),
    lM = or(),
    uM = or(),
    hM = ["x", "y", "rotation"],
    cM = (function () {
      ...
      return (
        ...
        (t.prototype._addLabel = function (t, e, n, i, r) {
          ...
          Sm.applyTransform(u, u, l),
            l
              ? sM.setLocalTransform(l)
              : ((sM.x = sM.y = sM.rotation = sM.originX = sM.originY = 0),
                (sM.scaleX = sM.scaleY = 1));
          var h,
            c = i.__hostTarget;
          if (c) {
            h = c.getBoundingRect().plain();
            var p = c.getComputedTransform();
            Sm.applyTransform(h, h, p);
          }
        ...
        (t.prototype.updateLayoutConfig = function (t) {
          ...
          for (
            ...
            var o = this._labelList[r],
              ...
              u = void 0;
            (u =
              "function" == typeof o.layoutOption
                ? o.layoutOption(nc(o, s))
                : o.layoutOption),
              (u = u || {}),
            ...
            if (
              (null != u.x
                ? ((a.x = _i(u.x, n)), a.setStyle("x", 0), (c = !0))
                : ((a.x = l.x), a.setStyle("x", l.style.x)),
              null != u.y
                ? ((a.y = _i(u.y, i)), a.setStyle("y", 0), (c = !0))
        ...
        (t.prototype.processLabelsOverall = function () {
          ...
          v(this._chartViewList, function (e) {
            ...
            e.group.traverse(function (e) {
              ...
              var o = !i,
                a = e.getTextContent();
              !o && a && (o = lM(a).needsUpdateLabelLine),
          ...
          if (
            ...
            if (o) {
              ...
              h &&
                ...
                ns(n, l, e, s);
            } else if ((n.attr(l), !bb(n).valueAnimation)) {
            ...
            if (((r.oldLayout = l), n.states.select)) {
              ...
              ic(f, l, hM), ic(f, n.states.select, hM);
            }
            if (n.states.emphasis) {
              var d = (r.oldLayoutEmphasis = {});
              ic(d, l, hM), ic(d, n.states.emphasis, hM);
            }
            Ls(n, s, u, e, e);
          }
  ...
  for (
    var wM,
      bM = Px.extend({
        ...
        buildPath: function (t, e, n) {
          ...
          if ("none" !== i) {
            var r = xM[i];
            r || ((i = "rect"), (r = xM[i])),
              _M[i](e.x, e.y, e.width, e.height, r.shape),
      ...
      RM = w(OM),
      BM = { "alignment-baseline": "textBaseline", "stop-color": "stopColor" },
      EM = w(BM),
      NM = (function () {
        function t() {
        ...
        return (
          (t.prototype.parse = function (t, e) {
            ...
            for (var l = n.firstChild; l; )
              this._parseNode(l, i, r, null, !1, !1), (l = l.nextSibling);
            ...
            if (
              ...
              null != a &&
              null != s &&
              ((h = ep(u, { x: 0, y: 0, width: a, height: s })),
              !e.ignoreViewBox)
            ) {
              var p = i;
              (i = new n_()),
                i.add(p),
                (p.scaleX = p.scaleY = h.scale),
                (p.x = h.x),
                (p.y = h.y);
            }
            return (
              e.ignoreRootClip ||
                ...
                null == s ||
                i.setClipPath(
                  new Hx({ shape: { x: 0, y: 0, width: a, height: s } }),
                ),
              {
                root: i,
                width: a,
          ...
          (t.internalField = (function () {
            wM = {
              ...
              rect: function (t, e) {
                ...
                return (
                  Yc(e, n),
                  jc(t, n, this._defsUsePending, !1, !1),
                  n.setShape({
              ...
              polygon: function (t, e) {
                ...
                i && (n = Xc(i));
                var r = new Gw({ shape: { points: n || [] }, silent: !0 });
              ...
              polyline: function (t, e) {
                var n,
                  i = t.getAttribute("points");
                i && (n = Xc(i));
                var r = new Yw({ shape: { points: n || [] }, silent: !0 });
                return Yc(e, r), jc(t, r, this._defsUsePending, !1, !1), r;
              },
              image: function (t, e) {
                var n = new Ex();
              ...
              tspan: function (t, e) {
                ...
                return (
                  Yc(e, a),
                  jc(t, a, this._defsUsePending, !1, !0),
              ...
              path: function (t, e) {
                ...
                return (
                  Yc(e, i),
                  jc(t, i, this._defsUsePending, !1, !1),
                  (i.silent = !0),
                  i
                );
              },
      ...
      zM = {
        ...
        radialgradient: function (t) {
          var e = parseInt(t.getAttribute("cx") || "0", 10),
            ...
            r = new ib(e, n, i);
          return Gc(t, r), Uc(t, r), r;
        },
      },
      FM = /^url\(\s*#(.*?)\)/,
      HM = /-?([0-9]*\.)?[0-9]+([eE]-?[0-9]+)?/g,
      VM = /(translate|scale|rotate|skewX|skewY|matrix)\(([\-\s0-9\.eE,]*)\)/g,
      WM = /([^\s:;]+)\s*:\s*([^:;]+)/g,
      GM = 1e-8,
      UM = [],
      YM = (function () {
        ...
        return (
          ...
          (n.prototype.getBoundingRect = function () {
            ...
            for (
              ...
              if ("polygon" === a[s].type) {
                var l = a[s].exterior;
                eo(l, r, o), ve(n, n, r), ye(i, i, o);
              }
            return (
              0 === s && (n[0] = n[1] = i[0] = i[1] = 0),
              (this._rect = new Sm(n[0], n[1], i[0] - n[0], i[1] - n[1]))
            );
          }),
      ...
      ZM = (function () {
        function t(t, e) {
          (this.type = "geoSVG"),
            (this._usedGraphicMap = X()),
            (this._freedGraphics = []),
            (this._mapName = t),
            (this._parsedXML = Wc(e));
        }
        return (
          ...
          (t.prototype._buildGraphic = function (t) {
            ...
            try {
              (e =
                (t && np(t, { ignoreViewBox: !0, ignoreRootClip: !0 })) || {}),
                (n = e.root),
                W(null != n);
            } catch (i) {
            ...
            if (!l) {
              ...
              if (
                ...
                null == u && ((u = f.x), (c = f.width)),
                  null == h && ((h = f.y), (p = f.height));
              }
              l = this._boundingRect = new Sm(u, h, c, p);
            }
            if (s) {
              var d = ep(s, l);
              (n.scaleX = n.scaleY = d.scale), (n.x = d.x), (n.y = d.y);
            }
            r.setClipPath(new Hx({ shape: l.plain() }));
            var g = [];
            return (
              v(e.named, function (t) {
                null != qM.get(t.svgNodeTagLower) && (g.push(t), op(t.el));
              }),
    ...
    for (var QM = 0; QM < $M[JM].length; QM++)
      ($M[JM][QM][0] /= 10.5),
        ($M[JM][QM][1] /= -14),
        ($M[JM][QM][0] += KM[0]),
        ($M[JM][QM][1] += KM[1]);
  var tC = {
      ...
      return (
        (t.prototype.load = function (t, e) {
          ...
          if (!n) {
            ...
            n = this._parsedMap.set(e, { regions: i, boundingRect: dp(i) });
          }
          var r = X(),
            o = [];
          return (
            v(n.regions, function (e) {
              var n = e.name;
            ...
            {
              regions: o,
              boundingRect: n.boundingRect || new Sm(0, 0, 0, 0),
              regionsMap: r,
            }
          );
        }),
    ...
    AC = 7e3,
    PC = {
      PROCESSOR: { FILTER: mC, SERIES_FILTER: vC, STATISTIC: xC },
      VISUAL: {
        LAYOUT: wC,
        PROGRESSIVE_LAYOUT: bC,
        GLOBAL: SC,
        CHART: TC,
        POST_CHART_LAYOUT: DC,
        COMPONENT: MC,
        BRUSH: kC,
        CHART_ITEM: CC,
        ARIA: IC,
    ...
    LC = "__flagInMainProcess",
    OC = "__optionUpdated",
    RC = "__needsUpdateStatus",
    BC = /^[a-zA-Z0-9_]+$/,
    EC = "__connectUpdateStatus",
    NC = 0,
    zC = 1,
    FC = 2,
    HC = (function (t) {
  ...
  var WC,
    ...
    uD = (function (t) {
      function n(e, n, i) {
        ...
        (o._throttledZrFlush = xh(yy(u.flush, u), 17)),
          (n = s(n)),
          n && pu(n, !0),
          (o._theme = n),
          (o._locale = zs(i.locale || Vb)),
          (o._coordSysMgr = new FS());
        var h = (o._api = rD(o));
        return (
          Jn(mD, r),
          Jn(dD, r),
          (o._scheduler = new BT(o, h, dD, mD)),
          (o._messageCenter = new HC()),
          (o._labelManager = new cM()),
          o._initEvents(),
          (o.resize = yy(o.resize, o)),
      ...
      return (
        ...
        (n.prototype.setOption = function (t, e, n) {
          if (!this._disposed) {
            ...
            if (
              ...
              var a = new VS(this._api),
                s = this._theme,
                l = (this._model = new AS());
              (l.scheduler = this._scheduler),
                l.init(null, null, null, s, this._locale, a);
            }
            this._model.setOption(t, { replaceMerge: r }, gD),
              aD(this, o),
              n
                ? ((this[OC] = { silent: i }),
                  (this[LC] = !1),
        ...
        (n.prototype.getDevicePixelRatio = function () {
          return this._zr.painter.dpr || (pC && window.devicePixelRatio) || 1;
        }),
        (n.prototype.getRenderedCanvas = function (t) {
          if (iy.canvasSupported) {
            (t = h({}, t || {})),
              (t.pixelRatio = t.pixelRatio || this.getDevicePixelRatio()),
              (t.backgroundColor =
        ...
        (n.prototype.getConnectedDataURL = function (t) {
          if (!this._disposed && iy.canvasSupported) {
            var e = "svg" === t.type,
              n = this.group,
              i = Math.min,
              r = Math.max,
        ...
        (n.prototype.convertToPixel = function (t, e) {
          return XC(this, "convertToPixel", t, e);
        }),
        (n.prototype.convertFromPixel = function (t, e) {
          return XC(this, "convertFromPixel", t, e);
        }),
        ...
        (n.prototype.getVisual = function (t, e) {
          var n = this._model,
            i = ar(n, t, { defaultMainType: "series" }),
            r = i.seriesModel,
            o = r.getData(),
        ...
        (n.prototype.dispose = function () {
          if (!this._disposed) {
            (this._disposed = !0), ur(this.getDom(), MD, "");
            var t = this._api,
              e = this._model;
            lC(this._componentsViews, function (n) {
              n.dispose(e, t);
            }),
              lC(this._chartsViews, function (n) {
                n.dispose(e, t);
              }),
              this._zr.dispose(),
              delete wD[this.id];
        ...
        (n.prototype.dispatchAction = function (t, e) {
          if (
            !this._disposed &&
            (hC(e) || (e = { silent: !!e }), pD[t.type] && this._model)
          ) {
            if (this[LC]) return void this._pendingActions.push(t);
            var n = e.silent;
            qC.call(this, t, n);
            var i = e.flush;
            i
              ? this._zr.flush()
              : i !== !1 && iy.browser.weChat && this._throttledZrFlush(),
              ZC.call(this, n),
              KC.call(this, n);
          }
        }),
        (n.prototype.updateLabelLayout = function () {
          ...
          t.updateLayoutConfig(this._api),
            t.layout(this._api),
            t.processLabelsOverall();
        }),
        (n.prototype.appendData = function (t) {
          if (!this._disposed) {
            var e = t.seriesIndex,
        ...
        (n.internalField = (function () {
          function t(t) {
            ...
            t.selected && t.states.select && e.push("select"),
              t.hoverState === Qx && t.states.emphasis
                ? e.push("emphasis")
                : t.hoverState === Jx && t.states.blur && e.push("blur"),
              t.useStates(e);
          }
          function n(t, e) {
            var n = t._zr,
          ...
          function r(t, e) {
            t.preventAutoZ ||
              o(e.group, t.get("z") || 0, t.get("zlevel") || 0, -1 / 0);
          }
          function o(t, e, n, i) {
            var r = t.getTextContent(),
            ...
            if (
              ...
              (a.z = e),
                (a.zlevel = n),
                isFinite(i) && (a.z2 = i + (h && h.showAbove ? 1 : -1));
            }
            return i;
          }
          function a(t, e) {
          ...
          function s(e, n) {
            ...
            n.group.traverse(function (e) {
              if (e.states && e.states.emphasis) {
                if (ss(e)) return;
                if ((e instanceof Px && Ma(e), e.__dirty)) {
                  var n = e.prevStates;
                  n && e.useStates(n);
                }
                if (r) {
          ...
          (WC = function (t) {
            ...
            (GC = function (t, e) {
              function n(t) {
                ...
                if (!h) {
                  var c = fr(t.type),
                    p = e ? mT.getClass(c.main, c.sub) : wT.getClass(c.sub);
                  (h = new p()),
                    h.init(i, l),
                    (a[u] = h),
                    o.push(h),
                  ...
                  a.eachComponent(
                    ...
                    function (e) {
                      if (!u || null == u.get(e.id)) {
                        if (Ta(n))
                          if (e instanceof yT)
                            n.type !== rw || n.notBlur || ha(e, n, t._api);
                          else {
                            var r = ca(
                                e.mainType,
                                e.componentIndex,
                            ...
                            n.type === rw &&
                              a &&
                              !n.notBlur &&
                              ua(e.mainType, e.componentIndex, t._api),
                              s &&
                                lC(s, function (t) {
                                  n.type === rw ? ta(t) : ea(t);
                                });
            ...
            (YC = {
              ...
              updateView: function (t) {
                ...
                e &&
                  (e.setUpdatePayload(t),
                  wT.markUpdateMethod(t, "updateView"),
                  QC(e),
                  this._scheduler.performVisualTasks(e, t, { setDirty: !0 }),
                  tD(this, this._model, this._api, t),
                  iD(e, this._api));
              },
              updateVisual: function (t) {
                ...
                n &&
                  ...
                  wT.markUpdateMethod(t, "updateVisual"),
                  QC(n),
                  this._scheduler.performVisualTasks(n, t, {
                    visualType: "visual",
                    setDirty: !0,
              ...
              if (
                (lC(f, function (e) {
                  if (
                    ...
                    m
                      ? (UC(n, u, e, "series"), sD(n))
                      : p && UC(n, u, e, p.main, p.sub);
                }),
                "none" === u ||
                  _ ||
                  m ||
                  p ||
                  (this[OC]
                    ? (WC(this), YC.update.call(this, t), (this[OC] = !1))
                    : YC[u].call(this, t)),
                (g = d
                  ? { type: s.event || r, escapeConnect: o, batch: v }
                  : v[0]),
                (this[LC] = !1),
                !e)
              ) {
            ...
            (JC = function (t, e) {
              t.on("mouseover", function (t) {
                var n = t.target,
                  i = sc(n, wa);
                i && (pa(i, t, e._api), sD(e));
              })
                .on("mouseout", function (t) {
                  var n = t.target,
                    i = sc(n, wa);
                  i && (fa(i, t, e._api), sD(e));
                })
                .on("click", function (t) {
                  var n = t.target,
                    i = sc(
            ...
            (eD = function (t, e, n, i, o) {
              lC(o || t._componentsViews, function (t) {
                var o = t.__model;
                a(o, t), t.render(o, e, n, i), r(o, t), s(o, t);
              });
            }),
            (nD = function (t, e, o, l, u) {
              var h = t._scheduler,
                c = t._labelManager;
              c.clearLabels();
              var p = !1;
              e.eachSeries(function (e) {
                ...
                h.updatePayload(r, l),
                  a(e, n),
                  u && u.get(e.uid) && r.dirty(),
                  r.perform(h.getPerformArgs(r)) && (p = !0),
                  (e.__transientTransitionOpt = null),
                  (n.group.silent = !!e.get("silent")),
                  i(e, n),
                  ga(e),
                  c.addLabelsOfSeries(n);
              }),
                (h.unfinished = p || h.unfinished),
                c.updateLayoutConfig(o),
                c.layout(o),
                c.processLabelsOverall(),
                e.eachSeries(function (e) {
                  var n = t._chartsMap[e.__viewId];
                  r(e, n), s(e, n);
                }),
  ...
  Rp(SC, AT),
    ...
    Dp(yC, fu),
    Ep("default", Th),
    Ap({ type: rw, event: rw, update: rw }, K),
    Ap({ type: ow, event: ow, update: ow }, K),
    Ap({ type: aw, event: aw, update: aw }, K),
    Ap({ type: sw, event: sw, update: sw }, K),
    Ap({ type: lw, event: lw, update: lw }, K),
    Mp("light", HT),
    Mp("dark", YT);
  var ID,
    AD,
    ...
    UD = (function () {
      function t(t, e, n, i, r, o) {
        (this._old = t),
          (this._new = e),
          (this._oldKeyGetter = n || Vp),
          (this._newKeyGetter = i || Vp),
          (this.context = r),
    ...
    $D = "e\x00\x00",
    JD = {
      float: typeof Float64Array === ZD ? Array : Float64Array,
      int: typeof Int32Array === ZD ? Array : Int32Array,
      ordinal: Array,
      number: Array,
      time: Array,
    },
    QD = typeof Uint32Array === ZD ? Array : Uint32Array,
    tk = typeof Int32Array === ZD ? Array : Int32Array,
    ek = typeof Uint16Array === ZD ? Array : Uint16Array,
    nk = [
      "hasItemOption",
      "_nameList",
      "_idList",
    ...
    ik = ["_extent", "_approximateExtent", "_rawExtent"],
    rk = (function () {
      function t(t, e) {
        (this.type = "list"),
          (this._count = 0),
        ...
        for (var n = {}, i = [], r = {}, o = 0; o < t.length; o++) {
          var a = t[o],
            s = C(a) ? new YD({ name: a }) : a instanceof YD ? a : new YD(a),
            l = s.name;
          (s.type = s.type || "float"),
          ...
          i.push(l),
            (n[l] = s),
            (s.index = o),
            s.createInvertedIndices && (r[l] = []),
            0 === u.itemName &&
              ((this._nameDimIdx = o), (this._nameOrdinalMeta = s.ordinalMeta)),
            0 === u.itemId &&
              ((this._idDimIdx = o), (this._idOrdinalMeta = s.ordinalMeta));
        }
        (this.dimensions = i),
          (this._dimensionInfos = n),
          (this.hostModel = e),
          (this._dimensionsSummary = Wp(this)),
      ...
      return (
        ...
        (t.prototype.appendValues = function (t, e) {
          for (
            var n = this._storage,
              ...
              o = this._rawExtent,
              a = this.count(),
              s = a + Math.max(t.length, e ? e.length : 0),
              l = 0;
            r > l;
            l++
          ) {
            var u = i[l];
            o[u] || (o[u] = HD()), LD(n, this._dimensionInfos[u], s, !0);
          }
          for (
            var h = qD(i, function (t) {
                return o[t];
              }),
              c = (this._storageArr = qD(i, function (t) {
                return n[t];
              })),
              p = [],
              f = a;
            ...
            for (var d = f - a, g = 0; r > g; g++) {
              var u = i[g],
                v = this._dimValueGetterArrayRows(t[d] || p, u, d, g);
              c[g][f] = v;
              var y = h[g];
              v < y[0] && (y[0] = v), v > y[1] && (y[1] = v);
            }
            e &&
              ((this._nameList[f] = e[d]),
              this._dontMakeIdFromName || ND(this, f));
          }
          (this._rawCount = this._count = s), (this._extent = {}), AD(this);
        }),
        (t.prototype._initDataFromProvider = function (t, e, n) {
          if (!(t >= e)) {
            for (
              ...
              var d = o[f];
              h[d] || (h[d] = HD()), LD(r, s[d], e, n);
            }
            var g = (this._storageArr = qD(o, function (t) {
                return r[t];
              })),
              v = qD(o, function (t) {
                return h[t];
              });
            if (i.fillStorage) i.fillStorage(t, e, g, v);
            else
              for (var y = [], m = t; e > m; m++) {
                y = i.getItem(m, y);
                for (var _ = 0; a > _; _++) {
                ...
                if (p && !i.pure && y) {
                  ...
                  var T = y.id;
                  null == u[m] && null != T && (u[m] = Qi(T, null));
                }
                this._dontMakeIdFromName || ND(this, m);
              }
        ...
        (t.prototype.setCalculationInfo = function (t, e) {
          jD(t) ? h(this._calculationInfo, t) : (this._calculationInfo[t] = e);
        }),
        ...
        (t.prototype.getName = function (t) {
          ...
          return (
            null == n &&
              ...
              (n = ED(this, this._nameDimIdx, this._nameOrdinalMeta, e)),
            null == n && (n = ""),
            n
          );
        }),
        (t.prototype.getId = function (t) {
          return BD(this, this.getRawIndex(t));
        }),
        (t.prototype.each = function (t, e, n, i) {
          ...
          if (this._count) {
            ...
            for (
              var o = n || i || this,
                a = qD(zD(t), this.getDimension, this),
                s = a.length,
                l = qD(a, function (t) {
        ...
        (t.prototype.filterSelf = function (t, e, n, i) {
          ...
          if (this._count) {
            ...
            return (
              ...
              (this._count = p),
              (this._extent = {}),
              (this.getRawIndex = this._indices ? RD : OD),
              this
            );
          }
        }),
            ...
            if (o) {
              ...
              if (!g)
                if (1 === o)
                  ...
                  for (var m = 0; a > m; m++) {
                    for (
                      var M = !0, T = this.getRawIndex(m), C = 0;
                      o > C;
                      C++
                    ) {
                      var D = i[C],
        ...
        (t.prototype.map = function (t, e, n, i) {
          var r = n || i || this,
            o = qD(zD(t), this.getDimension, this),
            a = FD(this, o),
            s = a._storage;
          (a._indices = this._indices), (a.getRawIndex = a._indices ? RD : OD);
          for (
            var l = [],
              u = o.length,
              h = this.count(),
            ...
            if (null != g) {
              ...
              for (var v = this.getRawIndex(f), y = 0; y < g.length; y++) {
                var m = o[y],
                  _ = g[y],
                  x = p[m],
                  w = s[m];
        ...
        (t.prototype.downSample = function (t, e, n, i) {
          ...
          return (r._count = p), (r._indices = c), (r.getRawIndex = RD), r;
        }),
          ...
          for (var f = 1; l - 1 > f; f += c) {
            ...
            for (var m = w; b > m; m++) {
              var _ = this.getRawIndex(m),
                x = s[_];
              isNaN(x) ||
                ((i = Math.abs((S - v) * (x - T) - (S - m) * (y - T))),
                i > n && ((n = i), (r = _)));
            }
            (u[h++] = r), (p = r);
          }
          return (
            (u[h++] = this.getRawIndex(l - 1)),
            (o._count = h),
            (o._indices = u),
            (o.getRawIndex = RD),
            o
        ...
        (t.prototype.setVisual = function (t, e) {
          (this._visual = this._visual || {}),
            jD(t) ? h(this._visual, t) : (this._visual[t] = e);
        }),
        ...
        (t.prototype.setItemVisual = function (t, e, n) {
          ...
          (this._itemVisuals[t] = i), jD(e) ? h(i, e) : (i[e] = n);
        }),
        ...
        (t.prototype.setItemGraphicEl = function (t, e) {
          ...
          if (e) {
            var i = jx(e);
            (i.dataIndex = t),
              (i.dataType = this.dataType),
              (i.seriesIndex = n && n.seriesIndex),
              "group" === e.type && e.traverse(VD, e);
          }
        ...
        (t.prototype.cloneShallow = function (e) {
          if (!e) {
            var n = qD(this.dimensions, this.getDimensionInfo, this);
            e = new t(n, this.hostModel);
          }
          if (
            ((e._storage = this._storage),
            (e._storageArr = this._storageArr),
            WD(e, this),
            this._indices)
          ) {
          ...
          return (e.getRawIndex = e._indices ? RD : OD), e;
        }),
        ...
        (t.internalField = (function () {
          function e(t, e, n, i) {
            return Lu(t[i], this._dimensionInfos[e]);
          }
          function n(t) {
            var e = t.constructor;
          ...
          (ID = {
            ...
            objectRows: function (t, e) {
              return Lu(t[e], this._dimensionInfos[e]);
            },
            keyedColumns: e,
            original: function (t, e, n, i) {
              var r = t && (null == t.value ? t : t.value);
              return (
                !this._rawData.pure && Gi(t) && (this.hasItemOption = !0),
                Lu(r instanceof Array ? r[i] : r, this._dimensionInfos[e])
              );
            },
            ...
            (AD = function (t) {
              ...
              v(e, function (n, i) {
                var r = t._dimensionInfos[i],
                  o = r.ordinalMeta;
                if (o) {
                  n = e[i] = new tk(o.categories.length);
                  for (var a = 0; a < n.length; a++) n[a] = KD;
            ...
            (ED = function (t, e, n, i) {
              ...
              return (
                o &&
                  ((r = o[i]),
                  n && n.categories.length && (r = n.categories[r])),
                Qi(r, null)
              );
            }),
            (PD = function (t) {
              return t._rawCount > 65535 ? QD : ek;
            }),
            (LD = function (t, e, n, i) {
              var r = JD[e.type],
                o = e.name;
            ...
            (BD = function (t, e) {
              ...
              return (
                null == n &&
                  null != t._idDimIdx &&
                  (n = ED(t, t._idDimIdx, t._idOrdinalMeta, e)),
                null == n && (n = $D + e),
                n
              );
            }),
            ...
            (FD = function (e, i) {
              var r = e.dimensions,
                o = new t(qD(r, e.getDimensionInfo, e), e.hostModel);
              WD(o, e);
              for (
                var a = (o._storage = {}),
                  s = e._storage,
            ...
            (ND = function (t, e) {
              ...
              if (
                (null == a &&
                  null != r &&
                  (n[e] = a = ED(t, r, t._nameOrdinalMeta, e)),
                null == s &&
                  null != o &&
                  (i[e] = s = ED(t, o, t._idOrdinalMeta, e)),
                null == s && null != a)
              ) {
    ...
    ak = {
      cartesian2d: function (t, e, n, i) {
        var r = t.getReferringComponents("xAxis", v_).models[0],
          o = t.getReferringComponents("yAxis", v_).models[0];
        (e.coordSysDims = ["x", "y"]),
          n.set("x", r),
          n.set("y", o),
          $p(r) && (i.set("x", r), (e.firstCategoryDimIndex = 0)),
          $p(o) &&
            (i.set("y", o),
            null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
      },
      singleAxis: function (t, e, n, i) {
        var r = t.getReferringComponents("singleAxis", v_).models[0];
        (e.coordSysDims = ["single"]),
          n.set("single", r),
          $p(r) && (i.set("single", r), (e.firstCategoryDimIndex = 0));
      },
      polar: function (t, e, n, i) {
        var r = t.getReferringComponents("polar", v_).models[0],
          o = r.findAxisModel("radiusAxis"),
          a = r.findAxisModel("angleAxis");
        (e.coordSysDims = ["radius", "angle"]),
          n.set("radius", o),
          n.set("angle", a),
          $p(o) && (i.set("radius", o), (e.firstCategoryDimIndex = 0)),
          $p(a) &&
            (i.set("angle", a),
            null == e.firstCategoryDimIndex && (e.firstCategoryDimIndex = 1));
      },
    ...
    hk = (function (t) {
      ...
      return (
        ...
        (n.prototype.contain = function (t) {
          return (
            (t = this.parse(t)),
            hf(t, this._extent) && null != this._ordinalMeta.categories[t]
          );
        }),
        ...
        (n.prototype.scale = function (t) {
          return (
            (t = Math.round(pf(t, this._extent))), this.getRawOrdinalNumber(t)
          );
        }),
    ...
    pk = (function (t) {
      ...
      return (
        ...
        (n.prototype.getTicks = function (t) {
          ...
          var a = 1e4;
          n[0] < i[0] &&
            o.push(t ? { value: ck(i[0] - e, r) } : { value: n[0] });
          for (
            var s = i[0];
            s <= i[1] &&
            (o.push({ value: s }),
          ...
          return (
            n[1] > l && o.push(t ? { value: ck(l + e, r) } : { value: n[1] }), o
          );
        }),
        ...
        (n.prototype.niceExtent = function (t) {
          ...
          t.fixMin || (e[0] = ck(Math.floor(e[0] / r) * r)),
            t.fixMax || (e[1] = ck(Math.ceil(e[1] / r) * r));
        }),
        (n.type = "interval"),
        n
      );
  ...
  var fk = "__ec_stack_",
    dk = 0.5,
    gk = "undefined" != typeof Float32Array ? Float32Array : Array,
    vk =
      ({
        seriesType: "bar",
        plan: gh(),
              ...
              h > dk || (h = dk),
              {
                progress: function (t, e) {
                  for (
                    ...
                    (y[u] = e.get(a, c)),
                      (y[1 - u] = e.get(s, c)),
                      (v = n.dataToPoint(y, null, v)),
                      (d[m] = l ? i.x + i.width : v[0]),
                      (f[m++] = v[0]),
                      (d[m] = l ? v[1] : i.y + i.height),
                      (f[m++] = v[1]),
                      (g[_++] = c);
                  e.setLayout({
                    largePoints: f,
    ...
    yk = (function (t) {
      ...
      return (
        ...
        (n.prototype.getLabel = function (t) {
          ...
          return Ys(
            t.value,
            Zb[Us(Ws(this._minLevelUnit))] || Zb.second,
            e,
        ...
        (n.prototype.getTicks = function () {
          ...
          var i = this.getSetting("useUTC"),
            r = Af(this._minLevelUnit, this._approxInterval, i, e);
          return (n = n.concat(r)), n.push({ value: e[1], level: 0 }), n;
        }),
        (n.prototype.niceExtent = function (t) {
          var e = this._extent;
          if (
            (e[0] === e[1] && ((e[0] -= Yb), (e[1] += Yb)),
            e[1] === -1 / 0 && 1 / 0 === e[0])
          ) {
            var n = new Date();
        ...
        (n.prototype.niceTicks = function (t, e, n) {
          ...
          var o = mk.length,
            a = Math.min(vk(mk, this._approxInterval, 0, o), o - 1);
          (this._interval = mk[a][1]),
            (this._minLevelUnit = mk[Math.max(a - 1, 0)][0]);
        }),
        (n.prototype.parse = function (t) {
  ...
  var _k = sk.prototype,
    ...
    Dk = (function (t) {
      ...
      return (
          ...
          return y(
            ...
            function (t) {
              var e = t.value,
                r = xi(Mk(this.base, e));
              return (
                (r = e === n[0] && this._fixMin ? Pf(r, i[0]) : r),
                (r = e === n[1] && this._fixMax ? Pf(r, i[1]) : r),
                { value: r }
              );
            },
            this,
        ...
        (n.prototype.setExtent = function (t, e) {
          ...
          (t = Ck(t) / Ck(n)),
            (e = Ck(e) / Ck(n)),
            xk.setExtent.call(this, t, e);
        }),
        (n.prototype.getExtent = function () {
          var t = this.base,
            e = _k.getExtent.call(this);
          (e[0] = Mk(t, e[0])), (e[1] = Mk(t, e[1]));
          var n = this._originalScale,
            i = n.getExtent();
          return (
            this._fixMin && (e[0] = Pf(e[0], i[0])),
            this._fixMax && (e[1] = Pf(e[1], i[1])),
            e
          );
        }),
        (n.prototype.unionExtent = function (t) {
        ...
        (n.prototype.niceTicks = function (t) {
          ...
          if (!(1 / 0 === n || 0 >= n)) {
            ...
            for (
              ...
              i *= 10;
            var o = [xi(Tk(e[0] / i) * i), xi(Sk(e[1] / i) * i)];
            (this._interval = i), (this._niceExtent = o);
          }
        }),
        (n.prototype.niceExtent = function (t) {
          xk.niceExtent.call(this, t),
        ...
        (n.prototype.contain = function (t) {
          return (t = Ck(t) / Ck(this.base)), hf(t, this._extent);
        }),
        (n.prototype.normalize = function (t) {
          return (t = Ck(t) / Ck(this.base)), cf(t, this._extent);
        }),
        (n.prototype.scale = function (t) {
          return (t = pf(t, this._extent)), Mk(this.base, t);
        }),
        (n.type = "log"),
        n
      );
    ...
    kk = Dk.prototype;
  (kk.getMinorTicks = xk.getMinorTicks),
    (kk.getLabel = xk.getLabel),
    sk.registerClass(Dk);
  var Ik = (function () {
      function t(t, e, n) {
      ...
      return (
        (t.prototype._prepareParams = function (t, e, n) {
          ...
          M(r)
            ? (this._modelMinNum = Of(t, r({ min: n[0], max: n[1] })))
            : "dataMin" !== r && (this._modelMinNum = Of(t, r));
          var o = (this._modelMaxRaw = e.get("max", !0));
          if (
            (M(o)
              ? (this._modelMaxNum = Of(t, o({ min: n[0], max: n[1] })))
              : "dataMax" !== o && (this._modelMaxNum = Of(t, o)),
            i)
          )
    ...
    Ak = { min: "_determinedMin", max: "_determinedMax" },
    ...
    Rk = (Object.freeze || Object)({
      ...
      dataStack: Ok,
      createScale: Gf,
      mixinAxisModelCommonMethods: Uf,
      getECData: jx,
      createTextStyle: Yf,
      createDimensions: Zp,
      createSymbol: uc,
      enableHoverEmphasis: ya,
    }),
    Bk = [],
    Ek = {
      ...
      registerPostInit: kp,
      registerPostUpdate: Ip,
      registerAction: Ap,
      registerCoordinateSystem: Pp,
      registerLayout: Op,
      registerVisual: Rp,
      ...
      registerSubTypeDefaulter: function (t, e) {
        lS.registerSubTypeDefaulter(t, e);
      },
    ...
    zk = (Object.freeze || Object)({ parse: ki, format: Ys }),
    ...
    Hk = (Object.freeze || Object)({
      addCommas: hl,
      toCamelCase: cl,
      normalizeCssArray: Jb,
      encodeHTML: pl,
      formatTpl: dl,
      getTooltipMarker: vl,
      formatTime: yl,
    ...
    Yk = (function (t) {
      ...
      return (
        ...
        (n.prototype.createBackBuffer = function () {
          var t = this.dpr;
          (this.domBack = dd("back-" + this.id, this.painter, t)),
          ...
          for (
            ...
            if (h) {
              var c = h.shouldBePainted(n, i, !0, !0),
                p =
                  h.__isRendered && (h.__dirty & zm.REDARAW_BIT || !c)
                    ? h.getPrevPaintRect()
                    : null;
              p && r(p);
              var f =
                c && (h.__dirty & zm.REDARAW_BIT || !h.__isRendered)
                  ? h.getPaintRect()
                  : null;
              f && r(f);
            }
      ...
      return (
        ...
        (t.prototype._paintHoverList = function (t) {
          ...
          if ((n && n.clear(), e)) {
            for (
              ...
              var a = t[o];
              a.__inHover &&
                (n || (n = this._hoverlayer = this.getLayer(Xk)),
                i || ((i = n.ctx), i.save()),
                Oc(i, a, r, o === e - 1));
            }
            i && i.restore();
        ...
        (t.prototype._doPaintEl = function (t, e, n, i, r, o) {
          ...
          if (n) {
            ...
            (!i || (s && s.intersect(i))) &&
              (Oc(a, t, r, o), t.setPrevPaintRect(s));
          } else Oc(a, t, r, o);
        }),
        (t.prototype.getLayer = function (t, e) {
          ...
          return (
            n ||
              ((n = new Yk("zr_" + t, this, this.dpr)),
              (n.zlevel = t),
              (n.__builtin__ = !0),
              this._layerConfig[t]
                ? l(n, this._layerConfig[t], !0)
                : this._layerConfig[t - qk] &&
                  l(n, this._layerConfig[t - qk], !0),
              e && (n.virtual = e),
        ...
        (t.prototype._updateLayerStatus = function (t) {
          ...
          for (o = 0; o < t.length; o++) {
            ...
            r !== u && ((r = u), (l = 0)),
              i.incremental
                ? ((h = this.getLayer(u + Zk, this._needsManuallyCompositing)),
                  (h.incremental = !0),
                  (l = 1))
                : (h = this.getLayer(
                    u + (l > 0 ? qk : 0),
        ...
        (t.prototype.getRenderedCanvas = function (t) {
          ...
          var e = new Yk("image", this, t.pixelRatio || this.dpr);
          e.initContext(),
        ...
        (t.prototype.pathToImage = function (t, e) {
          ...
          var m = new Ex({ style: { x: 0, y: 0, image: n } });
          return h(t, y), m;
        }),
        t
      );
      ...
      return (
        ...
        (n.prototype.init = function (e, n, i) {
          t.prototype.init.call(this, e, n, i),
            (this._sourceManager = new hT(this)),
            Wu(this);
        }),
        (n.prototype.mergeOption = function (e, n) {
          t.prototype.mergeOption.call(this, e, n), Wu(this);
        }),
        (n.prototype.optionUpdated = function () {
        ...
        (n.type = "dataset"),
        (n.defaultOption = { seriesLayoutBy: wS }),
        n
      );
    })(lS),
    Jk = (function (t) {
      ...
      return (
        ...
        (n.prototype.updateData = function (t, e, n, i) {
          ...
          if (i) {
            ...
            "scale" === c
              ...
              : ((r.shape.endAngle = l.startAngle),
                ns(r, { shape: { endAngle: l.endAngle } }, o, e));
          } else ns(r, { shape: u }, o, e);
          r.useStyle(t.getItemVisual(e, "style")), _a(r, a);
          ...
          v && r.attr("cursor", v),
            ...
            (r.ensureState("emphasis").shape = ty(
              { r: l.r + (s.get("scale") ? s.get("scaleSize") || 0 : 0) },
              Dd(s.getModel("itemStyle"), l),
            )),
            h(r.ensureState("select"), {
              x: d,
              y: g,
              shape: Dd(a.getModel(["select", "itemStyle"]), l),
            }),
            h(r.ensureState("blur"), {
              shape: Dd(a.getModel(["blur", "itemStyle"]), l),
            });
          var y = r.getTextGuideLine(),
            m = r.getTextContent();
          y && h(y.ensureState("select"), { x: d, y: g }),
            h(m.ensureState("select"), { x: d, y: g }),
            ya(this, s.get("focus"), s.get("blurScope"));
        }),
        (n.prototype._updateLabel = function (t, e, n) {
          ...
          if ("outside" !== h && "outer" !== h) i.removeTextGuideLine();
            ...
            c || ((c = new Yw()), this.setTextGuideLine(c)),
              qh(this, Zh(r), {
                stroke: s,
    ...
    iI = (function (t) {
      ...
      return (
        ...
        (n.prototype.render = function (t) {
          ...
          if (!i && n.count() > 0) {
            for (
              var o = n.getItemLayout(0), a = 1;
              isNaN(o && o.startAngle) && a < n.count();
              ++a
            )
              o = n.getItemLayout(a);
            o && (e = o.startAngle);
          ...
          n
            ...
            .execute(),
            Cd(t),
            "expansion" !== t.get("animationTypeUpdate") && (this._data = n);
        }),
        (n.prototype.dispose = function () {}),
      ...
      return (
        ...
        (n.prototype.init = function (e) {
          t.prototype.init.apply(this, arguments),
            (this.legendVisualProvider = new rI(
              yy(this.getData, this),
              yy(this.getRawData, this),
            )),
        ...
        (n.prototype.getDataParams = function (e) {
          ...
          return (
            ...
            (i.percent = Mi(r, e, n.hostModel.get("percentPrecision"))),
            i.$vars.push("percent"),
            i
          );
        }),
  ...
  var aI = (function (t) {
      ...
      return (
        ...
        (n.prototype.init = function (e) {
          var n = Cl(e);
          t.prototype.init.apply(this, arguments), Ad(e, n);
        }),
        (n.prototype.mergeOption = function (e) {
          t.prototype.mergeOption.apply(this, arguments), Ad(this.option, e);
        }),
      ...
      return (
        ...
        (n.prototype.render = function (t) {
          ...
          var n = t.coordinateSystem,
            i = n.getRangeInfo(),
            r = n.getOrient();
          this._renderDayRect(t, i, e),
            this._renderLines(t, i, r, e),
            this._renderYearText(t, i, r, e),
            this._renderMonthText(t, r, e),
            this._renderWeekText(t, i, r, e);
        }),
        (n.prototype._renderDayRect = function (t, e, n) {
          for (
            ...
            var l = i.dataToRect([s], !1).tl,
              u = new Hx({
                shape: { x: l[0], y: l[1], width: o, height: a },
                cursor: "default",
                style: r,
              });
            n.add(u);
        ...
        (n.prototype._renderLines = function (t, e, n, i) {
          function r(e) {
            o._firstDayOfMonth.push(a.getDateInfo(e)),
              o._firstDayPoints.push(a.dataToRect([e], !1).tl);
            var r = o._getLinePointsOfOneWeek(t, e, n);
            o._tlpoints.push(r[0]),
              o._blpoints.push(r[r.length - 1]),
              l && o._drawSplitline(r, s, i);
          }
          var o = this,
          ...
          for (var h = e.start, c = 0; h.time <= e.end.time; c++) {
            r(h.formatedDate),
              0 === c && (h = a.getDateInfo(e.start.y + "-" + e.start.m));
            var p = h.date;
            p.setMonth(p.getMonth() + 1), (h = a.getDateInfo(p));
          }
          r(a.getNextNDay(e.end.time, 1).formatedDate),
            l &&
              this._drawSplitline(o._getEdgesPoints(o._tlpoints, u, n), s, i),
            l &&
              this._drawSplitline(o._getEdgesPoints(o._blpoints, u, n), s, i);
        }),
        ...
        (n.prototype._drawSplitline = function (t, e, n) {
          var i = new Yw({ z2: 20, shape: { points: t }, style: e });
          n.add(i);
        }),
        (n.prototype._getLinePointsOfOneWeek = function (t, e, n) {
          for (
            var i = t.coordinateSystem, r = i.getDateInfo(e), o = [], a = 0;
            7 > a;
            a++
          ) {
        ...
        (n.prototype._renderYearText = function (t, e, n, i) {
          ...
          if (r.get("show")) {
            ...
            var f = r.get("formatter"),
              d = { start: e.start.y, end: e.end.y, nameMap: p },
              g = this._formatterLabel(f, d),
              v = new Ux({ z2: 30, style: Cs(r, { text: g }) });
            v.attr(this._yearTextPositionControl(v, c[a], n, a, o)), i.add(v);
          }
        }),
        (n.prototype._monthTextPositionControl = function (t, e, n, i, r) {
          ...
          return (
            "horizontal" === n
              ? ((l += r), e && (o = "center"), "start" === i && (a = "bottom"))
              : ((s += r), e && (a = "middle"), "start" === i && (o = "right")),
        ...
        (n.prototype._renderMonthText = function (t, e, n) {
          ...
          if (i.get("show")) {
            ...
            C(r) && (r = sI[r.toUpperCase()] || []);
            var u = "start" === a ? 0 : 1,
              c = "horizontal" === e ? 0 : 1;
            o = "start" === a ? -o : o;
            for (var p = "center" === s, f = 0; f < l[u].length - 1; f++) {
              var d = l[u][f].slice(),
              ...
              var y = i.get("formatter"),
                ...
                x = this._formatterLabel(y, _),
                w = new Ux({
                  z2: 30,
                  style: h(
                    Cs(i, { text: x }),
                    this._monthTextPositionControl(d, p, e, a, o),
                  ),
                });
              n.add(w);
            }
        ...
        (n.prototype._renderWeekText = function (t, e, n, i) {
          ...
          if (r.get("show")) {
            ...
            C(s) && (s = lI[s.toUpperCase()] || []);
            var c = o.getNextNDay(e.end.time, 7 - e.lweek).time,
              p = [o.getCellWidth(), o.getCellHeight()];
            (l = _i(l, Math.min(p[1], p[0]))),
              "start" === a &&
                ((c = o.getNextNDay(e.start.time, -(7 + e.fweek)).time),
                (l = -l));
            for (var f = 0; 7 > f; f++) {
              var d = o.getNextNDay(c, f),
                g = o.dataToRect([d.time], !1).center,
                v = f;
              v = Math.abs((f + u) % 7);
              var y = new Ux({
                z2: 30,
                style: h(
                  Cs(r, { text: s[v] }),
                  this._weekTextPositionControl(g, n, a, l, p),
                ),
              });
              i.add(y);
            }
      ...
      return (
        ...
        (t.prototype.getDateInfo = function (t) {
          ...
          var e = t.getFullYear(),
            ...
            a = t.getDay();
          return (
            (a = Math.abs((a + 7 - this.getFirstDayOfWeek()) % 7)),
            {
              y: e + "",
              m: i,
              d: o,
        ...
        (t.prototype.dataToPoint = function (t, e) {
          T(t) && (t = t[0]), null == e && (e = !0);
          var n = this.getDateInfo(t),
            i = this._rangeInfo,
            r = n.formatedDate;
          if (e && !(n.time >= i.start.time && n.time < i.end.time + hI))
            return [0 / 0, 0 / 0];
          var o = n.day,
        ...
        (t.prototype._initRangeOption = function () {
          ...
          if ((T(e) && 1 === e.length && (e = e[0]), T(e))) t = e;
          else {
            var n = e.toString();
            if (
        ...
        (t.prototype._getRangeInfo = function (t) {
          ...
          var i = Math.floor(n[1].time / hI) - Math.floor(n[0].time / hI) + 1,
            r = new Date(n[0].time),
            o = r.getDate(),
            a = n[1].date.getDate();
          r.setDate(o + i - 1);
        ...
        (n.prototype.render = function (t, e, n) {
          if ((this.group.removeAll(), t.get("show"))) {
            var i = this.group,
              ...
              a = t.get("textAlign"),
              s = z(t.get("textBaseline"), t.get("textVerticalAlign")),
              l = new Ux({
                style: Cs(
                  r,
            ...
            (l.silent = !p && !d),
              ...
              f &&
                c.on("click", function () {
                  xl(f, "_" + t.get("subtarget"));
                }),
              (jx(l).eventData = jx(c).eventData =
                d
  ...
  var dI = function (t, e) {
      return "all" === e
        ? { type: "all", title: t.getLocale(["legend", "selector", "all"]) }
        : "inverse" === e
        ? {
            type: "inverse",
      ...
      return (
        ...
        (n.prototype._updateSelector = function (t) {
          ...
          e === !0 && (e = t.selector = ["all", "inverse"]),
            T(e) &&
              v(e, function (t, i) {
                C(t) && (t = { type: t }), (e[i] = l(t, dI(n, t.type)));
              });
        }),
        (n.prototype.optionUpdated = function () {
    ...
    _I = (function (t) {
      ...
      return (
        e(n, t),
        (n.prototype.init = function () {
          this.group.add((this._contentGroup = new mI())),
            this.group.add((this._selectorGroup = new mI())),
        ...
        (n.prototype.render = function (t, e, n) {
          ...
          if (
            ...
            (this.group.x = d.x - f.x),
              ...
              this.group.add((this._backgroundEl = Rd(f, t)));
          }
        }),
              ...
              function (r, o) {
                ...
                if (!l.get(a))
                  if (p) {
                    ...
                    var y = this._createItem(p, a, o, r, e, t, d, v, g, u);
                    y
                      .on("click", vI(Nd, a, null, i, h))
                      .on("mouseover", vI(Fd, p.name, null, i, h))
                      .on("mouseout", vI(Hd, p.name, null, i, h)),
                      l.set(a, !0);
                  } else
                    n.eachRawSeries(function (n) {
                      if (!l.get(a) && n.legendVisualProvider) {
                        ...
                        d &&
                          0 === d[3] &&
                          ((d[3] = 0.2), (p.fill = dn(d, "rgba")));
                        var g = this._createItem(n, a, o, r, e, t, {}, p, f, u);
                        g
                          .on("click", vI(Nd, null, a, i, h))
                          .on("mouseover", vI(Fd, null, a, i, h))
                          .on("mouseout", vI(Hd, null, a, i, h)),
                          l.set(a, !0);
                      }
                    }, this);
              },
        ...
        (n.prototype._createSelector = function (t, e, n) {
          ...
          yI(t, function (t) {
            ...
            Ts(o, { normal: a, emphasis: s }, { defaultText: t.title }), ya(o);
          });
        }),
        (n.prototype._createItem = function (t, e, n, i, r, o, a, s, l, u) {
          var h = t.visualDrawType,
            ...
            g = i.get("icon");
          l = g || l || "roundRect";
          var v = r.getModel("lineStyle"),
            y = Bd(l, i, v, a, s, h, f),
            m = new mI(),
            _ = i.getModel("textStyle");
          m.add(
            "function" != typeof t.getLegendIcon || g
              ? Ed({
                  itemWidth: c,
                  itemHeight: p,
                  symbolType: l,
          ...
          var M = new Hx({ shape: m.getBoundingRect(), invisible: !0 }),
        ...
        (n.prototype.layoutInner = function (t, e, n, i, r, o) {
          ...
          aS(t.get("orient"), a, t.get("itemGap"), n.width, n.height);
          var l = a.getBoundingRect(),
            u = [-l.x, -l.y];
          if ((s.markRedraw(), a.markRedraw(), r)) {
            aS("horizontal", s, t.get("selectorItemGap", !0));
    ...
    xI = (function (t) {
      ...
      return (
        ...
        (n.prototype.init = function (e, n, i) {
          var r = Cl(e);
          t.prototype.init.call(this, e, n, i), Yd(this, e, r);
        }),
        (n.prototype.mergeOption = function (e, n) {
          t.prototype.mergeOption.call(this, e, n), Yd(this, this.option, e);
        }),
        (n.type = "legend.scroll"),
        (n.defaultOption = Es(gI.defaultOption, {
          scrollDataIndex: 0,
          pageButtonItemGap: 5,
          pageButtonGap: null,
      ...
      return (
        ...
        (n.prototype.init = function () {
          t.prototype.init.call(this),
            this.group.add((this._containerGroup = new wI())),
            this._containerGroup.add(this.getContentGroup()),
            this.group.add((this._controllerGroup = new wI()));
        }),
        (n.prototype.resetInner = function () {
        ...
        (n.prototype.layoutInner = function (t, e, n, i, r, o) {
          var a = this.getSelectorGroup(),
            ...
            c = bI[1 - l],
            p = SI[1 - l];
          r && aS("horizontal", a, t.get("selectorItemGap", !0));
        ...
        (n.prototype._layoutContentAndController = function (
          ...
          aS(
            ...
            aS("horizontal", h, t.get("pageButtonItemGap", !0));
          ...
          var g = [0, 0],
            v = [-p.x, -p.y],
            y = z(t.get("pageButtonGap", !0), t.get("itemGap", !0));
          if (f) {
  ...
  var MI = {},
    ...
    AI = (function () {
      ...
      return (
        ...
        (t.prototype.createPointerEl = function (t, e) {
          var n = e.pointer;
          if (n) {
            var i = (DI(t).pointerEl = new yb[n.type](kI(e.pointer)));
            t.add(i);
          }
        }),
        (t.prototype.createLabelEl = function (t, e, n, i) {
          if (e.label) {
            var r = (DI(t).labelEl = new Ux(kI(e.label)));
            t.add(r), sg(r, i);
          }
        }),
        (t.prototype.updatePointerEl = function (t, e, n) {
          var i = DI(t).pointerEl;
          i &&
            e.pointer &&
            ...
            this._handle ||
              ...
              (i = this._handle =
                vs(r.get("icon"), {
                  ...
                  onmousedown: II(this._onHandleDragMove, this, 0, 0),
                  drift: II(this._onHandleDragMove, this),
                  ondragend: II(this._onHandleDragEnd, this),
                })),
              n.add(i)),
              ug(i, e, !1),
              i.setStyle(
    ...
    LI = (function () {
      ...
      return (
        ...
        (t.prototype.add = function (t) {
          OI[t](this.opt, this.axisModel, this.group, this._transformGroup);
        }),
    ...
    OI = {
        ...
        if (
          ...
          if (("number" == typeof d && (d = [d, d]), null != p)) {
            "string" == typeof p && (p = [p, p]),
              ("string" == typeof f || "number" == typeof f) && (f = [f, f]);
            var g = f[0],
              y = f[1];
            v(
              [
      ...
      axisTickLabel: function (t, e, n, i) {
        var r = vg(n, i, e, t),
          o = mg(n, i, e, t);
        cg(e, o, r), yg(n, i, e, t.tickDirection);
      },
      axisName: function (t, e, n, i) {
        ...
        if (r) {
          ...
          var d;
          dg(a)
            ? (o = LI.innerTextLayout(
                t.rotation,
                null != f ? f : t.rotation,
                s,
              ))
            : ((o = hg(t.rotation, a, f || 0, h)),
          ...
          if (
            (ws({ el: _, componentModel: e, itemName: r }),
            (_.__fullText = r),
            (_.anid = "name"),
            e.get("triggerEvent"))
          ) {
            var x = LI.makeAxisEventDataBase(e);
            (x.targetType = "axisName"), (x.name = r), (jx(_).eventData = x);
          }
    ...
    RI = (function (t) {
      ...
      return (
        ...
        (n.prototype.getHandleTransform = function (t, e, n) {
          var i = Dg(e.axis.grid.model, e, { labelInside: !1 });
        ...
        (n.prototype.render = function (t, e, n) {
          var i = e.getComponent("tooltip"),
            r =
              ...
              (i && i.get("triggerOn")) ||
              "mousemove|click";
          Ag("axisPointer", n, function (t, e, n) {
            "none" !== r &&
    ...
    XI =
      ...
      (iy.transform3dSupported ? "will-change:transform;" : ""),
    jI = (function () {
      function t(t, e, n) {
        if (
          ((this._show = !1),
        ...
        av(this._styleCoord, r, o, e.getWidth() / 2, e.getHeight() / 2),
      ...
      return (
        ...
        (t.prototype.show = function (t, e) {
          ...
          n.innerHTML
            ? (i.cssText =
                XI +
                ov(t, !this._firstShow, this._longHide) +
                iv(r[0], r[1], !0) +
                ("border-color:" + _l(e) + ";") +
                (t.get("extraCssText") || "") +
          ...
          if (null != t) {
            ...
            if (
              (C(r) &&
                "item" === n.get("trigger") &&
                !Kg(n) &&
                (t += ev(n.get("backgroundColor"), i, r)),
              C(t))
            )
              o.innerHTML = t;
            else if (t) {
              ...
              for (var a = 0; a < t.length; a++)
                L(t[a]) && t[a].parentNode !== o && o.appendChild(t[a]);
            }
          }
        }),
        ...
        (t.prototype.moveTo = function (t, e) {
          ...
          if (
            (av(n, this._zr, this._appendToBody, t, e),
            null != n[0] && null != n[1])
          ) {
            var i = this.el.style,
              r = iv(n[0], n[1]);
        ...
        (t.prototype.hide = function () {
          ...
          (e.visibility = "hidden"),
            (e.opacity = "0"),
            iy.transform3dSupported && (e.willChange = ""),
            (this._show = !1),
        ...
        (t.prototype.hideLater = function (t) {
          !this._show ||
            ...
            (t
              ? ((this._hideDelay = t),
                (this._show = !1),
                (this._hideTimeout = setTimeout(yy(this.hide, this), t)))
              : this.hide());
        }),
    ...
    qI = (function () {
      function t(t) {
        (this._show = !1),
          ...
          (this._enterable = !0),
          (this._zr = t.getZr()),
          uv(this._styleCoord, this._zr, t.getWidth() / 2, t.getHeight() / 2);
      }
      return (
        (t.prototype.update = function (t) {
        ...
        (t.prototype.setContent = function (t, e, n, i) {
          I(t) && Fi(""), this.el && this._zr.remove(this.el);
        ...
        (t.prototype.moveTo = function (t, e) {
          ...
          if (n) {
            ...
            uv(i, this._zr, t, e), (t = i[0]), (e = i[1]);
            var r = n.style,
              o = sv(r.borderWidth || 0),
              a = lv(r);
    ...
    KI = v,
    $I = _i,
    JI = new Hx({ shape: { x: -1, y: -1, width: 2, height: 2 } }),
    QI = (function (t) {
      function n() {
        var e = (null !== t && t.apply(this, arguments)) || this;
        return (e.type = n.type), e;
      ...
      return (
          ...
          if (i.from !== this.uid && !iy.node) {
            ...
            if (a) {
              ...
              (l.x = i.x),
                (l.y = i.y),
                l.update(),
                (jx(l).tooltipConfig = { name: null, option: i.tooltip }),
        ...
        (n.prototype._showAxisTooltip = function (t, e) {
          var n = this._ecModel,
            ...
            o = hv([e.tooltipOption], i),
            a = this._renderMode,
            s = [],
            l = Xu("section", { blocks: [], noHeader: !0 }),
            u = [],
            h = new gT();
          KI(t, function (t) {
            KI(t.dataByAxis, function (t) {
              var e = n.getComponent(t.axisDim + "Axis", t.axisIndex),
                i = t.value;
              if (e && null != i) {
                var r = bg(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt),
                  o = Xu("section", {
                    header: r,
                    noHeader: !G(r),
                    sortBlocks: !0,
                ...
                l.blocks.push(o),
                  v(t.seriesDataIndices, function (l) {
                    ...
                    (f.axisDim = t.axisDim),
                      ...
                      (f.axisId = t.axisId),
                      (f.axisValue = Ff(e.axis, { value: i })),
                      (f.axisValueLabel = r),
                      (f.marker = h.makeTooltipMarker("item", _l(f.color), a));
                    var d = Au(c.formatTooltip(p, !0, null));
        ...
        (n.prototype._showSeriesItemTooltip = function (t, e, n) {
          ...
          if (null == d || "item" === d) {
            var g = s.getDataParams(l, u),
              v = new gT();
            g.marker = v.makeTooltipMarker("item", _l(g.color), c);
            var y = Au(s.formatTooltip(l, !1, u)),
              m = f.get("order"),
              _ = y.markupFragment
                ? Zu(
                    y.markupFragment,
        ...
        (n.prototype._showComponentItemTooltip = function (t, e, n) {
          ...
          var h = t.positionDefault,
            c = hv(l, this._tooltipModel, h ? { position: h } : null),
            p = c.get("content"),
            f = Math.random() + "",
            d = new gT();
        ...
        (n.prototype._showTooltipContent = function (
          ...
          if (((this._ticket = ""), t.get("showContent") && t.get("show"))) {
            ...
            if (h && C(h)) {
              ...
              (c = h), v && (c = Ys(g.axisValue, c, d)), (c = dl(c, n, !0));
            } else if (M(h)) {
              var y = ZI(function (e, i) {
                e === this._ticket &&
        ...
        (n.prototype._updatePosition = function (t, e, n, i, r, o, a) {
          ...
          if (
            ...
            var g = pv(n, i, r, s, l, h ? null : 20, c ? null : 20);
            (n = g[0]), (i = g[1]);
          }
          if (
            (h && (n -= gv(h) ? u[0] / 2 : "right" === h ? u[0] : 0),
            c && (i -= gv(c) ? u[1] / 2 : "bottom" === c ? u[1] : 0),
            Kg(t))
          ) {
            var g = fv(n, i, r, s, l);
            (n = g[0]), (i = g[1]);
        ...
        (n.prototype.dispose = function (t, e) {
          iy.node || (this._tooltipContent.dispose(), Eg("itemTooltip", e));
        }),
        (n.type = "tooltip"),
        n
      );
  ...
  var tA = "none",
      ...
      return (
        ...
        (t.prototype.ellipse = function (t, e, n, i, r, o, a, s) {
          ...
          return isNaN(g) ||
            ...
            isNaN(m)
            ? ""
            : void this._d.push("A", Cv(n), Cv(i), eA(r * aA), +d, +h, y, m);
        }),
        (t.prototype.rect = function (t, e, n, i) {
          this._add("M", t, e),
            this._add("L", t + n, e),
        ...
        (t.prototype._add = function (t) {
          ...
          for (var e = 1; e < arguments.length; e++) {
            var n = arguments[e];
            if (isNaN(n)) return void (this._invalid = !0);
            this._d.push(Cv(n));
          }
        }),
    ...
    uA = {
      brush: function (t) {
        var e = t.style,
          n = t.__svgEl;
        n || ((n = mv("path")), (t.__svgEl = n)), t.path || t.createPathProxy();
        var i = t.path;
        t.shapeChanged() &&
          (i.beginPath(), t.buildPath(i, t.shape), t.pathUpdated());
        var r = i.getVersion(),
          o = t,
          a = o.__svgPathBuilder;
        (o.__svgPathVersion !== r || !a || t.style.strokePercent < 1) &&
          (a || (a = o.__svgPathBuilder = new lA()),
          a.reset(),
          i.rebuildPath(a, t.style.strokePercent),
          a.generateStr(),
          (o.__svgPathVersion = r)),
          Pv(n, "d", a.getStr()),
          Rv(n, e, t),
          Av(n, t.transform);
      },
      ...
      brush: function (t) {
        ...
        if (
          (n instanceof HTMLImageElement
            ? (n = n.src)
            : n instanceof HTMLCanvasElement && (n = n.toDataURL()),
          n)
        ) {
          var i = e.x || 0,
            r = e.y || 0,
            ...
            a = e.height,
            s = t.__svgEl;
          s || ((s = mv("image")), (t.__svgEl = s)),
            n !== t.__imageSrc && (Lv(s, "href", n), (t.__imageSrc = n)),
            Pv(s, "width", o + ""),
            Pv(s, "height", a + ""),
            Pv(s, "x", i + ""),
            Pv(s, "y", r + ""),
    ...
    cA = { left: "start", right: "end", center: "middle", middle: "middle" },
    pA = {
      brush: function (t) {
        var e = t.style,
          n = e.text;
        if ((null != n && (n += ""), n && !isNaN(e.x) && !isNaN(e.y))) {
          var i = t.__svgEl;
          i ||
            ((i = mv("text")), Ov(i, "xml:space", "preserve"), (t.__svgEl = i));
          var r = e.font || Mm,
            o = i.style;
          (o.font = r), (i.textContent = n), Rv(i, e, t), Av(i, t.transform);
          var a = e.x || 0,
            s = Bv(e.y || 0, Nn(r), e.textBaseline),
            l = cA[e.textAlign] || e.textAlign;
          Pv(i, "dominant-baseline", "central"),
            Pv(i, "text-anchor", l),
            Pv(i, "x", a + ""),
            Pv(i, "y", s + "");
        }
    ...
    gA = (function () {
      ...
      return (
        (t.prototype.getDefs = function (t) {
          var e = this._svgRoot,
            n = this._svgRoot.getElementsByTagName("defs");
          if (0 === n.length) {
            if (t) {
              var i = e.insertBefore(this.createElement("defs"), e.firstChild);
              return (
                i.contains ||
        ...
        (t.prototype.doUpdate = function (t, e) {
          if (t) {
        ...
        (t.prototype.addDom = function (t) {
          var e = this.getDefs(!0);
          t.parentNode !== e && e.appendChild(t);
        }),
        (t.prototype.removeDom = function (t) {
          var e = this.getDefs(!1);
          e &&
            t[this._domName] &&
            (e.removeChild(t[this._domName]), (t[this._domName] = null));
        }),
        (t.prototype.getDoms = function () {
          var t = this.getDefs(!1);
          if (!t) return [];
          var e = [];
          return (
            v(this._tagNames, function (n) {
              for (var i = t.getElementsByTagName(n), r = 0; r < i.length; r++)
                e.push(i[r]);
            }),
            e
          );
        ...
        (t.prototype.markDomUsed = function (t) {
          t && (t[this._markLabel] = dA);
        }),
        (t.prototype.markDomUnused = function (t) {
          t && (t[this._markLabel] = fA);
        }),
        (t.prototype.isDomUnused = function (t) {
          return t && t[this._markLabel] !== dA;
        }),
        (t.prototype.removeUnused = function () {
          ...
          if (e) {
            var n = this.getDoms();
            v(n, function (n) {
              t.isDomUnused(n) && e.removeChild(n);
            });
          }
        }),
        (t.prototype.getSvgProxy = function (t) {
          return t instanceof Px
            ? uA
            : t instanceof Ex
            ? hA
        ...
        (t.prototype.getSvgElement = function (t) {
          return t.__svgEl;
        }),
        t
      );
    ...
    vA = (function (t) {
      ...
      return (
            ...
            v(["fill", "stroke"], function (i) {
              ...
              if (zv(r)) {
                var o = r,
                  ...
                  s = void 0;
                o.__dom
                  ? ((s = o.__dom), a.contains(o.__dom) || n.addDom(s))
                  : (s = n.add(o)),
                  n.markUsed(e);
                var l = s.getAttribute("id");
                t.setAttribute(i, "url(#" + l + ")");
              }
            });
          }
        }),
        (n.prototype.add = function (t) {
          var e;
          if (Ev(t)) e = this.createElement("linearGradient");
          else {
            if (!Nv(t)) return a("Illegal gradient type."), null;
        ...
        (n.prototype.update = function (t) {
          if (zv(t)) {
            var e = this;
            this.doUpdate(t, function () {
              var n = t.__dom;
              if (n) {
                var i = n.tagName,
                  r = t.type;
                ("linear" === r && "linearGradient" === i) ||
                ("radial" === r && "radialGradient" === i)
                  ? e.updateDom(t, t.__dom)
        ...
        (n.prototype.updateDom = function (t, e) {
          if (Ev(t))
            ...
            if (!Nv(t)) return void a("Illegal gradient type.");
          ...
          for (var n = t.colorStops, i = 0, r = n.length; r > i; ++i) {
            ...
            if (s.indexOf("rgba") > -1) {
              var l = on(s)[3],
                u = un(s);
              o.setAttribute("stop-color", "#" + u),
                o.setAttribute("stop-opacity", l + "");
            } else o.setAttribute("stop-color", n[i].color);
            e.appendChild(o);
          }
          t.__dom = e;
        }),
        (n.prototype.markUsed = function (e) {
          if (e.style) {
            var n = e.style.fill;
            n && n.__dom && t.prototype.markDomUsed.call(this, n.__dom),
              (n = e.style.stroke),
              n && n.__dom && t.prototype.markDomUsed.call(this, n.__dom);
          }
        }),
    ...
    mA = (function (t) {
      function n(e, n) {
        return t.call(this, e, n, ["pattern"], "__pattern_in_use__") || this;
      }
      return (
        e(n, t),
        (n.prototype.addWithoutUpdate = function (t, e) {
          if (e && e.style) {
            ...
            v(["fill", "stroke"], function (i) {
              ...
              if (Fv(r)) {
                var o = n.getDefs(!0),
                  a = yA.get(r);
                a ? o.contains(a) || n.addDom(a) : (a = n.add(r)),
                  n.markUsed(e);
        ...
        (n.prototype.add = function (t) {
          if (Fv(t)) {
            var e = this.createElement("pattern");
            return (
              (t.id = null == t.id ? this.nextId++ : t.id),
        ...
        (n.prototype.updateDom = function (t, e) {
          ...
          if (n instanceof SVGElement)
            ...
            var i = void 0,
              r = e.getElementsByTagName("image");
            if (r.length) {
              if (!t.image) return void e.removeChild(r[0]);
              i = r[0];
            } else t.image && (i = this.createElement("image"));
            if (i) {
              var o = void 0;
              if (
                ("string" == typeof t.image
                  ...
                  ? (o = t.image.src)
                  : t.image instanceof HTMLCanvasElement &&
                    (o = t.image.toDataURL()),
                o)
              ) {
                i.setAttribute("href", o),
                  i.setAttribute("x", "0"),
                  i.setAttribute("y", "0");
                var a = { dirty: function () {} },
                  s = Mr(o, i, a, function (t) {
          ...
          var l = t.x || 0,
            ...
            f =
              ...
              p +
              ")";
          e.setAttribute("patternTransform", f), yA.set(t, e);
        }),
        (n.prototype.markUsed = function (e) {
          e.style &&
            (Fv(e.style.fill) &&
              t.prototype.markDomUsed.call(this, yA.get(e.style.fill)),
            Fv(e.style.stroke) &&
              t.prototype.markDomUsed.call(this, yA.get(e.style.stroke)));
        }),
        n
      );
    })(gA),
    _A = (function (t) {
      function n(e, n) {
        var i = t.call(this, e, n, "clipPath", "__clippath_in_use__") || this;
        return (i._refGroups = {}), (i._keyDuplicateCount = {}), i;
      }
      return (
        e(n, t),
        (n.prototype.markAllUnused = function () {
          t.prototype.markAllUnused.call(this);
          for (var e in this._refGroups) this.markDomUnused(this._refGroups[e]);
          this._keyDuplicateCount = {};
        }),
        (n.prototype._getClipPathGroup = function (t, e) {
          if (Vv(t)) {
            var n = t.__clipPaths,
              i = this._keyDuplicateCount,
              r = Hv(n);
            return (
              fc(n, e && e.__clipPaths) &&
                ((i[r] = i[r] || 0), i[r] && (r += "-" + i[r]), i[r]++),
              this._refGroups[r] ||
                (this._refGroups[r] = this.createElement("g"))
            );
          }
        }),
        (n.prototype.update = function (t, e) {
          var n = this._getClipPathGroup(t, e);
          return (
            n && (this.markDomUsed(n), this.updateDom(n, t.__clipPaths)), n
          );
        }),
        (n.prototype.updateDom = function (t, e) {
          if (e && e.length > 0) {
            ...
            i._dom
              ...
              : ((o = "zr" + this._zrId + "-clip-" + this.nextId),
                ...
                n.appendChild(r),
                (i._dom = r));
            var a = this.getSvgProxy(i);
            a.brush(i);
            var s = this.getSvgElement(i);
            (r.innerHTML = ""),
              r.appendChild(s),
              t.setAttribute("clip-path", "url(#" + o + ")"),
              e.length > 1 && this.updateDom(r, e.slice(1));
          } else t && t.setAttribute("clip-path", "none");
        }),
        (n.prototype.markUsed = function (e) {
          var n = this;
          e.__clipPaths &&
            v(e.__clipPaths, function (e) {
              e._dom && t.prototype.markDomUsed.call(n, e._dom);
            });
        }),
        (n.prototype.removeUnused = function () {
          t.prototype.removeUnused.call(this);
          var e = {};
          for (var n in this._refGroups) {
            var i = this._refGroups[n];
            this.isDomUnused(i)
    ...
    xA = (function (t) {
      function n(e, n) {
        var i =
          t.call(this, e, n, ["filter"], "__filter_in_use__", "_shadowDom") ||
          this;
        return (i._shadowDomMap = {}), (i._shadowDomPool = []), i;
      }
      return (
        e(n, t),
        (n.prototype._getFromPool = function () {
          var t = this._shadowDomPool.pop();
          if (!t) {
            (t = this.createElement("filter")),
              t.setAttribute(
                "id",
                "zr" + this._zrId + "-shadow-" + this.nextId++,
              );
            var e = this.createElement("feDropShadow");
            t.appendChild(e), this.addDom(t);
          }
          return t;
        }),
        (n.prototype.update = function (t, e) {
          ...
          if (Wv(n)) {
            var i = Gv(e),
              r = (e._shadowDom = this._shadowDomMap[i]);
            r || ((r = this._getFromPool()), (this._shadowDomMap[i] = r)),
              this.updateDom(t, e, r);
          } else this.remove(t, e);
        }),
        (n.prototype.remove = function (t, e) {
          null != e._shadowDom &&
            ((e._shadowDom = null), (t.style.filter = ""));
        }),
        (n.prototype.updateDom = function (t, e, n) {
          var i = n.children[0],
            r = e.style,
            o = e.getGlobalScale(),
            a = o[0],
            s = o[1];
          if (a && s) {
            var l = r.shadowOffsetX || 0,
              u = r.shadowOffsetY || 0,
              h = r.shadowBlur,
              c = r.shadowColor;
            i.setAttribute("dx", l / a + ""),
              i.setAttribute("dy", u / s + ""),
              i.setAttribute("flood-color", c);
            var p = h / 2 / a,
              f = h / 2 / s,
              d = p + " " + f;
            i.setAttribute("stdDeviation", d),
              ...
              (e._shadowDom = n);
            var g = n.getAttribute("id");
            t.style.filter = "url(#" + g + ")";
          }
        }),
        (n.prototype.removeUnused = function () {
          var t = this.getDefs(!1);
          if (t) {
            ...
            for (var n in this._shadowDomMap) {
              var i = this._shadowDomMap[n];
              e.push(i);
            }
            this._shadowDomMap = {};
          }
    ...
    wA = (function () {
      function t(t, e, n, i) {
        (this.type = "svg"),
          (this.refreshHover = Jv("refreshHover")),
          (this.pathToImage = Jv("pathToImage")),
          (this.configLayer = Jv("configLayer")),
          (this.root = t),
          (this.storage = e),
          (this._opts = n = h({}, n || {}));
        var r = mv("svg");
        ...
        var a = mv("g");
        r.appendChild(a),
          (this._gradientManager = new vA(i, a)),
          (this._patternManager = new mA(i, a)),
          (this._clipPathManager = new _A(i, a)),
          (this._shadowManager = new xA(i, a));
      ...
      return (
        ...
        (t.prototype.createSVGElement = function (t) {
          return mv(t);
        }),
        (t.prototype.paintOne = function (t) {
          var e = Yv(t);
          return e && e.brush(t), $v(t);
        }),
        (t.prototype._paintList = function (t) {
          var e = this._gradientManager,
            n = this._patternManager,
            i = this._clipPathManager,
            r = this._shadowManager;
          e.markAllUnused(),
            n.markAllUnused(),
            i.markAllUnused(),
            r.markAllUnused();
          for (
            ...
            h.invisible ||
              ((h.__dirty || !p) &&
                ...
                p &&
                  h.style &&
                  (e.update(h.style.fill),
                  e.update(h.style.stroke),
                  n.update(h.style.fill),
                  n.update(h.style.stroke),
                  r.update(p, h)),
                (h.__dirty = 0)),
              p && l.push(h));
          }
          for (var f, d, g = Tv(a, l), u = 0; u < g.length; u++) {
            var v = g[u];
            if (v.removed)
          ...
          for (var m, _, u = 0; u < g.length; u++) {
            ...
            if (!v.removed)
              for (var y = 0; y < v.count; y++) {
                ...
                x !== _ &&
                  ((f = d),
                  x && (f ? jv(o, x, f) : qv(o, x), (d = x), (f = null)),
                  (_ = x));
                var p = $v(h);
                f ? jv(_ || o, p, f) : qv(_ || o, p),
                  (f = p || f),
                  _ || (d = f),
                  e.markUsed(h),
                  e.addWithoutUpdate(p, h),
                  n.markUsed(h),
                  n.addWithoutUpdate(p, h),
                  i.markUsed(h),
                  (m = h);
              }
          }
        ...
        (t.prototype.toDataURL = function () {
          this.refresh();
          var t = this._svgDom,
            e = t.outerHTML || (t.parentNode && t.parentNode).innerHTML,
            n = encodeURIComponent(e.replace(/></g, ">\n\r<"));
  ...
  vi("svg", wA),
    ...
    (t.getInstanceById = Tp),
    (t.registerTheme = Mp),
    (t.registerPreprocessor = Cp),
    (t.registerProcessor = Dp),
    (t.registerPostInit = kp),
    (t.registerPostUpdate = Ip),
    (t.registerAction = Ap),
    (t.registerCoordinateSystem = Pp),
    (t.getCoordinateSystemDimensions = Lp),
    (t.registerLayout = Op),
    (t.registerVisual = Rp),
    (t.registerLoading = Ep),
    (t.setCanvasCreator = Np),
    (t.registerMap = zp),
    (t.getMap = Fp),
    (t.registerTransform = kD),
    (t.dataTool = GD),
    (t.registerLocale = Ns),
    (t.zrender = l_),
    (t.matrix = Yy),
    ...
    (t.SeriesModel = yT),
    (t.ChartView = wT),
    (t.extendComponentModel = ud),
    (t.extendComponentView = hd),
    (t.extendSeriesModel = cd),
    (t.extendChartView = pd),
    (t.throttle = xh),
    (t.use = Xf),
    (t.parseGeoJSON = up),
    (t.parseGeoJson = up),
